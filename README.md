...
The list was updated at 02:06:54 03/04/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39905 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39621 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 36936 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28878 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23466 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22311 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 20902 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 19919 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 17911 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17625 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15646 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14992 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13852 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13253 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12753 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12171 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12129 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12019 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11765 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11733 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11456 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11176 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10666 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10649 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10105 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9751 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9631 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [tj/co](https://github.com/tj/co) | 9363 | `mocha --harmony` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9362 | `mocha test/index.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9324 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9169 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9116 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8919 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8590 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8430 | `mocha test/*-test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8378 | `mocha` | 
...
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8062 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7891 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7858 | `./node_modules/.bin/mocha test/src` | 
| [websockets/ws](https://github.com/websockets/ws) | 7817 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7741 | `mocha --compilers js:babel-register test/test.js` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7569 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [amark/gun](https://github.com/amark/gun) | 7528 | `mocha` | 
| [dthree/cash](https://github.com/dthree/cash) | 7452 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7327 | `mocha tests/*.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7177 | `npm run build && istanbul cover _mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7156 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6980 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6961 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6711 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6572 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6530 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6475 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6437 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6433 | `nyc mocha test/**/* -r ./test/before` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6420 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6346 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6328 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6324 | `mocha --compilers js:babel-core/register` | 
...
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5836 | `npm run test:mocha:src` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5827 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5738 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5591 | `jshint index.js test/tests.js && mocha test/tests.js` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5375 | `mocha test/test.js` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5373 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5190 | `mocha --exit --require babel-core/register` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5013 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 4960 | `mocha` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 4842 | `npm run build-cli && mocha` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4780 | `gulp lint && mocha` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4766 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4744 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
...
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4628 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4622 | `mocha --reporter spec -t 8000` | 
...
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4505 | `gulp build; mocha;` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4503 | `standard && mocha` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4430 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4410 | `mocha` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4327 | `mocha` | 
...
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4276 | `mocha; jshint *.js lib` | 
...
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4207 | `mocha` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4203 | `mocha test` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4183 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3922 | `mocha --recursive && make test` | 
...
| [muicss/mui](https://github.com/muicss/mui) | 3861 | `mocha` | 
| [CodeboxIDE/codebox](https://github.com/CodeboxIDE/codebox) | 3850 | `export TESTING=true; mocha --reporter list` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3849 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3789 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3767 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3667 | `nyc mocha` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3571 | `mocha ./test/*.spec.js` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3519 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3494 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [primus/primus](https://github.com/primus/primus) | 3478 | `npm run build && mocha test/*.test.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3472 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3354 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3327 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3309 | `npm run lint && npm run mocha` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3277 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3212 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3165 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3138 | `nyc mocha "test/**/*.test.js"` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3113 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [expressjs/session](https://github.com/expressjs/session) | 3103 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 3035 | `node_modules/.bin/mocha test/tests.js` | 
...
| [arkency/reactjs_koans](https://github.com/arkency/reactjs_koans) | 2974 | `npm run compile && mocha -b --compilers js:babel/register --require test/helpers.js test/**/*.js || echo` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2968 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2964 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2961 | `mocha` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2909 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2886 | `mocha test/*.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2847 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2832 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2787 | `nyc mocha && tsc` | 
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2780 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2755 | `mocha` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2750 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2746 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2743 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2741 | `mocha test/index.js && npm run demo` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2739 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2732 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2717 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2698 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [github-tools/github](https://github.com/github-tools/github) | 2686 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2671 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
...
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2667 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2649 | `mocha` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2647 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2602 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2599 | `mocha --opts mocha.opts` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2598 | `mocha --timeout 100000` | 
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2588 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2583 | `mocha-phantomjs ./test/index.html` | 
| [css/csso](https://github.com/css/csso) | 2575 | `mocha --reporter dot` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2565 | `npm run mocha && npm run lint` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2535 | `mocha` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2526 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2521 | `mocha --recursive --watch` | 
...
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2488 | `mocha` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2463 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2412 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2382 | `NODE_ENV=test mocha` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2380 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2366 | `node node_modules/mocha/bin/_mocha` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2355 | `node_modules/.bin/mocha --reporter spec` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2344 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2341 | `nyc mocha test/mocha-node-setup.js 'test/**/*-test.js'` | 
...
| [postaljs/postal.js](https://github.com/postaljs/postal.js) | 2323 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2311 | `mocha test/src/**/*.unit.js` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2311 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [json5/json5](https://github.com/json5/json5) | 2257 | `mocha --ui exports --reporter spec` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2209 | `mocha test/unit --require mochahook` | 
| [mde/ejs](https://github.com/mde/ejs) | 2202 | `mocha --require should --reporter spec` | 
...
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2184 | `npm run lint && mocha` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2170 | `mocha` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2166 | `mocha -R spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2156 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2035 | `mocha test.js` | 
...
| [weui/react-weui](https://github.com/weui/react-weui) | 1994 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1991 | `mocha -R landing test/index` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1947 | `mocha test && npm run lint` | 
...
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1903 | `mocha -c test/index.js` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 1886 | `mocha` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1881 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1877 | `mocha` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1859 | `mocha --compilers js:babel-register` | 
...
| [then/promise](https://github.com/then/promise) | 1778 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
...
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1773 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1759 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [kach/nearley](https://github.com/kach/nearley) | 1741 | `mocha test/*.test.js` | 
...
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1736 | `mocha` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1722 | `npm run lint && mocha -R dot && npm run cover` | 
| [share/sharedb](https://github.com/share/sharedb) | 1721 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [trailsjs/trails](https://github.com/trailsjs/trails) | 1713 | `eslint --ignore-path .gitignore index.js lib/ test/ && nyc mocha` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1687 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [BinaryMuse/fluxxor](https://github.com/BinaryMuse/fluxxor) | 1687 | `npm run jshint && mocha --recursive` | 
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1685 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1669 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1664 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1608 | `mocha && npm run lint` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1598 | `mocha` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1594 | `mocha` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1589 | `mocha --reporter spec --grep .` | 
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1580 | `npm run mocha && npm run lint` | 
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1579 | `mocha test/*.js` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1574 | `npm run lint && mocha` | 
...
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1552 | `mocha test -u bdd -R spec` | 
...
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1531 | `mocha test/* --reporter spec` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1528 | `mocha spec` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1502 | `standard "src/*.js" && npm run build && mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1405 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1397 | `nyc mocha` | 
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1397 | `eslint --cache . && tsc && mocha` | 
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1394 | `mocha --check-leaks -R dot` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1338 | `mocha tests.js` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1327 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1326 | `mocha --check-leaks --reporter spec --bail` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1320 | `eslint . && mocha -t 5000` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1301 | `mocha compiled_tests/` | 
| [letsgetrandy/DICSS](https://github.com/letsgetrandy/DICSS) | 1293 | `mocha-phantomjs tests/index.html` | 
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1289 | `mocha test/setup.js test/spec/*.js` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1283 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1280 | `nyc npm run mocha` | 
...
| [dlmanning/gulp-sass](https://github.com/dlmanning/gulp-sass) | 1257 | `./node_modules/.bin/mocha test` | 
...
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1199 | `mocha --recursive` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1192 | `mocha` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1161 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
...
| [paldepind/flyd](https://github.com/paldepind/flyd) | 1154 | `eslint --fix lib/ test/ module/ && mocha -R dot test/*.js module/**/test/*.js` | 
...
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1119 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1118 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1118 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1114 | `standard && istanbul cover _mocha` | 
| [btmills/geopattern](https://github.com/btmills/geopattern) | 1113 | `npm run lint && npm run mocha` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1112 | `mocha --reporter dot` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1108 | `mocha src/test.js` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1108 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1094 | `eslint src && mocha && karma start --single-run` | 
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1092 | `mocha test` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1076 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [teambit/bit](https://github.com/teambit/bit) | 1074 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1032 | `mocha tests/test-*` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1026 | `nyc mocha --timeout=20000 test.js` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1008 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 988 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 962 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 956 | `mocha --recursive test` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 942 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [OverZealous/run-sequence](https://github.com/OverZealous/run-sequence) | 942 | `mocha --reporter spec` | 
| [tomas/needle](https://github.com/tomas/needle) | 941 | `mocha test` | 
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 939 | `mocha -t 120000 test/*.test.js` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 928 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 925 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 918 | `mocha -R spec ./test/unit/**` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 918 | `mocha` | 
| [expressjs/generator](https://github.com/expressjs/generator) | 918 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 903 | `mocha tests/*.js` | 
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 900 | `standard src/index.js && mocha --compilers js:babel-register` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 888 | `eslint src test && mocha --compilers babel-register` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 880 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 880 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 868 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 866 | `npm run lint && npm run mocha` | 
...
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 856 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 804 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 785 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 766 | `mocha` | 
...
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 762 | `mocha spec/*.js` | 
...
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 747 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
...
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 745 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
| [klei/gulp-inject](https://github.com/klei/gulp-inject) | 742 | `mocha -R spec src/**/*_test.js` | 
...
| [alexkuz/react-json-tree](https://github.com/alexkuz/react-json-tree) | 713 | `npm run lint && NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [developit/decko](https://github.com/developit/decko) | 703 | `npm run test:ts && eslint {src,tests}/**.js && mocha --compilers js:babel/register tests/**/*.js` | 
...
| [proj4js/proj4js](https://github.com/proj4js/proj4js) | 702 | `npm run build && istanbul test _mocha test/test.js` | 
