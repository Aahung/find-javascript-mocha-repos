...
The list was updated at 02:06:45 08/26/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 43311 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 41194 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 39834 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 30174 | `mocha --async-only` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 26036 | `cross-env NODE_ENV=test mocha` | 
| [caolan/async](https://github.com/caolan/async) | 24525 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 23308 | `mocha test/index.js` | 
| [developit/preact](https://github.com/developit/preact) | 19870 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 19036 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 15268 | `node_modules/.bin/mocha test/*.*.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 14344 | `nyc --reporter=html --reporter=text mocha` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 14004 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 13571 | `cross-env BABEL_ENV=cjs mocha --require babel-register --reporter spec` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 13187 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) | 12762 | `./node_modules/.bin/mocha test/` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12659 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12351 | `mocha --reporter spec test/*-test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12235 | `mocha` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 11873 | `istanbul cover _mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11529 | `nyc grunt mocha-and-karma` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 11250 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 11223 | `mocha --reporter dot` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12235 | `mocha` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 11873 | `istanbul cover _mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11529 | `nyc grunt mocha-and-karma` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 11250 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 11223 | `mocha --reporter dot` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 10508 | `mocha test/index.js` | 
| [svg/svgo](https://github.com/svg/svgo) | 10207 | `set NODE_ENV=test && mocha` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 10145 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [RelaxedJS/ReLaXed](https://github.com/RelaxedJS/ReLaXed) | 10135 | `mocha` | 
| [tj/co](https://github.com/tj/co) | 10055 | `mocha --harmony` | 
| [reduxjs/redux-devtools](https://github.com/reduxjs/redux-devtools) | 9977 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7909 | `npm run eslint && npm run mocha` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 7876 | `mocha --opts mocha.opts` | 
...
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 7249 | `eslint lib/**/*.js test/**/*.js index.js && mocha --exit --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 7246 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 7087 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 7063 | `xo && mocha test/*.js --timeout 100000` | 
| [almende/vis](https://github.com/almende/vis) | 7024 | `mocha --compilers js:babel-core/register` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6933 | `mocha --timeout 10000 ./test/*/*.test.js` | 
| [remoteintech/remote-jobs](https://github.com/remoteintech/remote-jobs) | 6715 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 8074 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 8055 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7909 | `npm run eslint && npm run mocha` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 7876 | `mocha --opts mocha.opts` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7722 | `./node_modules/.bin/mocha test` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 7650 | `npm run pre_test && nyc mocha --exit --check-leaks -t 10000 -R spec test/index.js && npm run tape` | 
| [dthree/cash](https://github.com/dthree/cash) | 7559 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7438 | `npm run build && istanbul cover _mocha` | 
| [rstacruz/jquery.transit](https://github.com/rstacruz/jquery.transit) | 7438 | `mocha` | 
| [aui/art-template](https://github.com/aui/art-template) | 7265 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
...
| [almende/vis](https://github.com/almende/vis) | 7024 | `mocha --compilers js:babel-core/register` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6933 | `mocha --timeout 10000 ./test/*/*.test.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6909 | `mocha $HARMONY_OPTS` | 
| [remoteintech/remote-jobs](https://github.com/remoteintech/remote-jobs) | 6715 | `mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 6527 | `mocha; jshint *.js lib` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 6481 | `npm run jshint && mocha test/` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 6412 | `mocha --exit --require babel-core/register` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 6280 | `mocha` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 6269 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6250 | `mocha test/test.js` | 
...
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5980 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5934 | `mocha` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5926 | `mocha tests/node.js` | 
| [shipshapecode/shepherd](https://github.com/shipshapecode/shepherd) | 5833 | `mocha` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5830 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5730 | `mocha && eslint lib/**` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5724 | `mocha` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 5691 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha --timeout 60000 ./infra/testing/auto-stub-logger.mjs` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5678 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 5667 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5415 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 5357 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 5329 | `standard && mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 5321 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 5317 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 5003 | `mocha` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4977 | `gulp lint && mocha` | 
| [mimecorg/vuido](https://github.com/mimecorg/vuido) | 4945 | `mocha test/index.js test/spec/**/*.spec.js` | 
...
| [luin/ioredis](https://github.com/luin/ioredis) | 4598 | `NODE_ENV=test mocha --timeout 8000 -r ts-node/register --exit` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4459 | `mocha --recursive` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 4437 | `npm run lint && npm run mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4414 | `mocha --require babel-register "./test/**/*Test.js"` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 4220 | `nyc --reporter lcovonly mocha --full-trace --check-leaks --exit` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4214 | `mocha -R spec ./test --recursive` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 4173 | `mocha -R spec src` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4149 | `nyc mocha` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 4144 | `nyc mocha` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 4091 | `node_modules/.bin/mocha test/tests.js` | 
| [ramboxapp/community-edition](https://github.com/ramboxapp/community-edition) | 4031 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 4030 | `mocha --timeout=15000 tests/*.test.js` | 
...
| [Khan/tota11y](https://github.com/Khan/tota11y) | 4015 | `mocha --require test/babel-hook test/*.js` | 
| [tj/ejs](https://github.com/tj/ejs) | 3980 | `mocha --require should --reporter spec` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3960 | `cross-env NODE_ENV=test mocha --require babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3848 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 3846 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [teambit/bit](https://github.com/teambit/bit) | 3842 | `mocha --require babel-core/register './src/**/*.spec.js'` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 3633 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3541 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3528 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 3479 | `NODE_ENV=test mocha --exit` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 3476 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3421 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 3379 | `cross-env BABEL_ENV=test mocha --require babel-register test/test.js` | 
| [dthree/vantage](https://github.com/dthree/vantage) | 3443 | `mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3421 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 3379 | `cross-env BABEL_ENV=test mocha --require babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 3266 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 3257 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2916 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2915 | `mocha` | 
...
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2843 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2825 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2898 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [konvajs/konva](https://github.com/konvajs/konva) | 2893 | `mocha-headless-chrome -f ./test/runner.html -a disable-web-security` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2885 | `mocha -R spec --recursive src/test` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2876 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2868 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2861 | `mocha` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2848 | `mocha -R landing test/index` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2843 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2834 | `npm run mocha && npm run lint` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2830 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2827 | `istanbul cover _mocha` | 
...
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2785 | `mocha` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 2783 | `mocha -R spec spec spec/reporters` | 
| [mdaines/viz.js](https://github.com/mdaines/viz.js) | 2774 | `mocha test-node` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2785 | `mocha` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 2783 | `mocha -R spec spec spec/reporters` | 
| [mdaines/viz.js](https://github.com/mdaines/viz.js) | 2774 | `mocha test-node` | 
...
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2771 | `mocha --require babel-register --recursive spec` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2748 | `node_modules/.bin/mocha --reporter spec` | 
| [mde/ejs](https://github.com/mde/ejs) | 2737 | `mocha --require should --reporter spec` | 
| [css/csso](https://github.com/css/csso) | 2729 | `mocha --reporter dot` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2712 | `xo && mocha` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2672 | `mocha test.js` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2667 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2654 | `mocha --timeout 100000` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2642 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2440 | `mocha` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2394 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 2113 | `standard && mocha` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 2110 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 2101 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 2065 | `mocha test/runner.js --reporter spec` | 
| [lipp/login-with](https://github.com/lipp/login-with) | 2064 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
...
| [noble/noble](https://github.com/noble/noble) | 2208 | `mocha -R spec test/*.js` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 2027 | `rimraf dbtest && npm run lint && SQLPAD_DB_PATH='./dbtest' mocha server/test --timeout 10000 --recursive --exit` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 2026 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1974 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [then/promise](https://github.com/then/promise) | 1929 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
...
| [kach/nearley](https://github.com/kach/nearley) | 1899 | `mocha test/*.test.js` | 
...
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1878 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1875 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [kach/nearley](https://github.com/kach/nearley) | 1899 | `mocha test/*.test.js` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1892 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1719 | `mocha ./test/basic.js -t 5000` | 
...
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1684 | `mocha test/*.js` | 
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1679 | `npm run lint && npm run mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1655 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1747 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
...
| [freeCodeCamp/guide](https://github.com/freeCodeCamp/guide) | 1708 | `yarn ensure-page-naming && mocha  -R spec "./{,!(node_modules)/**/}*.test.js"` | 
| [Kong/mashape-oauth](https://github.com/Kong/mashape-oauth) | 1699 | `mocha` | 
| [Tencent/omi](https://github.com/Tencent/omi) | 1698 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1679 | `npm run lint && npm run mocha` | 
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1678 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1605 | `mocha` | 
| [helpers/handlebars-helpers](https://github.com/helpers/handlebars-helpers) | 1592 | `mocha` | 
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1581 | `eslint --cache . && tsc && mocha` | 
...
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1540 | `mocha` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1539 | `mocha test.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1538 | `nyc --reporter lcovonly mocha --full-trace --check-leaks --exit` | 
...
| [kefirjs/kefir](https://github.com/kefirjs/kefir) | 1456 | `./configs/prettier.sh check && rollup -c ./configs/rollup.dev.js && mocha && flow check` | 
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1575 | `node node_modules/mocha/bin/mocha --check-leaks -R dot` | 
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1572 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [intercellular/cell](https://github.com/intercellular/cell) | 1546 | `npm run test:lint && npm run test:mocha` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1545 | `mocha` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1540 | `mocha` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1539 | `mocha test.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1538 | `nyc --reporter lcovonly mocha --full-trace --check-leaks --exit` | 
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1533 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1531 | `mocha --check-leaks --reporter spec --bail` | 
| [andreaferretti/paths-js](https://github.com/andreaferretti/paths-js) | 1531 | `mocha --reporter nyan --compilers js:babel/register --recursive test` | 
...
| [noble/bleno](https://github.com/noble/bleno) | 1418 | `mocha -R spec test/*.js` | 
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1415 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 1385 | `TEST=all mocha` | 
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1384 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1347 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 1319 | `NODE_ENV=test mocha tests/*.js` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1313 | `mocha --reporter dot` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 1300 | `NODE_PATH=. mocha **/*.spec.js` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 1286 | `mocha ./test/test*.js --reporter spec` | 
| [messageformat/messageformat](https://github.com/messageformat/messageformat) | 1286 | `mocha` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1279 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1269 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 1261 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [paldepind/flyd](https://github.com/paldepind/flyd) | 1259 | `eslint --fix lib/ test/ module/ && mocha test/*.js module/**/test/*.js` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 1248 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1206 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 1187 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 1192 | `mocha --compilers js:babel-core/register` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1192 | `mocha --recursive test` | 
| [web-pal/DBGlass](https://github.com/web-pal/DBGlass) | 1192 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js test/**/*.spec.js` | 
| [jkphl/svg-sprite](https://github.com/jkphl/svg-sprite) | 1191 | `istanbul test node_modules/mocha/bin/_mocha --report html -- test/svg-sprite.js --reporter spec` | 
...
| [localtunnel/server](https://github.com/localtunnel/server) | 1151 | `mocha --check-leaks --require esm './**/*.test.js'` | 
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 1143 | `npm run lint && mocha --require @babel/register` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 1141 | `mocha` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 1121 | `npm run mocha:istanbul` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 1093 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 1083 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 1072 | `webpack && mocha test/unit` | 
| [levelgraph/levelgraph](https://github.com/levelgraph/levelgraph) | 1071 | `mocha --recursive --bail --reporter spec test` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 1063 | `mocha` | 
...
| [expressjs/generator](https://github.com/expressjs/generator) | 1058 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 1027 | `eslint src test && mocha --compilers babel-register` | 
...
| [coralproject/talk](https://github.com/coralproject/talk) | 1017 | `npm-run-all test:jest test:server:mocha` | 
...
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 953 | `babel-node node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
...
| [symfony/webpack-encore](https://github.com/symfony/webpack-encore) | 931 | `./node_modules/.bin/mocha --reporter spec test --recursive` | 
...
| [gaearon/react-side-effect](https://github.com/gaearon/react-side-effect) | 914 | `mocha` | 
| [jeremyckahn/shifty](https://github.com/jeremyckahn/shifty) | 913 | `mocha test` | 
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 913 | `mocha spec/*.js` | 
...
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 905 | `mocha test` | 
...
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 891 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
...
| [felixge/node-dateformat](https://github.com/felixge/node-dateformat) | 884 | `mocha` | 
...
| [johnagan/clean-webpack-plugin](https://github.com/johnagan/clean-webpack-plugin) | 853 | `mocha --recursive ./test/*_spec.js` | 
...
| [bubenshchykov/ngrok](https://github.com/bubenshchykov/ngrok) | 841 | `node ./node_modules/mocha/bin/_mocha --exit` | 
...
| [webpack-contrib/html-loader](https://github.com/webpack-contrib/html-loader) | 803 | `mocha --harmony --full-trace --check-leaks` | 
| [gre/bezier-easing](https://github.com/gre/bezier-easing) | 802 | `mocha` | 
...
| [apollographql/graphql-tag](https://github.com/apollographql/graphql-tag) | 794 | `mocha test/graphql.js test/graphql-v0.12.js && tav --ci --compat` | 
...
| [pillarjs/cookies](https://github.com/pillarjs/cookies) | 793 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
...
| [edusoho/edusoho](https://github.com/edusoho/edusoho) | 790 | `mocha --recursive --reporter mochawesome --require babel-core/register tests/Js/test && open mochawesome-report/mochawesome.html && npm run test:cover` | 
...
| [GantMan/ReactStateMuseum](https://github.com/GantMan/ReactStateMuseum) | 776 | `node_modules/mocha/bin/_mocha ./test/index.js` | 
...
| [ant-design/antd-init](https://github.com/ant-design/antd-init) | 769 | `mocha --no-timeouts` | 
