...
The list was updated at 02:06:34 12/12/17 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39269 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 37794 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35532 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 34815 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28161 | `mocha --reporter spec` | 
| [caolan/async](https://github.com/caolan/async) | 22878 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19570 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 16955 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16637 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15136 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14191 | `mocha test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13580 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12287 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12187 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11899 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11661 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11524 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11484 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11249 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10374 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10291 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10243 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9729 | `NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9480 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9168 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9081 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 8990 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 8884 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [tmpvar/jsdom](https://github.com/tmpvar/jsdom) | 8849 | `mocha test/index.js` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8795 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 8713 | `cross-env NODE_ENV=test mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8682 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [svg/svgo](https://github.com/svg/svgo) | 8612 | `set NODE_ENV=test && mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8348 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8097 | `mocha test/*-test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8093 | `mocha --check-leaks -R dot` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8011 | `grunt clean:test && mocha` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 7976 | `mocha test/test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 7803 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7624 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7544 | `./node_modules/.bin/mocha test/src` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7484 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [rstacruz/jquery.transit](https://github.com/rstacruz/jquery.transit) | 7423 | `mocha` | 
| [dthree/cash](https://github.com/dthree/cash) | 7396 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7319 | `mocha --compilers js:babel-register test/test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7178 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7171 | `npm run eslint && npm run mocha` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7034 | `npm run build && istanbul cover _mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 6955 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6914 | `./node_modules/.bin/mocha test` | 
| [amark/gun](https://github.com/amark/gun) | 6882 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 6824 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6809 | `mocha tests/*.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6434 | `mocha $HARMONY_OPTS` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6353 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6316 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6274 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6145 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6140 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6044 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 5984 | `mocha --compilers js:babel-core/register` | 
...
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5777 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5748 | `nyc mocha test/** -r ./test/before` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5643 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5634 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5588 | `mocha --opts mocha.opts` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5517 | `npm run test:mocha:src` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5464 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5424 | `npm run jshint && mocha test/` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5385 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5353 | `mocha tests/node.js` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5344 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5258 | `mocha && eslint lib/**` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5247 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5166 | `mocha test --recursive` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5159 | `mocha --color` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5138 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5110 | `mocha src/**/*Tests.js --harmony` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5049 | `mocha test/test.js` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4735 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4719 | `gulp lint && mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4664 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [santinic/how2](https://github.com/santinic/how2) | 4606 | `mocha test` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4582 | `mocha --compilers js:babel-core/register` | 
...
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4545 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4507 | `mocha ./test/runner.js` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4361 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4333 | `gulp build; mocha;` | 
...
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4288 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4285 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4238 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4214 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4203 | `./node_modules/.bin/mocha` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4142 | `standard && mocha` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4091 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4078 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4001 | `mocha` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 3968 | `mocha && ./bin/shipit staging test` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 3949 | `mocha test` | 
...
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3822 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 3804 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [muicss/mui](https://github.com/muicss/mui) | 3730 | `mocha` | 
| [tj/ejs](https://github.com/tj/ejs) | 3692 | `mocha --require should --reporter spec` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3637 | `mocha && make test` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3629 | `npm run jshint && npm run mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3574 | `NODE_ENV=test mocha` | 
...
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3529 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3499 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3494 | `mocha --require test/babel-hook test/*.js` | 
| [blakeembrey/code-problems](https://github.com/blakeembrey/code-problems) | 3493 | `mocha tests/javascript` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3490 | `npm run lint && npm run mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3424 | `npm run lint ; mocha && mocha test/individual` | 
...
| [primus/primus](https://github.com/primus/primus) | 3388 | `npm run build && mocha test/*.test.js` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3361 | `nyc mocha` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3266 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3162 | `npm run build-cli && mocha` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3077 | `mocha` | 
| [easy-mock/easy-mock](https://github.com/easy-mock/easy-mock) | 3069 | `cross-env NODE_ENV=test istanbul cover _mocha test/*` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3011 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3011 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3011 | `mocha --check-leaks --reporter spec --bail` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 2982 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 2933 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 2906 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [lambci/lambci](https://github.com/lambci/lambci) | 2871 | `mocha` | 
| [expressjs/session](https://github.com/expressjs/session) | 2871 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2854 | `nyc mocha "test/**/*.test.js"` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 2848 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2803 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2794 | `npm run lint && npm run mocha` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2782 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2766 | `mocha test/*.js` | 
...
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2728 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2679 | `mocha` | 
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2670 | `istanbul cover _mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 2636 | `mocha; jshint *.js lib` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2577 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2549 | `nyc mocha && tsc` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2528 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2522 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2511 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2503 | `NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [Reportr/dashboard](https://github.com/Reportr/dashboard) | 2499 | `export TESTING=true; mocha --reporter list` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2490 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [css/csso](https://github.com/css/csso) | 2486 | `mocha --reporter dot` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2486 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2480 | `mocha` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2476 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2463 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 2425 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2413 | `mocha --compilers js:babel-register --recursive spec` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2402 | `mocha` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2392 | `mocha --reporter=spec test/*-test.js` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2387 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2346 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2324 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2310 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2295 | `mocha --opts mocha.opts` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2285 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2283 | `mocha` | 
| [postaljs/postal.js](https://github.com/postaljs/postal.js) | 2281 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2277 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2272 | `mocha` | 
...
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2238 | `npm run compile && mocha --compilers js:babel-core/register` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2229 | `mocha test/src/**/*.unit.js` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2211 | `mocha -t 30000 -R spec tests/unit/index.js` | 
| [davidmerfield/Typeset](https://github.com/davidmerfield/Typeset) | 2208 | `mocha -u bdd -R spec -t 500 --recursive` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2205 | `mocha test` | 
| [mplewis/src2png](https://github.com/mplewis/src2png) | 2201 | `mocha test test/unit/**/*_test.js` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2184 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2181 | `gulp && cd test && mocha . --reporter dot` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2181 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [octokit/node-github](https://github.com/octokit/node-github) | 2156 | `nyc mocha test/**/*-test.js` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2133 | `node_modules/.bin/mocha --reporter spec` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2119 | `NODE_ENV=test mocha` | 
| [esbenp/pdf-bot](https://github.com/esbenp/pdf-bot) | 2119 | `nyc --reporter=lcov --reporter=text mocha test/*.test.js --recursive --coverage` | 
| [mozilla/send](https://github.com/mozilla/send) | 2108 | `mocha test/unit` | 
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2097 | `npm run lint && npm run build && npm run mocha` | 
...
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2083 | `mocha -R spec` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2079 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2073 | `mocha` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2070 | `mocha test/unit --require mochahook` | 
| [json5/json5](https://github.com/json5/json5) | 2052 | `mocha --ui exports --reporter spec` | 
| [slate/slate](https://github.com/slate/slate) | 2023 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2017 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 1965 | `mocha --require should --reporter spec` | 
...
| [sandeepmistry/noble](https://github.com/sandeepmistry/noble) | 1890 | `mocha -R spec test/*.js` | 
...
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1845 | `mocha test/index.js --reporter dot` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1838 | `mocha` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 1826 | `mocha` | 
...
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1801 | `mocha --require ./test/common --growl test/expect.js` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1795 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1784 | `mocha test && npm run lint` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 1780 | `mocha` | 
...
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1759 | `mocha` | 
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1755 | `cross-env NODE_ENV=test mocha` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1740 | `mocha test.js` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 1732 | `export TESTING=true; mocha --reporter list` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1725 | `mocha -c test/index.js` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1690 | `mocha -R landing test/index` | 
| [BinaryMuse/fluxxor](https://github.com/BinaryMuse/fluxxor) | 1690 | `npm run jshint && mocha --recursive` | 
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1684 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [Automattic/knox](https://github.com/Automattic/knox) | 1678 | `mocha` | 
| [addyosmani/tmi](https://github.com/addyosmani/tmi) | 1672 | `xo && mocha` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1668 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [molnarg/node-http2](https://github.com/molnarg/node-http2) | 1667 | `istanbul test _mocha -- --reporter spec --slow 500 --timeout 15000` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1665 | `./node_modules/.bin/mocha tests/*.js --exit` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1665 | `mocha --compilers js:babel-register` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1663 | `mocha --compilers js:babel-core/register __tests__` | 
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1659 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 1630 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1616 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
| [KunalKapadia/express-mongoose-es6-rest-api](https://github.com/KunalKapadia/express-mongoose-es6-rest-api) | 1612 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1608 | `mocha -R spec spec spec/reporters` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1604 | `mocha && eslint *.js` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 1589 | `node ./node_modules/mocha/bin/mocha --reporter spec --full-trace` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1582 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1576 | `mocha` | 
...
| [gitsummore/nile.js](https://github.com/gitsummore/nile.js) | 1570 | `./node_modules/mocha/bin/mocha ./test.js` | 
...
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1544 | `mocha test/*.js` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1541 | `./node_modules/.bin/mocha` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1535 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1515 | `npm run lint && mocha` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1514 | `npm run mocha && npm run karma` | 
...
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1503 | `mocha --reporter spec --grep .` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1449 | `mocha test/` | 
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1449 | `mocha -u tdd` | 
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1449 | `./node_modules/mocha/bin/mocha -R spec` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1448 | `mocha test -u bdd -R spec` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1448 | `mocha test/* --reporter spec` | 
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1447 | `npm run lint && mocha test/unit && mocha test/runner` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1432 | `npm run lint && npm run mocha` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1418 | `npm run lint && npm run mocha` | 
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1404 | `mocha` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1336 | `mocha --reporter spec test/*.js` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1318 | `./node_modules/.bin/mocha && npm run jshint` | 
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1317 | `standard "./src/*.js" && mocha` | 
...
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1313 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
| [trufflesuite/ganache-cli](https://github.com/trufflesuite/ganache-cli) | 1305 | `mocha` | 
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1300 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1295 | `mocha --compilers js:babel-register` | 
| [kss-node/kss-node](https://github.com/kss-node/kss-node) | 1290 | `istanbul cover _mocha` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1248 | `standard "src/*.js" && npm run build && mocha` | 
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1248 | `npm run build && mocha -r should` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1246 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1214 | `mocha --timeout 10000 ./tests/lib.js` | 
...
| [expressjs/compression](https://github.com/expressjs/compression) | 1205 | `mocha --check-leaks --reporter spec --bail` | 
| [yyx990803/pod](https://github.com/yyx990803/pod) | 1201 | `mocha test/api.js -r jscoverage -R spec --slow 1250 --timeout 5000 && bash test/cli.sh` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1189 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1175 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1156 | `mocha` | 
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1154 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1153 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [markdalgleish/static-site-generator-webpack-plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin) | 1149 | `istanbul cover _mocha test -- --timeout 20000` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1147 | `mocha --full-trace --check-leaks` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1140 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1124 | `mocha compiled_tests/` | 
| [oracle/node-oracledb](https://github.com/oracle/node-oracledb) | 1115 | `mocha --opts test/opts/mocha.opts` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1100 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
...
| [normalize/mz](https://github.com/normalize/mz) | 1077 | `mocha --reporter spec` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1067 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [fent/randexp.js](https://github.com/fent/randexp.js) | 1061 | `istanbul cover node_modules/.bin/_mocha -- test/*-test.js` | 
| [neumino/thinky](https://github.com/neumino/thinky) | 1059 | `mocha --check-leaks -t 20000` | 
| [sorrycc/roadhog](https://github.com/sorrycc/roadhog) | 1056 | `npm run lint && npm run build && cross-env NODE_ENV=test nyc mocha --no-timeouts test/**/*-test.js` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1043 | `mocha` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1039 | `node_modules/.bin/mocha` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1038 | `mocha src/test.js` | 
| [3rd-Eden/memcached](https://github.com/3rd-Eden/memcached) | 1034 | `mocha $(find test -name '*.test.js')` | 
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1033 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1026 | `mocha test --timeout 600000` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1008 | `mocha --reporter dot` | 
...
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1002 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 983 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 983 | `eslint src && mocha && karma start --single-run` | 
...
| [hokaccha/node-jwt-simple](https://github.com/hokaccha/node-jwt-simple) | 961 | `istanbul cover _mocha test/*.js` | 
| [yeoman/generator-mobile](https://github.com/yeoman/generator-mobile) | 959 | `mocha --timeout 5000` | 
| [googlevr/webvr-polyfill](https://github.com/googlevr/webvr-polyfill) | 958 | `mocha` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 947 | `NODE_PATH=. mocha **/*.spec.js` | 
...
| [FormidableLabs/redux-little-router](https://github.com/FormidableLabs/redux-little-router) | 943 | `BABEL_ENV=commonjs mocha test/.setup.js 'test/**/*.spec.js'` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 939 | `eslint . && mocha -t 5000` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 930 | `standard && mocha` | 
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 924 | `mocha` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 917 | `mocha tests/test-*` | 
...
| [angular-redux/ng-redux](https://github.com/angular-redux/ng-redux) | 911 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive` | 
| [tomas/needle](https://github.com/tomas/needle) | 910 | `mocha test` | 
| [dabeng/OrgChart](https://github.com/dabeng/OrgChart) | 904 | `mocha ./test/**/*-tests.js` | 
| [codemix/babel-plugin-typecheck](https://github.com/codemix/babel-plugin-typecheck) | 903 | `mocha ./test/index.js` | 
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 901 | ` NODE_ENV=test mocha --compilers js:babel-register` | 
...
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 880 | `mocha -t 120000 test/*.test.js` | 
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 879 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 876 | `mocha test` | 
| [oortcloud/meteorite](https://github.com/oortcloud/meteorite) | 874 | `mocha spec/unit spec/acceptance -t 240000 -R spec` | 
| [pid/speakingurl](https://github.com/pid/speakingurl) | 872 | `mocha` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 860 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
...
| [electron/asar](https://github.com/electron/asar) | 854 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
...
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 846 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 845 | `standard src/index.js && mocha --compilers js:babel-register` | 
...
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 843 | `mocha` | 
...
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 837 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [MohammadYounes/rtlcss](https://github.com/MohammadYounes/rtlcss) | 822 | `npm run lint && mocha -R spec` | 
| [electron/spectron](https://github.com/electron/spectron) | 821 | `mocha && standard` | 
...
| [lightning-viz/lightning](https://github.com/lightning-viz/lightning) | 817 | `mocha --timeout 200000` | 
...
| [gulpjs/gulp-util](https://github.com/gulpjs/gulp-util) | 810 | `jshint *.js lib/*.js test/*.js && mocha` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 803 | `nyc mocha --timeout=20000 test.js` | 
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 801 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [reactivestack/cookies](https://github.com/reactivestack/cookies) | 766 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
...
| [leizongmin/node-segment](https://github.com/leizongmin/node-segment) | 760 | `mocha -t 5000` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 753 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 745 | `mocha ./test/test*.js --reporter spec` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 722 | `mocha -R spec` | 
| [react-materialize/react-materialize](https://github.com/react-materialize/react-materialize) | 721 | `mocha` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 720 | `npm run lint && mocha --compilers js:babel-register` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 714 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [coralproject/talk](https://github.com/coralproject/talk) | 712 | `TEST_MODE=unit NODE_ENV=test jest && TEST_MODE=unit NODE_ENV=test mocha -R ${MOCHA_REPORTER:-spec}` | 
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 711 | `mocha spec/*.js` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 708 | `mocha -R spec --compilers js:babel-core/register ./tests/setup.js ./tests/** --recursive` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 703 | `./node_modules/.bin/mocha -R spec` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 694 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
| [webpro/DOMtastic](https://github.com/webpro/DOMtastic) | 693 | `npm run bundle && mocha` | 
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 686 | `cross-env NODE_ENV=test nyc mocha` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 682 | `npm run lint && nyc mocha test/**` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 674 | `mocha tests/*.js` | 
...
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 664 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 655 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require babel-register --no-timeouts` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 650 | `eslint src test && mocha --compilers babel-register` | 
