...
The list was updated at 02:06:21 01/03/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39436 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 38250 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35879 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 35462 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28313 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23037 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19944 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17130 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16985 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15260 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14383 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 14239 | `cross-env NODE_ENV=test mocha` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13635 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12491 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12341 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11922 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11743 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11693 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11549 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11379 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10642 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10518 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10338 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9938 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9656 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9302 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9154 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9116 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 8977 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [tmpvar/jsdom](https://github.com/tmpvar/jsdom) | 8954 | `mocha test/index.js` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8894 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 8745 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8743 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
...
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7663 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7622 | `./node_modules/.bin/mocha test/src` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7581 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7389 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7380 | `mocha --compilers js:babel-register test/test.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7200 | `npm run eslint && npm run mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 7154 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7076 | `npm run build && istanbul cover _mocha` | 
| [amark/gun](https://github.com/amark/gun) | 7029 | `mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6977 | `./node_modules/.bin/mocha test` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 6973 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6955 | `mocha tests/*.js` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6520 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6471 | `mocha $HARMONY_OPTS` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6463 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6342 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6262 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6240 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6145 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 6073 | `mocha --compilers js:babel-core/register` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6017 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5934 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5928 | `nyc mocha test/** -r ./test/before` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5928 | `mocha` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5901 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5778 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5708 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5679 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5635 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5502 | `npm run jshint && mocha test/` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5445 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5389 | `mocha tests/node.js` | 
...
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5263 | `mocha test --recursive` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5192 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5164 | `mocha --color` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5124 | `mocha test/test.js` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5117 | `mocha src/**/*Tests.js --harmony` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5007 | `mocha --timeout 10000 && npm run lint` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4839 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4821 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4746 | `mocha --compilers js:babel-core/register` | 
...
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4597 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4571 | `mocha -R spec 'tests/app'` | 
...
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4399 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4373 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4370 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4363 | `gulp build; mocha;` | 
...
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4267 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4251 | `./node_modules/.bin/mocha` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4229 | `standard && mocha` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4225 | `mocha -R spec ./test --recursive` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4123 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4122 | `mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4095 | `mocha` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4012 | `mocha test` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 3996 | `mocha && ./bin/shipit staging test` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3992 | `mocha` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 3957 | `nyc mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 3890 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3705 | `mocha --recursive && make test` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3653 | `NODE_ENV=test mocha` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3634 | `npm run jshint && npm run mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3615 | `mocha --require test/babel-hook test/*.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3615 | `npm run build-cli && mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3558 | `istanbul test node_modules/mocha/bin/_mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3536 | `npm run lint && npm run mocha` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3415 | `nyc mocha` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3341 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3291 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [easy-mock/easy-mock](https://github.com/easy-mock/easy-mock) | 3166 | `cross-env NODE_ENV=test istanbul cover _mocha test/*` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3101 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3084 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3077 | `mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3076 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3072 | `mocha --check-leaks --reporter spec --bail` | 
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3062 | `mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 3055 | `mocha; jshint *.js lib` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3049 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3043 | `./node_modules/.bin/mocha test/test.*.js` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3035 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3016 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 2974 | `node_modules/.bin/mocha test/tests.js` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 2969 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [arkency/reactjs_koans](https://github.com/arkency/reactjs_koans) | 2946 | `npm run compile && mocha -b --compilers js:babel/register --require test/helpers.js test/**/*.js || echo` | 
| [expressjs/session](https://github.com/expressjs/session) | 2935 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2917 | `nyc mocha "test/**/*.test.js"` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2912 | `npm run lint && npm run mocha` | 
| [googlesamples/md2googleslides](https://github.com/googlesamples/md2googleslides) | 2895 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2883 | `mocha` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2843 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2842 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2787 | `mocha test/*.js` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2780 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2773 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2689 | `mocha` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2681 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2670 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2646 | `mocha test/index.js && npm run demo` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2634 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2605 | `nyc mocha && tsc` | 
...
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2564 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2559 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2559 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2551 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2536 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2530 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2520 | `mocha` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2514 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2502 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2501 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2501 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2486 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2477 | `npm run mocha && npm run lint` | 
...
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2455 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2420 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2412 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2401 | `mocha --reporter=spec test/*-test.js` | 
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2388 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2353 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2352 | `npm run compile && mocha --compilers js:babel-core/register` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2340 | `mocha` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2333 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [katiefenn/parker](https://github.com/katiefenn/parker) | 2319 | `mocha --no-colors --reporter spec` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2313 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [uber-archive/image-diff](https://github.com/uber-archive/image-diff) | 2311 | `grunt jshint && mocha` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2306 | `mocha` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2252 | `mocha -t 30000 -R spec tests/unit/index.js` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2245 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2238 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [agershun/alasql](https://github.com/agershun/alasql) | 2211 | `gulp && cd test && mocha . --reporter dot` | 
| [davidmerfield/Typeset](https://github.com/davidmerfield/Typeset) | 2208 | `mocha -u bdd -R spec -t 500 --recursive` | 
| [mplewis/src2png](https://github.com/mplewis/src2png) | 2206 | `mocha test test/unit/**/*_test.js` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2203 | `NODE_ENV=test mocha` | 
| [octokit/node-github](https://github.com/octokit/node-github) | 2194 | `nyc mocha test/**/*-test.js` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2189 | `node_modules/.bin/mocha --reporter spec` | 
| [mozilla/send](https://github.com/mozilla/send) | 2153 | `mocha test/unit` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2140 | `mocha` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2131 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2109 | `mocha test/unit --require mochahook` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2053 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2037 | `mocha` | 
...
| [lynndylanhurley/redux-auth](https://github.com/lynndylanhurley/redux-auth) | 1963 | `node_modules/.bin/_mocha --timeout 5000 --compilers .:test/compiler.js test/runner.js` | 
...
| [weui/react-weui](https://github.com/weui/react-weui) | 1881 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 1852 | `mocha ./test/*.spec.js` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1852 | `mocha` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1850 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1837 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 1835 | `export TESTING=true; mocha --reporter list` | 
...
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1817 | `mocha` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1785 | `mocha test.js` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1783 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1732 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1722 | `mocha test/runner.js --reporter spec` | 
| [lipp/login-with](https://github.com/lipp/login-with) | 1721 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1715 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1710 | `./node_modules/.bin/mocha tests/*.js --exit` | 
...
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1690 | `mocha --compilers js:babel-core/register __tests__` | 
| [BinaryMuse/fluxxor](https://github.com/BinaryMuse/fluxxor) | 1690 | `npm run jshint && mocha --recursive` | 
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1688 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1675 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1660 | `mocha test` | 
...
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1651 | `mocha` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1630 | `mocha && eslint *.js` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1619 | `mocha -R spec spec spec/reporters` | 
| [Automattic/juice](https://github.com/Automattic/juice) | 1616 | `mocha --reporter spec && npm run test-typescript` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1603 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1594 | `./node_modules/mocha/bin/mocha -R spec` | 
| [gitsummore/nile.js](https://github.com/gitsummore/nile.js) | 1579 | `./node_modules/mocha/bin/mocha ./test.js` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1577 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1576 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1562 | `npm run mocha && npm run karma` | 
...
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1533 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1530 | `mocha && npm run lint` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1512 | `nyc npm run _mocha` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1507 | `mocha` | 
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1506 | `npm run mocha && npm run lint` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1494 | `mocha tests --compilers js:babel-core/register` | 
...
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1487 | `mocha` | 
...
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1470 | `npm run lint && mocha test/unit && mocha test/runner` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1468 | `mocha spec/` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1468 | `mocha ./test/basic.js -t 5000` | 
...
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1460 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1442 | `mocha` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1407 | `mocha --reporter spec test/*.js` | 
...
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1386 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1361 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1340 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1335 | `eslint --rulesdir=dev-tools/eslint --cache . && tsc && mocha` | 
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1335 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1318 | `standard "src/*.js" && npm run build && mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1304 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1303 | `mocha test.js` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1236 | `mocha --timeout 10000 ./tests/lib.js` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1231 | `mocha --check-leaks --reporter spec --bail` | 
| [zeit/ms](https://github.com/zeit/ms) | 1227 | `mocha tests.js` | 
| [dlmanning/gulp-sass](https://github.com/dlmanning/gulp-sass) | 1227 | `./node_modules/.bin/mocha test` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1224 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1210 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1209 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [donejs/donejs](https://github.com/donejs/donejs) | 1209 | `npm run jshint && npm run mocha && npm run document && npm run test-guides` | 
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1209 | `mocha test/setup.js test/spec/*.js` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1206 | `mocha test --timeout 600000` | 
| [electron/devtron](https://github.com/electron/devtron) | 1205 | `mocha test/unit/*-test.js test/integration/*-test.js && standard` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1203 | `mocha` | 
...
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1181 | `npm run lint && npm run mocha` | 
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1181 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [ToothlessGear/node-gcm](https://github.com/ToothlessGear/node-gcm) | 1177 | `mocha test/**/*Spec.js` | 
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1177 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1172 | `mocha compiled_tests/` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1115 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1113 | `mocha --check-leaks --require @babel/register` | 
...
| [variety/variety](https://github.com/variety/variety) | 1080 | `node_modules/.bin/mocha --compilers js:babel-core/register --require babel-polyfill  --recursive --reporter spec --timeout 15000 spec` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1052 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1044 | `eslint . && mocha -t 5000` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1037 | `standard && istanbul cover _mocha` | 
...
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1025 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
...
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1008 | `mocha test/unit` | 
...
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1003 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 961 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
...
| [levelgraph/levelgraph](https://github.com/levelgraph/levelgraph) | 951 | `mocha --recursive --bail --reporter spec test` | 
| [brianreavis/sifter.js](https://github.com/brianreavis/sifter.js) | 950 | `mocha -R list` | 
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 949 | `mocha tests/test-*` | 
...
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 937 | `mocha` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 924 | `mocha test` | 
| [OverZealous/run-sequence](https://github.com/OverZealous/run-sequence) | 923 | `mocha --reporter spec` | 
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 922 | ` NODE_ENV=test mocha --compilers js:babel-register` | 
...
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 898 | `mocha -t 120000 test/*.test.js` | 
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 896 | `standard && mocha -b` | 
...
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 865 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [SamyPesse/betty](https://github.com/SamyPesse/betty) | 865 | `mocha --reporter list` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 863 | `mocha --recursive test` | 
...
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 849 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 843 | `mocha` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 842 | `nyc mocha --timeout=20000 test.js` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 836 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [js-joda/js-joda](https://github.com/js-joda/js-joda) | 829 | `./node_modules/.bin/mocha --timeout 5000 --compilers js:babel-core/register ./test/*Test.js ./test/**/*Test.js ./test/**/**/*Test.js ./test/*Test_mochaOnly.js` | 
| [js-joda/js-joda](https://github.com/js-joda/js-joda) | 829 | `./node_modules/.bin/mocha --timeout 5000 --compilers js:babel-core/register ./test/*Test.js ./test/**/*Test.js ./test/**/**/*Test.js ./test/*Test_mochaOnly.js` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 820 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 794 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 783 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 782 | `mocha ./test/test*.js --reporter spec` | 
...
| [alexa-js/alexa-app](https://github.com/alexa-js/alexa-app) | 768 | `./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [coralproject/talk](https://github.com/coralproject/talk) | 750 | `TEST_MODE=unit NODE_ENV=test jest && TEST_MODE=unit NODE_ENV=test mocha -R ${MOCHA_REPORTER:-spec}` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 746 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 715 | `mocha tests/*.js` | 
...
| [raineroviir/react-redux-socketio-chat](https://github.com/raineroviir/react-redux-socketio-chat) | 692 | `mocha './test/**/*.test.js' --compilers js:babel-core/register --recursive` | 
...
| [datastax/nodejs-driver](https://github.com/datastax/nodejs-driver) | 683 | `./node_modules/.bin/mocha test/unit -R spec -t 5000` | 
