...
The list was updated at 02:06:47 04/01/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40334 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40082 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 37448 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29091 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23661 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22671 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21371 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20949 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18229 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17881 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15850 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15282 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13940 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13600 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12979 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12371 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12229 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12072 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11935 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11886 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11828 | `mocha --reporter spec test/*-test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11526 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 11043 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10786 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10418 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9980 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9871 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9539 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9482 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9459 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9333 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9312 | `set NODE_ENV=test && mocha` | 
...
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8641 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8537 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8361 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8221 | `mocha test/test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8214 | `mocha --check-leaks -R dot` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8136 | `grunt clean:test && mocha --exit` | 
| [websockets/ws](https://github.com/websockets/ws) | 8127 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8036 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7978 | `./node_modules/.bin/mocha test/src` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7866 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7842 | `mocha --compilers js:babel-register test/test.js` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7828 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [amark/gun](https://github.com/amark/gun) | 7824 | `mocha` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7618 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7523 | `mocha tests/*.js` | 
...
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7277 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7239 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7192 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7152 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6987 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6681 | `nyc mocha test/**/* -r ./test/before` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6675 | `mocha --opts mocha.opts` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6624 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6622 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6593 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6553 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6548 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6536 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6439 | `mocha --compilers js:babel-core/register` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6139 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6047 | `npm run lint -s && npm run mocha -s` | 
...
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5969 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5950 | `npm run test:mocha:src` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5925 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5857 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5687 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5604 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5575 | `mocha tests/node.js` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5512 | `mocha test/test.js` | 
...
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5396 | `mocha --exit --require babel-core/register` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5343 | `npm run build-cli && mocha` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5263 | `mocha` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5124 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4914 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
...
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4775 | `mocha; jshint *.js lib` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4756 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4743 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4687 | `mocha` | 
...
| [expressjs/multer](https://github.com/expressjs/multer) | 4643 | `standard && mocha` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4640 | `mocha --reporter spec -t 8000` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4575 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
...
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4536 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [prerender/prerender](https://github.com/prerender/prerender) | 4404 | `./node_modules/.bin/mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4310 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4280 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4254 | `mocha` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4036 | `mocha --recursive && make test` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3889 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3876 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [CodeboxIDE/codebox](https://github.com/CodeboxIDE/codebox) | 3857 | `export TESTING=true; mocha --reporter list` | 
| [tj/ejs](https://github.com/tj/ejs) | 3823 | `mocha --require should --reporter spec` | 
| [erming/shout](https://github.com/erming/shout) | 3815 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3758 | `mocha -R spec ./test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3729 | `nyc mocha` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3722 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3714 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3649 | `mocha ./test/*.spec.js` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3647 | `npm run jshint && npm run mocha` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3597 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3506 | `npm run lint && npm run mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3500 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3400 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3390 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3383 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3275 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3256 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3241 | `nyc mocha "test/**/*.test.js"` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 3210 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3181 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3102 | `mocha` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3097 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3089 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3044 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 3018 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [gsuitedevs/md2googleslides](https://github.com/gsuitedevs/md2googleslides) | 2943 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2939 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2890 | `nyc mocha && tsc` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2889 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2865 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2829 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2819 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2797 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2795 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2790 | `mocha` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2786 | `mocha test/index.js && npm run demo` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2784 | `mocha -R spec --recursive src/test` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2763 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2763 | `mocha --require should --reporter spec` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2762 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2741 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2704 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2700 | `mocha` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2685 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2670 | `mocha --opts mocha.opts` | 
...
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2650 | `xo && mocha` | 
...
| [css/csso](https://github.com/css/csso) | 2605 | `mocha --reporter dot` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2600 | `mocha --timeout 100000` | 
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2597 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2597 | `yarn tsc && yarn lint && mocha` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2565 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2563 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2543 | `mocha --compilers js:babel-register --recursive spec` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2538 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2538 | `mocha --recursive --watch` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2532 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2520 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2430 | `node_modules/.bin/mocha --reporter spec` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2409 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2405 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2395 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2326 | `mocha test` | 
| [json5/json5](https://github.com/json5/json5) | 2307 | `nyc --reporter=html --reporter=text mocha` | 
| [mde/ejs](https://github.com/mde/ejs) | 2274 | `mocha --require should --reporter spec` | 
...
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2267 | `mocha "test/**/*-test.js"` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2156 | `mocha test.js` | 
...
| [noble/noble](https://github.com/noble/noble) | 2050 | `mocha -R spec test/*.js` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2046 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2044 | `mocha && eslint .` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 2024 | `mocha test && npm run lint` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1988 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1929 | `mocha -c test/index.js` | 
| [Qix-/color](https://github.com/Qix-/color) | 1924 | `mocha` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1924 | `mocha --compilers js:babel-register` | 
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1907 | `mocha test/index.js --reporter dot` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1903 | `mocha` | 
| [1602/jugglingdb](https://github.com/1602/jugglingdb) | 1902 | `mocha --bail --reporter spec --check-leaks test/` | 
| [lukehaas/RegexHub](https://github.com/lukehaas/RegexHub) | 1895 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1888 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1877 | `mocha test/runner.js --reporter spec` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1864 | `mocha --require ./test/common --growl test/expect.js` | 
| [yeoman/generator-chrome-extension](https://github.com/yeoman/generator-chrome-extension) | 1864 | `mocha --reporter spec --timeout 5000` | 
...
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1841 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1835 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
...
| [then/promise](https://github.com/then/promise) | 1813 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1809 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
| [diegonetto/generator-ionic](https://github.com/diegonetto/generator-ionic) | 1803 | `mocha --timeout 5000` | 
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1794 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1765 | `mocha && eslint *.js` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1763 | `npm run lint && mocha -R dot && npm run cover` | 
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1763 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1728 | `mocha test` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1724 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1722 | `mocha -R spec spec spec/reporters` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1711 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1658 | `mocha` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1626 | `npm run lint && npm run mocha` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1611 | `mocha tests --compilers js:babel-core/register` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1590 | `mocha test/**/*.js` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1583 | `mocha --reporter spec test/*.js` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1578 | `mocha` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1575 | `mocha test --timeout 600000` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1570 | `mocha ./test/basic.js -t 5000` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1567 | `standard "src/*.js" && npm run build && mocha` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1499 | `mocha --compilers js:babel-register` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1495 | `eslint . && mocha -t 5000` | 
| [intercellular/cell](https://github.com/intercellular/cell) | 1488 | `npm run test:lint && npm run test:mocha` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1454 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1421 | `mocha --check-leaks -R dot` | 
...
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1412 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1387 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1376 | `mocha compiled_tests/` | 
| [zeit/ms](https://github.com/zeit/ms) | 1375 | `mocha tests.js` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1373 | `mocha --recursive` | 
| [squaremo/rabbit.js](https://github.com/squaremo/rabbit.js) | 1372 | `./node_modules/mocha/bin/mocha --ui exports test` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1369 | `mocha --check-leaks --reporter spec --bail` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1348 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [noble/bleno](https://github.com/noble/bleno) | 1301 | `mocha -R spec test/*.js` | 
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1300 | `npm run build && mocha -r should` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1263 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1236 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
...
| [oracle/node-oracledb](https://github.com/oracle/node-oracledb) | 1212 | `mocha --opts test/opts/mocha.opts` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1190 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
...
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1158 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1154 | `eslint src && mocha && karma start --single-run` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1153 | `mocha --reporter dot` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1145 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [normalize/mz](https://github.com/normalize/mz) | 1134 | `mocha --reporter spec` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1129 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1080 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [3rd-Eden/memcached](https://github.com/3rd-Eden/memcached) | 1069 | `mocha $(find test -name '*.test.js')` | 
...
| [hokaccha/node-jwt-simple](https://github.com/hokaccha/node-jwt-simple) | 1036 | `istanbul cover _mocha test/*.js` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1031 | ` NODE_ENV=test mocha --require babel-core/register` | 
| [sghall/resonance](https://github.com/sghall/resonance) | 1025 | `cross-env NODE_ENV=test BABEL_ENV=test mocha "src/**/*.spec.js"` | 
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1024 | `npm run prepublishOnly && mocha test/test.js` | 
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1024 | `mocha` | 
...
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1014 | `mocha test/tests.js` | 
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 1006 | `mocha` | 
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1004 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 987 | `mocha --compilers js:babel-core/register` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 987 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 986 | `mocha --recursive test` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 983 | `mocha -R spec ./test/unit/**` | 
...
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 977 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 976 | `mocha` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 969 | `mocha tests/*.js` | 
...
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 962 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 962 | `mocha ./test/test*.js --reporter spec` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 946 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 945 | `mocha` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 922 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 899 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 894 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 878 | `mocha ./test -R spec` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 873 | `TEST=all mocha` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 835 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 832 | `mocha --timeout 20000` | 
...
| [start-react/sb-admin-react](https://github.com/start-react/sb-admin-react) | 807 | `mocha "src/**/*.test.js" --require test/setup.js --compilers js:babel-register` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 801 | `npm run mocha:istanbul` | 
...
| [leizongmin/node-segment](https://github.com/leizongmin/node-segment) | 796 | `mocha -t 5000` | 
...
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 788 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
...
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 762 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
...
| [JoshuaWise/better-sqlite3](https://github.com/JoshuaWise/better-sqlite3) | 734 | `$(npm bin)/mocha --bail --timeout 5000 --slow 5000` | 
...
| [lodash/lodash-webpack-plugin](https://github.com/lodash/lodash-webpack-plugin) | 710 | `mocha --check-leaks --slow 1e3 -r @babel/register` | 
