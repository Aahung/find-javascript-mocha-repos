...
The list was updated at 02:07:02 02/13/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39738 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39240 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 37056 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [expressjs/express](https://github.com/expressjs/express) | 36599 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28759 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23366 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22101 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 20666 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 18988 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 17654 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17501 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15555 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14816 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13782 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13027 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12647 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12040 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12018 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11992 | `mocha` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11680 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11650 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11211 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10946 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10560 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10414 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
...
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9465 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [tj/co](https://github.com/tj/co) | 9305 | `mocha --harmony` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9237 | `mocha test/index.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9228 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9103 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 8995 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8870 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8519 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8365 | `mocha test/*-test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8288 | `mocha` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8142 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8125 | `mocha test/test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7867 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7813 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7776 | `./node_modules/.bin/mocha test/src` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7737 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7678 | `mocha --compilers js:babel-register test/test.js` | 
| [websockets/ws](https://github.com/websockets/ws) | 7650 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
...
| [lovell/sharp](https://github.com/lovell/sharp) | 7423 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [amark/gun](https://github.com/amark/gun) | 7362 | `mocha` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7332 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7218 | `mocha tests/*.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7148 | `npm run build && istanbul cover _mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7101 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6856 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6792 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6583 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6548 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6483 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6428 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6343 | `mocha --opts mocha.opts` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6332 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6287 | `nyc mocha test/**/* -r ./test/before` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6241 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [almende/vis](https://github.com/almende/vis) | 6239 | `mocha --compilers js:babel-core/register` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6174 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 6115 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5928 | `npm run jshint -s && npm run mocha -s` | 
...
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5779 | `npm run test:mocha:src` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5686 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5675 | `npm run jshint && mocha test/` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5486 | `mocha tests/node.js` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5455 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5435 | `mocha test --recursive` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5386 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5359 | `mocha && eslint lib/**` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5325 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5311 | `mocha test/test.js` | 
...
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5107 | `mocha --timeout 10000 && npm run lint` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5070 | `mocha --exit --require babel-core/register` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4981 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4967 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
...
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4683 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4651 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
...
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4549 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4533 | `mocha ./test/runner.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 4508 | `npm run build-cli && mocha` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4451 | `gulp build; mocha;` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4415 | `standard && mocha` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4389 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4382 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4370 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4328 | `mocha` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4326 | `./node_modules/.bin/mocha` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4253 | `mocha` | 
...
| [lebab/lebab](https://github.com/lebab/lebab) | 4185 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4150 | `mocha test` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 4099 | `mocha` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4085 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 4063 | `mocha && ./bin/shipit staging test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 3996 | `nyc mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 3898 | `mocha; jshint *.js lib` | 
...
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3846 | `mocha --require test/babel-hook test/*.js` | 
| [muicss/mui](https://github.com/muicss/mui) | 3820 | `mocha` | 
| [erming/shout](https://github.com/erming/shout) | 3820 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3801 | `NODE_ENV=test mocha` | 
| [tj/ejs](https://github.com/tj/ejs) | 3782 | `mocha --require should --reporter spec` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3733 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3717 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3640 | `npm run jshint && npm run mocha` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3629 | `nyc mocha` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3602 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
...
| [primus/primus](https://github.com/primus/primus) | 3457 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3451 | `mocha --reporter spec --timeout 3000` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3450 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3382 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3362 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3347 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3275 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3273 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3205 | `mocha --check-leaks --reporter spec --bail` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3186 | `npm run lint && npm run mocha` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3168 | `mocha ./test/*.spec.js` | 
...
| [shoutem/ui](https://github.com/shoutem/ui) | 3117 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3095 | `mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3072 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3070 | `mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3066 | `nyc mocha "test/**/*.test.js"` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3062 | `./node_modules/.bin/mocha test/test.*.js` | 
| [expressjs/session](https://github.com/expressjs/session) | 3053 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [lambci/lambci](https://github.com/lambci/lambci) | 2932 | `mocha` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2929 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2863 | `mocha test/*.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2859 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2843 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2779 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2728 | `nyc mocha && tsc` | 
...
| [aui/font-spider](https://github.com/aui/font-spider) | 2716 | `mocha test/index.js && npm run demo` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2715 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2702 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2692 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2682 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 2665 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [github-tools/github](https://github.com/github-tools/github) | 2664 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2654 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
...
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2644 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2633 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2626 | `mocha` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2611 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2608 | `xo && mocha` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2602 | `mocha` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2592 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2577 | `mocha-phantomjs ./test/index.html` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2575 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2573 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2565 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2562 | `mocha --opts mocha.opts` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2478 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2449 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2441 | `mocha` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2400 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2366 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2364 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2321 | `NODE_ENV=test mocha` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2317 | `mocha -t 30000 -R spec tests/unit/index.js` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2307 | `node_modules/.bin/mocha --reporter spec` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2301 | `nyc mocha` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2291 | `nyc mocha 'test/**/*-test.js'` | 
...
| [mozilla/send](https://github.com/mozilla/send) | 2287 | `mocha test/unit` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2273 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2252 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2170 | `mocha "test/**/*-test.js"` | 
| [mde/ejs](https://github.com/mde/ejs) | 2151 | `mocha --require should --reporter spec` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2151 | `mocha -R spec` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2132 | `mocha` | 
| [gajus/swing](https://github.com/gajus/swing) | 2132 | `mocha --compilers js:babel-register` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2095 | `export TESTING=true; mocha --reporter list` | 
...
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2042 | `nyc --reporter=html --reporter=text mocha` | 
...
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2013 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [noble/noble](https://github.com/noble/noble) | 1989 | `mocha -R spec test/*.js` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 1970 | `mocha && eslint .` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 1969 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1956 | `mocha test.js` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1946 | `mocha -R landing test/index` | 
| [hojberg/cssarrowplease](https://github.com/hojberg/cssarrowplease) | 1927 | `mocha --require=test/test_helper.js` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1911 | `mocha test && npm run lint` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1901 | `mocha` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1900 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 1864 | `mocha` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1859 | `mocha` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1841 | `mocha --require ./test/common --growl test/expect.js` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1834 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [yeoman/generator-chrome-extension](https://github.com/yeoman/generator-chrome-extension) | 1829 | `mocha --reporter spec --timeout 5000` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 1791 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1784 | `mocha test/runner.js --reporter spec` | 
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1782 | `cross-env NODE_ENV=test mocha` | 
| [then/promise](https://github.com/then/promise) | 1766 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1765 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
...
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1753 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1721 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1709 | `mocha` | 
...
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1698 | `mocha test` | 
| [share/sharedb](https://github.com/share/sharedb) | 1698 | `./node_modules/.bin/mocha && npm run jshint` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1697 | `npm run lint && mocha --reporter spec test/*.js` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1665 | `npm run lint && mocha server/test --recursive --exit` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1658 | `npm run mocha && npm run karma` | 
| [Automattic/juice](https://github.com/Automattic/juice) | 1658 | `mocha --reporter spec && npm run test-typescript` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 1655 | `node ./node_modules/mocha/bin/mocha --reporter spec --full-trace` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1654 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [shouldjs/should.js](https://github.com/shouldjs/should.js) | 1620 | `mocha -R mocha-better-spec-reporter --require ./cjs/should --color --check-leaks ./test/*.test.js ./test/**/*.test.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1613 | `nyc npm run _mocha` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1590 | `mocha && npm run lint` | 
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1574 | `mocha test/*.js` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1569 | `mocha` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1561 | `mocha` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1561 | `mocha --reporter spec --grep .` | 
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1559 | `npm run mocha && npm run lint` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1558 | `npm run lint && mocha` | 
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1556 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1553 | `mocha tests --compilers js:babel-core/register` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1535 | `npm run lint && npm run mocha` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1532 | `mocha test -u bdd -R spec` | 
...
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1513 | `mocha test/* --reporter spec` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1466 | `mocha test --timeout 600000` | 
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1463 | `mocha -u tdd` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1453 | `standard "src/*.js" && npm run build && mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1381 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1375 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1337 | `mocha --recursive` | 
...
| [kss-node/kss-node](https://github.com/kss-node/kss-node) | 1320 | `istanbul cover _mocha` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1320 | `mocha` | 
| [adleroliveira/dreamjs](https://github.com/adleroliveira/dreamjs) | 1318 | `mocha` | 
| [zeit/ms](https://github.com/zeit/ms) | 1312 | `mocha tests.js` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1302 | `mocha --check-leaks --reporter spec --bail` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1300 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1277 | `mocha --timeout 10000 ./tests/lib.js` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1275 | `eslint . && mocha -t 5000` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1275 | `mocha` | 
| [noble/bleno](https://github.com/noble/bleno) | 1275 | `mocha -R spec test/*.js` | 
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1273 | `npm run build && mocha -r should` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1248 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
...
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1235 | `npm run lint && npm run mocha` | 
...
| [lukehaas/Scrollify](https://github.com/lukehaas/Scrollify) | 1217 | `mocha ./test/scrollify_test.js --recursive ./test` | 
...
| [andywer/leakage](https://github.com/andywer/leakage) | 1202 | `mocha --timeout 10000 test/ && standard src/**/*.js test/**/*.js` | 
...
| [patriksimek/node-mssql](https://github.com/patriksimek/node-mssql) | 1116 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
...
| [Yomguithereal/mnemonist](https://github.com/Yomguithereal/mnemonist) | 1093 | `mocha` | 
...
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1092 | `mocha test/unit` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1091 | `mocha --reporter dot` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1090 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1089 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1089 | `standard && istanbul cover _mocha` | 
| [derbyjs/racer](https://github.com/derbyjs/racer) | 1089 | `node_modules/.bin/mocha && npm run lint` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1084 | `node_modules/.bin/mocha` | 
...
| [markdalgleish/redial](https://github.com/markdalgleish/redial) | 1080 | `babel-istanbul cover _mocha && babel-istanbul check-coverage --branches 100` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1075 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1059 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [babel/gulp-babel](https://github.com/babel/gulp-babel) | 1048 | `xo && mocha` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1037 | `mocha test` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1036 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
...
| [pauldijou/redux-act](https://github.com/pauldijou/redux-act) | 998 | `NODE_ENV=test mocha --recursive --compilers js:babel-core/register --reporter mocha-better-spec-reporter` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 974 | ` NODE_ENV=test mocha --require babel-core/register` | 
| [teambit/bit](https://github.com/teambit/bit) | 973 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 968 | `npm run prepublish && mocha test/test.js` | 
...
| [lukasoppermann/html5sortable](https://github.com/lukasoppermann/html5sortable) | 957 | `mocha test/umd/module.js && mocha test/*.js && npm run standard && npm run standard-test && standard-readme` | 
...
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 938 | `mocha` | 
| [OverZealous/run-sequence](https://github.com/OverZealous/run-sequence) | 936 | `mocha --reporter spec` | 
...
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 925 | `standard && mocha -b` | 
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 923 | `mocha --compilers js:babel-core/register` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 920 | `nyc mocha --timeout=20000 test.js` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 919 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 913 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [ryanflorence/ember-tools](https://github.com/ryanflorence/ember-tools) | 911 | `node_modules/.bin/mocha --require should --reporter dot --ui bdd --growl $(find test -name "*.spec.js")` | 
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 911 | `webpack && mocha test/unit` | 
| [codemix/babel-plugin-typecheck](https://github.com/codemix/babel-plugin-typecheck) | 908 | `mocha ./test/index.js` | 
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 908 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [hunterloftis/newton](https://github.com/hunterloftis/newton) | 908 | `mocha spec/*.spec.js` | 
| [expressjs/generator](https://github.com/expressjs/generator) | 903 | `mocha --reporter spec --bail --check-leaks test/` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 899 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 893 | `mocha` | 
...
| [kriasoft/aspnet-starter-kit](https://github.com/kriasoft/aspnet-starter-kit) | 874 | `mocha "client.test" --compilers js:babel-register` | 
| [WP-API/node-wpapi](https://github.com/WP-API/node-wpapi) | 873 | `istanbul cover _mocha -- tests --recursive --reporter=nyan` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 869 | `mocha ./test/test*.js --reporter spec` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 853 | `mocha -R spec ./test/unit/**` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 853 | `mocha tests/*.js` | 
...
| [azu/promises-book](https://github.com/azu/promises-book) | 847 | `mocha ./Ch**/test/*.js && npm run textlint` | 
...
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 843 | `mocha --reporter spec --bail --check-leaks test/` | 
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 843 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [reactivestack/cookies](https://github.com/reactivestack/cookies) | 829 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
...
| [testdouble/testdouble.js](https://github.com/testdouble/testdouble.js) | 816 | `mocha --ui mocha-given --reporter $npm_package_config_mocha_reporter --compilers js:babel-core/register,coffee:coffeescript --recursive regression/node-helper.coffee regression/src` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 812 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 798 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 789 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [react-materialize/react-materialize](https://github.com/react-materialize/react-materialize) | 785 | `mocha` | 
...
| [floatdrop/gulp-plumber](https://github.com/floatdrop/gulp-plumber) | 754 | `xo && mocha -R spec` | 
| [adriancooney/voyeur.js](https://github.com/adriancooney/voyeur.js) | 754 | `mocha` | 
| [salomvary/soundcleod](https://github.com/salomvary/soundcleod) | 753 | `mocha` | 
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 749 | `./node_modules/.bin/mocha -R spec` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 740 | `eslint src test && mocha --compilers babel-register` | 
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 739 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [bitpay/insight](https://github.com/bitpay/insight) | 721 | `mocha test` | 
...
| [pillarjs/cookies](https://github.com/pillarjs/cookies) | 716 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [jish/pre-commit](https://github.com/jish/pre-commit) | 716 | `mocha test.js` | 
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 715 | `cross-env NODE_ENV=test nyc mocha` | 
| [acss-io/atomizer](https://github.com/acss-io/atomizer) | 715 | `./node_modules/.bin/mocha tests/ --recursive --reporter spec` | 
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 713 | `mocha` | 
...
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 711 | `npm run lint && npm run mocha` | 
...
| [sghiassy/react-native-sglistview](https://github.com/sghiassy/react-native-sglistview) | 688 | `yarn config:enable:babelrc; ./node_modules/.bin/mocha || yarn config:disable:babelrc` | 
...
| [volumio/Volumio2](https://github.com/volumio/Volumio2) | 680 | `npm install fs-extra && npm install --only=dev && ./node_modules/.bin/mocha --reporter spec` | 
