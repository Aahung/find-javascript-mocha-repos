...
The list was updated at 00:55:11 11/19/18 PST
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 44300 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 41674 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 41090 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 30570 | `mocha --async-only` | 
| [lord/slate](https://github.com/lord/slate) | 25054 | `cross-env BABEL_ENV=test FORBID_WARNINGS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [caolan/async](https://github.com/caolan/async) | 24897 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 24206 | `mocha test/index.js` | 
| [developit/preact](https://github.com/developit/preact) | 20703 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 19657 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 17483 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 17367 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 16188 | `node_modules/.bin/mocha test/*.*.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 14511 | `nyc --reporter=html --reporter=text mocha` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 14509 | `cross-env BABEL_ENV=cjs mocha --require babel-register --reporter spec` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 14486 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 13622 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) | 13259 | `mocha --globals document test` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12867 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12591 | `mocha --reporter spec test/*-test.js` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12867 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12591 | `mocha --reporter spec test/*-test.js` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 12440 | `istanbul cover _mocha` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12302 | `mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11980 | `nyc grunt mocha-and-karma` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 11907 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 11864 | `mocha --require @babel/register --reporter dot` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 11436 | `cross-env BABEL_ENV=test FORBID_WARNINGS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 11090 | `mocha test/index.js` | 
| [svg/svgo](https://github.com/svg/svgo) | 10742 | `set NODE_ENV=test && mocha` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 10567 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [reduxjs/redux-thunk](https://github.com/reduxjs/redux-thunk) | 10511 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [RelaxedJS/ReLaXed](https://github.com/RelaxedJS/ReLaXed) | 10444 | `mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 10299 | `mocha` | 
| [tj/co](https://github.com/tj/co) | 10271 | `mocha --harmony` | 
| [reduxjs/redux-devtools](https://github.com/reduxjs/redux-devtools) | 10253 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [websockets/ws](https://github.com/websockets/ws) | 9980 | `npm run lint && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 9828 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9563 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 9469 | `nyc --reporter=text --reporter=lcov npm run mocha` | 
| [systemjs/systemjs](https://github.com/systemjs/systemjs) | 9340 | `mocha -b -r esm` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 9259 | `mocha tests/*.js` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 9174 | `grunt mocha` | 
| [amark/gun](https://github.com/amark/gun) | 9097 | `mocha` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 9058 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6573 | `mocha test/test.js` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 6423 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha --timeout 60000 ./infra/testing/auto-stub-logger.mjs` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 6155 | `mocha -r intelli-espower-loader -t 20000 app.test.js --exit` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 6136 | `jshint index.js test/tests.js && mocha test/tests.js` | 
...
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 5943 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
...
| [oliver-moran/jimp](https://github.com/oliver-moran/jimp) | 7164 | `cross-env BABEL_ENV=test mocha --require @babel/register './packages/**/test/**/*.test.js' --require ts-node/register ./packages/**/test/*.test.ts` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 7154 | `mocha; jshint *.js lib` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 7042 | `mocha $HARMONY_OPTS` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 7038 | `mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 6988 | `mocha --exit --require @babel/register` | 
| [remoteintech/remote-jobs](https://github.com/remoteintech/remote-jobs) | 6973 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 6757 | `npm run jshint && mocha test/` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6573 | `mocha test/test.js` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 6155 | `mocha -r intelli-espower-loader -t 20000 app.test.js --exit` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 6136 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 6120 | `mocha tests/node.js` | 
| [angular-fullstack/generator-angular-fullstack](https://github.com/angular-fullstack/generator-angular-fullstack) | 6067 | `mocha --require should --require babel-register --require ./mocha.conf --reporter spec --timeout 120000 test/pre.test.js test/*.test.js` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 6040 | `mocha` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5977 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5945 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 5943 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5938 | `mocha` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5809 | `mocha && eslint lib/**` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 5709 | `standard && mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 5596 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 5569 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 5414 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 5317 | `mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 5234 | `npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 5101 | `mocha test` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 5075 | `gulp lint && mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 4988 | `NODE_ENV=test mocha --timeout 8000 -r ts-node/register --exit` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4825 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4814 | `mocha --recursive` | 
| [santinic/how2](https://github.com/santinic/how2) | 4802 | `mocha test` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4798 | `mocha -R spec 'tests/app'` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4763 | `./node_modules/.bin/mocha` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4748 | `mocha` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4724 | `mocha --reporter spec -t 8000` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 4723 | `nyc mocha --exit` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 4680 | `npm run lint && npm run mocha` | 
| [teambit/bit](https://github.com/teambit/bit) | 4634 | `mocha --require babel-core/register './src/**/*.spec.js'` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 4616 | `nyc --reporter lcovonly mocha --full-trace --check-leaks --exit` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 4591 | `nyc mocha` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 4403 | `cross-env NODE_ENV=test mocha --require babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 4388 | `mocha -R spec src` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 4375 | `nyc --require @babel/register _mocha -- test/tests/index.js` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 4266 | `mocha --timeout=15000 tests/*.test.js` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 4264 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ramboxapp/community-edition](https://github.com/ramboxapp/community-edition) | 4173 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 4137 | `mocha --check-leaks --reporter spec --bail` | 
...
| [tj/ejs](https://github.com/tj/ejs) | 4045 | `mocha --require should --reporter spec` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 4012 | `prettier-check src/**/*.js && mocha ./test/*.spec.js` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 3998 | `NODE_ENV=test mocha --exit` | 
| [CodeboxIDE/codebox](https://github.com/CodeboxIDE/codebox) | 3913 | `export TESTING=true; mocha --reporter list` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3842 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [expressjs/session](https://github.com/expressjs/session) | 3826 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [erming/shout](https://github.com/erming/shout) | 3791 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [primus/primus](https://github.com/primus/primus) | 3738 | `npm run build && mocha test/*.test.js` | 
| [primus/primus](https://github.com/primus/primus) | 3738 | `npm run build && mocha test/*.test.js` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 3715 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3617 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3607 | `node_modules/.bin/mocha` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 3601 | `mocha test/* --reporter spec` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 3451 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [dthree/vantage](https://github.com/dthree/vantage) | 3447 | `mocha` | 
| [express-validator/express-validator](https://github.com/express-validator/express-validator) | 3410 | `nyc mocha && tsc` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 3390 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 3323 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 3267 | `eslint . && mocha -t 5000` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 3261 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 3254 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:@babel/register --require ./test/setup.js test/*_test.js` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 3243 | `mocha` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 3236 | `mocha` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 3231 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 3220 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests --exclude "tests/unit/relations/files/**"` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 3141 | `mocha` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 3119 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [gsuitedevs/md2googleslides](https://github.com/gsuitedevs/md2googleslides) | 3113 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 3109 | `mocha -R landing test/index` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 3101 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 3012 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 3181 | `mocha test/*.js` | 
| [konvajs/konva](https://github.com/konvajs/konva) | 3170 | `mocha-headless-chrome -f ./test/runner.html -a disable-web-security` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3163 | `./node_modules/.bin/mocha test/test.*.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3151 | `mocha` | 
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 3149 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 3120 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 3119 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [gsuitedevs/md2googleslides](https://github.com/gsuitedevs/md2googleslides) | 3113 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 3064 | `mocha` | 
| [arkency/reactjs_koans](https://github.com/arkency/reactjs_koans) | 3040 | `npm run compile && mocha -b --compilers js:babel/register --require test/helpers.js test/**/*.js || echo` | 
| [pegjs/pegjs](https://github.com/pegjs/pegjs) | 3016 | `eslint . && nyc mocha --recursive` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 3012 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2999 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2680 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2671 | `mocha --timeout 100000` | 
| [tensorspace-team/tensorspace](https://github.com/tensorspace-team/tensorspace) | 2667 | `mocha` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2665 | `mocha` | 
| [yeoman/yo](https://github.com/yeoman/yo) | 2662 | `nyc mocha --timeout=10000` | 
| [retejs/rete](https://github.com/retejs/rete) | 2635 | `BABEL_ENV=test mocha --compilers js:babel-core/register` | 
| [conventional-changelog/conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) | 2598 | `nyc mocha --timeout 30000 packages/*/test{,/*}.js` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2560 | `mocha --recursive --bail --reporter spec test 2>&1` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2508 | `mocha test` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2802 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [enquirer/enquirer](https://github.com/enquirer/enquirer) | 2789 | `mocha && tsc -p ./test/types` | 
...
| [agershun/alasql](https://github.com/agershun/alasql) | 2750 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2643 | `mocha "./test/**/*-test.js"` | 
| [retejs/rete](https://github.com/retejs/rete) | 2635 | `BABEL_ENV=test mocha --compilers js:babel-core/register` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2623 | `mocha-phantomjs ./test/index.html` | 
| [conventional-changelog/conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) | 2598 | `nyc mocha --timeout 30000 packages/*/test{,/*}.js` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2587 | `mocha` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2582 | `mocha test/unit --require mochahook` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2560 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [h2non/toxy](https://github.com/h2non/toxy) | 2536 | `standard index.js 'lib/**/*.js' 'test/**/*.js' && mocha --timeout 5000 --bail --reporter spec --ui tdd 'test/**/*.js'` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2527 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2508 | `mocha test` | 
...
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2468 | `mocha` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2467 | `nyc --reporter=html --reporter=text mocha` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 2272 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 2219 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [gajus/swing](https://github.com/gajus/swing) | 2269 | `mocha --compilers js:babel-register` | 
| [hipache/hipache](https://github.com/hipache/hipache) | 2229 | `istanbul test _mocha --report html -- test/**/*.js --reporter spec --timeout 4000` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 2226 | `nyc npm run _mocha` | 
| [mplewis/src2png](https://github.com/mplewis/src2png) | 2223 | `mocha test test/unit/**/*_test.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 2219 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [kamranahmedse/pennywise](https://github.com/kamranahmedse/pennywise) | 2215 | `mocha` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 2145 | `rimraf dbtest && npm run lint && SQLPAD_DB_PATH='./dbtest' mocha server/test --timeout 10000 --recursive --exit` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 2119 | `mocha && eslint *.js` | 
| [pahen/madge](https://github.com/pahen/madge) | 2115 | `npm run lint && npm run mocha` | 
...
| [ziishaned/dumper.js](https://github.com/ziishaned/dumper.js) | 2110 | `./node_modules/.bin/istanbul cover node_modules/mocha/bin/_mocha && ./node_modules/.bin/codecov` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2095 | `mocha` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 2074 | `mocha --compilers js:babel-core/register __tests__` | 
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 2069 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 2058 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1983 | `mocha --compilers js:babel-register` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1974 | `npm run mocha && npm run karma` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1964 | `mocha -c test/index.js` | 
| [then/promise](https://github.com/then/promise) | 1963 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1927 | `mocha && npm run lint` | 
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1848 | `mocha test` | 
| [webpack-contrib/webpack-hot-middleware](https://github.com/webpack-contrib/webpack-hot-middleware) | 1847 | `mocha` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1835 | `mocha test -u bdd -R spec` | 
...
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1812 | `npm run lint && npm run mocha` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1806 | `mocha ./test/basic.js -t 5000` | 
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1785 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1755 | `npm run lint && npm run mocha` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1789 | `mocha compiled_tests/` | 
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1785 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1755 | `npm run lint && npm run mocha` | 
| [cliftonc/calipso](https://github.com/cliftonc/calipso) | 1750 | `NODE_ENV=mocha ./node_modules/.bin/mocha --reporter spec -t 80000 -s 500` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1727 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1718 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
...
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1580 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1579 | `mocha test.js` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1536 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [socraticorg/mathsteps](https://github.com/socraticorg/mathsteps) | 1532 | `node_modules/.bin/mocha --recursive` | 
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1524 | `mocha -u tdd` | 
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1511 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [Caligatio/jsSHA](https://github.com/Caligatio/jsSHA) | 1604 | `mocha --reporter spec` | 
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1603 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
...
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1524 | `mocha -u tdd` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 1523 | `NODE_ENV=test mocha tests/*.js` | 
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1511 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
| [socraticorg/mathsteps](https://github.com/socraticorg/mathsteps) | 1532 | `node_modules/.bin/mocha --recursive` | 
| [superscriptjs/superscript](https://github.com/superscriptjs/superscript) | 1529 | `mocha --compilers js:babel-register test -R spec -s 1700 -t 300000 --recursive` | 
| [carteb/carte-blanche](https://github.com/carteb/carte-blanche) | 1527 | `node_modules/.bin/mocha --opts mocha.opts` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 1478 | `mocha ./test/test*.js --reporter spec` | 
...
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1478 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
| [johntitus/node-horseman](https://github.com/johntitus/node-horseman) | 1478 | `mocha -R spec` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 1472 | `standard && cd frontend && ng lint && ng test --watch=false --source-map=false && cd .. && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1463 | `mocha -R spec ./test/unit/**` | 
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1458 | `mocha` | 
...
| [apifytech/apify-js](https://github.com/apifytech/apify-js) | 1446 | `npm run build &&  nyc --reporter=html --reporter=text mocha --timeout 60000 --compilers js:babel-core/register --recursive` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1439 | `npm run lint && mocha && karma start --single-run` | 
...
| [openstyles/stylus](https://github.com/openstyles/stylus) | 1428 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1415 | `cross-env BABEL_ENV=commonjs mocha --require @babel/register --recursive -r ./test/setup.js` | 
| [firebase/firebase-tools](https://github.com/firebase/firebase-tools) | 1412 | `npm run lint && npm run mocha` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 1379 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1345 | `npm run prepublishOnly && mocha test/test.js` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1342 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1340 | `mocha --recursive test` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1331 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
| [fbeline/Design-Patterns-JS](https://github.com/fbeline/Design-Patterns-JS) | 1320 | `mocha test --compilers js:babel-core/register` | 
...
| [messageformat/messageformat](https://github.com/messageformat/messageformat) | 1310 | `mocha` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 1288 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [marcelduran/webpagetest-api](https://github.com/marcelduran/webpagetest-api) | 1290 | `./node_modules/mocha/bin/mocha -R spec test/*-test.js` | 
...
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 1262 | `mocha` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 1257 | `npm run mocha:istanbul` | 
...
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 1239 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 1239 | `npm run lint && mocha --require @babel/register` | 
...
| [Koenkk/zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) | 1209 | `mocha --recursive` | 
...
| [justadudewhohacks/face-recognition.js](https://github.com/justadudewhohacks/face-recognition.js) | 1201 | `mocha --timeout 30000 --recursive ./tests` | 
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1200 | `mocha` | 
| [fossasia/open-event-webapp](https://github.com/fossasia/open-event-webapp) | 1186 | `mocha` | 
| [gkajs/gka](https://github.com/gkajs/gka) | 1186 | `mocha --timeout 20000` | 
...
| [ctimmerm/axios-mock-adapter](https://github.com/ctimmerm/axios-mock-adapter) | 1143 | `mocha` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 1143 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [ctimmerm/axios-mock-adapter](https://github.com/ctimmerm/axios-mock-adapter) | 1143 | `mocha` | 
| [microstates/microstates.js](https://github.com/microstates/microstates.js) | 1142 | `mocha --recursive -r tests/setup tests` | 
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 1137 | `mocha --reporter spec --bail --check-leaks test/` | 
| [coralproject/talk](https://github.com/coralproject/talk) | 1131 | `npm-run-all test:jest test:server:mocha` | 
...
| [gmetais/sw-delta](https://github.com/gmetais/sw-delta) | 1104 | `./node_modules/.bin/mocha test/unit --reporter spec` | 
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 1104 | `mocha` | 
...
| [electron/spectron](https://github.com/electron/spectron) | 1098 | `mocha && standard` | 
...
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 1081 | `node -r @babel/register node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 1081 | `mocha --require babel-register --colors ./test/*.spec.js` | 
| [pantsel/konga](https://github.com/pantsel/konga) | 1081 | `mocha` | 
...
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1071 | `mocha test/tests.js` | 
| [developit/snarkdown](https://github.com/developit/snarkdown) | 1070 | `eslint src test && mocha --compilers babel-register` | 
| [symfony/webpack-encore](https://github.com/symfony/webpack-encore) | 1065 | `mocha --reporter spec test --recursive` | 
...
| [mishk0/slack-bot-api](https://github.com/mishk0/slack-bot-api) | 1046 | `./node_modules/jshint/bin/jshint index.js && ./node_modules/jscs/bin/jscs index.js && ./node_modules/mocha/bin/mocha` | 
...
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 1013 | `standard src/index.js && mocha --compilers js:babel-register` | 
...
| [MohammadYounes/rtlcss](https://github.com/MohammadYounes/rtlcss) | 970 | `npm run lint && mocha -R spec` | 
...
| [kisenka/svg-sprite-loader](https://github.com/kisenka/svg-sprite-loader) | 952 | `mocha test/*.test.js` | 
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 949 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 949 | `mocha spec/*.js` | 
| [gaearon/react-side-effect](https://github.com/gaearon/react-side-effect) | 945 | `mocha` | 
| [bubenshchykov/ngrok](https://github.com/bubenshchykov/ngrok) | 926 | `node ./node_modules/mocha/bin/_mocha --exit` | 
| [catamphetamine/libphonenumber-js](https://github.com/catamphetamine/libphonenumber-js) | 926 | `mocha --require babel-core/register --colors --bail --reporter spec --require ./test/setup.js "source/**/*.test.js" "test/**/*.test.js" --recursive` | 
...
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 914 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
...
| [dantrain/react-stonecutter](https://github.com/dantrain/react-stonecutter) | 911 | `mocha -R spec --compilers jsx:babel-register test/*.jsx` | 
...
| [leizongmin/node-segment](https://github.com/leizongmin/node-segment) | 903 | `mocha -t 5000` | 
| [tj/node-migrate](https://github.com/tj/node-migrate) | 903 | `standard && standard ./bin/* && mocha` | 
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 924 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
| [pillarjs/multiparty](https://github.com/pillarjs/multiparty) | 920 | `mocha --reporter spec --bail --check-leaks --no-exit test/` | 
| [image-size/image-size](https://github.com/image-size/image-size) | 918 | `nyc mocha specs` | 
| [crcn/sift.js](https://github.com/crcn/sift.js) | 917 | `mocha ./test -R spec --compilers js:babel-core/register` | 
| [kriasoft/isomorphic-style-loader](https://github.com/kriasoft/isomorphic-style-loader) | 917 | `mocha test --compilers js:babel-register` | 
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 916 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
| [felixge/node-dateformat](https://github.com/felixge/node-dateformat) | 916 | `mocha` | 
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 914 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
| [hunterloftis/newton](https://github.com/hunterloftis/newton) | 911 | `mocha spec/*.spec.js` | 
| [axemclion/browser-perf](https://github.com/axemclion/browser-perf) | 911 | `node_modules/.bin/mocha --recursive --require=./test/test.helper.js ./test` | 
| [dantrain/react-stonecutter](https://github.com/dantrain/react-stonecutter) | 911 | `mocha -R spec --compilers jsx:babel-register test/*.jsx` | 
...
| [mozilla/node-convict](https://github.com/mozilla/node-convict) | 894 | `mocha --check-leaks -R spec test/*-tests.js` | 
...
| [ElemeFE/page-skeleton-webpack-plugin](https://github.com/ElemeFE/page-skeleton-webpack-plugin) | 851 | `npm run lint && npm run mocha` | 
...
| [syt123450/giojs](https://github.com/syt123450/giojs) | 838 | `mocha` | 
| [lelylan/simple-oauth2](https://github.com/lelylan/simple-oauth2) | 797 | `nyc mocha` | 
...
| [ant-design/antd-init](https://github.com/ant-design/antd-init) | 786 | `mocha --no-timeouts` | 
| [mapmeld/gitjk](https://github.com/mapmeld/gitjk) | 784 | `mocha` | 
| [flickr/yakbak](https://github.com/flickr/yakbak) | 776 | `mocha` | 
| [fossasia/yaydoc](https://github.com/fossasia/yaydoc) | 774 | `./node_modules/.bin/mocha tests --timeout 1500000` | 
...
| [natefaubion/matches.js](https://github.com/natefaubion/matches.js) | 793 | `mocha -u tdd` | 
| [cthackers/adm-zip](https://github.com/cthackers/adm-zip) | 754 | `mocha test/mocha.js` | 
...
| [arithmetric/aws-lambda-ses-forwarder](https://github.com/arithmetric/aws-lambda-ses-forwarder) | 753 | `istanbul cover _mocha -- --check-leaks --timeout 3000` | 
...
| [davglass/license-checker](https://github.com/davglass/license-checker) | 745 | `jenkins-mocha ./tests/*.js` | 
...
| [erikras/redux-form-material-ui](https://github.com/erikras/redux-form-material-ui) | 741 | `mocha --compilers js:babel-register --recursive --recursive "src/**/__tests__/*" --require src/__tests__/setup.js` | 
...
| [fossasia/CommonsNet](https://github.com/fossasia/CommonsNet) | 738 | `_mocha` | 