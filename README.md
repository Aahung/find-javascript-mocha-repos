...
The list was updated at 02:06:58 04/06/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40476 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40142 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 39510 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation` | 
| [expressjs/express](https://github.com/expressjs/express) | 37533 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29127 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23695 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22738 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21447 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 21111 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18279 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17925 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15888 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15325 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13947 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13683 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13024 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12415 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12244 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12076 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11966 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11847 | `mocha --reporter spec test/*-test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11587 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 11108 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10816 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10462 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 10054 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9926 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9567 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9501 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9486 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9359 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9346 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9006 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8684 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8673 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8555 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8406 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8239 | `mocha test/test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8217 | `mocha --check-leaks -R dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 8166 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8146 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8061 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7999 | `./node_modules/.bin/mocha test/src` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7922 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7862 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7849 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7833 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7629 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7566 | `mocha tests/*.js` | 
...
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7303 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7256 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7236 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7182 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 7045 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6724 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6718 | `nyc mocha test/**/* -r ./test/before` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6636 | `xo && mocha test/*.js --timeout 100000` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6629 | `mocha $HARMONY_OPTS` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 6616 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation` | 
| [aui/art-template](https://github.com/aui/art-template) | 6615 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6578 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6576 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6576 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [almende/vis](https://github.com/almende/vis) | 6465 | `mocha --compilers js:babel-core/register` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6195 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6052 | `npm run lint -s && npm run mocha -s` | 
...
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5975 | `npm run test:mocha:src` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5926 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5876 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5707 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5632 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5592 | `mocha tests/node.js` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5531 | `mocha test/test.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5497 | `mocha && eslint lib/**` | 
...
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5401 | `npm run build-cli && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5394 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5303 | `mocha` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5143 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4940 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4844 | `mocha; jshint *.js lib` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4815 | `gulp lint && mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4809 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4763 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4760 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4728 | `mocha` | 
| [santinic/how2](https://github.com/santinic/how2) | 4669 | `mocha test` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4669 | `standard && mocha` | 
...
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4598 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4557 | `gulp build; mocha;` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4479 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4462 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4333 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4295 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4262 | `mocha` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4053 | `mocha --recursive && make test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4042 | `nyc mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3969 | `NODE_ENV=test mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3934 | `mocha --require test/babel-hook test/*.js` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3907 | `npm run lint && npm run mocha` | 
| [muicss/mui](https://github.com/muicss/mui) | 3906 | `mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3897 | `istanbul test node_modules/mocha/bin/_mocha` | 
...
| [tj/ejs](https://github.com/tj/ejs) | 3827 | `mocha --require should --reporter spec` | 
| [erming/shout](https://github.com/erming/shout) | 3813 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3769 | `mocha -R spec ./test` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3758 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3749 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3744 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3716 | `npm run lint ; mocha && mocha test/individual` | 
...
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3648 | `npm run jshint && npm run mocha` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3611 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3581 | `standard && mocha --timeout 60000 test/test.js` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3533 | `npm run lint && npm run mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3525 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [primus/primus](https://github.com/primus/primus) | 3518 | `npm run build && mocha test/*.test.js` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3416 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [fzaninotto/uptime](https://github.com/fzaninotto/uptime) | 3414 | `node_modules/.bin/mocha test/lib/` | 
| [dthree/vantage](https://github.com/dthree/vantage) | 3411 | `mocha` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3406 | `mocha --check-leaks --reporter spec --bail` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3396 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3288 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3265 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3238 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3199 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3125 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3069 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [arkency/reactjs_koans](https://github.com/arkency/reactjs_koans) | 2984 | `npm run compile && mocha -b --compilers js:babel/register --require test/helpers.js test/**/*.js || echo` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2958 | `NODE_ENV=test mocha test/**/*.js` | 
| [gsuitedevs/md2googleslides](https://github.com/gsuitedevs/md2googleslides) | 2946 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2935 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2924 | `mocha test/*.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2915 | `nyc mocha && tsc` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2896 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2890 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2843 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2838 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2822 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [kenwheeler/cash](https://github.com/kenwheeler/cash) | 2814 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2805 | `mocha` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2804 | `mocha test/index.js && npm run demo` | 
...
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2792 | `mocha -R spec --recursive src/test` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2782 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2736 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2721 | `mocha` | 
...
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2709 | `mocha` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2696 | `NODE_ENV=test mocha` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2683 | `mocha --opts mocha.opts` | 
...
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2668 | `yarn tsc && yarn lint && mocha` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2654 | `xo && mocha` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2646 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2608 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2579 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2578 | `mocha` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2574 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2562 | `mocha --compilers js:babel-register --recursive spec` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2552 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2550 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2541 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2448 | `node_modules/.bin/mocha --reporter spec` | 
...
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2411 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [agershun/alasql](https://github.com/agershun/alasql) | 2378 | `npm run build && cd test && mocha . --reporter dot` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2375 | `export TESTING=true; mocha --reporter list` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2295 | `mocha --require should --reporter spec` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2268 | `mocha` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2243 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2239 | `npm run lint && npm run build:test && npm run build:user && npm run mocha` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2209 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2202 | `mocha -R spec` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2184 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2123 | `mocha -R landing test/index` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2120 | `nyc --reporter=html --reporter=text mocha` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2089 | `mocha` | 
...
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2048 | `mocha && eslint .` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 2034 | `mocha test && npm run lint` | 
...
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1893 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
...
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1853 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1851 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1845 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1779 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [kach/nearley](https://github.com/kach/nearley) | 1778 | `mocha test/*.test.js` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1777 | `mocha && eslint *.js` | 
| [share/sharedb](https://github.com/share/sharedb) | 1768 | `./node_modules/.bin/mocha && npm run jshint` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1767 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1753 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [cliftonc/calipso](https://github.com/cliftonc/calipso) | 1751 | `NODE_ENV=mocha ./node_modules/.bin/mocha --reporter spec -t 80000 -s 500` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1740 | `npm run lint && mocha --reporter spec test/*.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1738 | `nyc npm run _mocha` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1729 | `mocha --reporter spec && npm run test-typescript` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1721 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1716 | `npm run mocha && npm run karma` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1708 | `rm -rf ./dbtest && npm run lint && SQLPAD_DB_PATH='./dbtest' mocha server/test --timeout 10000 --recursive --exit` | 
...
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1675 | `npm run lint && npm run mocha` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1666 | `mocha` | 
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1665 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [shouldjs/should.js](https://github.com/shouldjs/should.js) | 1653 | `mocha -R mocha-better-spec-reporter --require ./cjs/should --color --check-leaks ./test/*.test.js ./test/**/*.test.js` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1639 | `npm run lint && npm run mocha` | 
| [webpack-contrib/webpack-hot-middleware](https://github.com/webpack-contrib/webpack-hot-middleware) | 1638 | `mocha` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1626 | `mocha --reporter spec --grep .` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1624 | `mocha tests --compilers js:babel-core/register` | 
...
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1595 | `mocha test -u bdd -R spec` | 
| [flitbit/diff](https://github.com/flitbit/diff) | 1594 | `mocha test/**/*.js` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1590 | `mocha --reporter spec test/*.js` | 
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1588 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1581 | `standard "src/*.js" && npm run build && mocha` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1557 | `eslint . && mocha -t 5000` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1531 | `npm run lint && npm run mocha` | 
| [helpers/handlebars-helpers](https://github.com/helpers/handlebars-helpers) | 1521 | `mocha` | 
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1508 | `mocha --compilers js:babel-register` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1468 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [superscriptjs/superscript](https://github.com/superscriptjs/superscript) | 1444 | `mocha --compilers js:babel-register test -R spec -s 1700 -t 300000 --recursive` | 
...
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1431 | `eslint --cache . && tsc && mocha` | 
...
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1421 | `nyc mocha` | 
...
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1412 | `standard "./src/*.js" && mocha` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1405 | `mocha test.js` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1403 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1399 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [teambit/bit](https://github.com/teambit/bit) | 1396 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
| [zeit/ms](https://github.com/zeit/ms) | 1386 | `mocha tests.js` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1385 | `mocha` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1383 | `mocha compiled_tests/` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1379 | `mocha --recursive` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1376 | `mocha --check-leaks --reporter spec --bail` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1344 | `mocha test/setup.js test/spec/*.js` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1343 | `mocha` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1339 | `nyc npm run mocha` | 
...
| [lukehaas/Scrollify](https://github.com/lukehaas/Scrollify) | 1276 | `mocha ./test/scrollify_test.js --recursive ./test` | 
| [electron/devtron](https://github.com/electron/devtron) | 1273 | `mocha test/unit/*-test.js test/integration/*-test.js && standard` | 
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1271 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
...
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1234 | `mocha --check-leaks --require @babel/register` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1226 | `mocha` | 
...
| [andywer/leakage](https://github.com/andywer/leakage) | 1220 | `mocha --timeout 10000 test/ && standard src/**/*.js test/**/*.js` | 
| [lloyd/node-toobusy](https://github.com/lloyd/node-toobusy) | 1218 | `mocha tests` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1195 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1188 | `mocha` | 
...
| [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) | 1172 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
| [paldepind/flyd](https://github.com/paldepind/flyd) | 1172 | `eslint --fix lib/ test/ module/ && mocha -R dot test/*.js module/**/test/*.js` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1169 | `standard && istanbul cover _mocha` | 
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1167 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1165 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1164 | `mocha test/unit` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1163 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1161 | `eslint src && mocha && karma start --single-run` | 
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1159 | `mocha` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1158 | `mocha --reporter dot` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1154 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1139 | `node_modules/.bin/mocha` | 
| [frctl/fractal](https://github.com/frctl/fractal) | 1138 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
| [normalize/mz](https://github.com/normalize/mz) | 1138 | `mocha --reporter spec` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1126 | `nyc mocha --timeout=20000 test.js` | 
| [btmills/geopattern](https://github.com/btmills/geopattern) | 1126 | `npm run lint && npm run mocha` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1122 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1073 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1034 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1012 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1010 | `mocha -R spec ./test/unit/**` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1003 | `mocha --recursive test` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1002 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 988 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 984 | `mocha` | 
| [router5/router5](https://github.com/router5/router5) | 984 | `mocha --compilers js:babel-core/register --require test-helper.js --recursive 'packages/*/test/**/*.js'` | 
| [yeoman/generator-polymer](https://github.com/yeoman/generator-polymer) | 983 | `jshint {app,el,gh,seed,test}/*.js script-base.js util.js && mocha --reporter spec` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 982 | `mocha tests/*.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 971 | `mocha ./test/test*.js --reporter spec` | 
...
| [electron/asar](https://github.com/electron/asar) | 957 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 953 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [yeoman/generator-mobile](https://github.com/yeoman/generator-mobile) | 951 | `mocha --timeout 5000` | 
...
| [expressjs/generator](https://github.com/expressjs/generator) | 944 | `mocha --reporter spec --bail --check-leaks test/` | 
| [electron/spectron](https://github.com/electron/spectron) | 942 | `mocha && standard` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 903 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 903 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 903 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 901 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 901 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
| [domenic/sinon-chai](https://github.com/domenic/sinon-chai) | 901 | `mocha` | 
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 897 | `npm run lint && mocha --require @babel/register` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 890 | `TEST=all mocha` | 
...
| [js-joda/js-joda](https://github.com/js-joda/js-joda) | 879 | `NODE_ENV=test ./node_modules/.bin/mocha --timeout 5000 --require babel-core/register ./test/*Test.js ./test/**/*Test.js ./test/**/**/*Test.js ./test/*Test_mochaOnly.js` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 854 | `mocha -R spec` | 
...
| [MaxCDN/bootstrapcdn](https://github.com/MaxCDN/bootstrapcdn) | 845 | `npm run lint && npm run mocha` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 842 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 838 | `mocha --timeout 20000` | 
...
| [gulpjs/gulp-util](https://github.com/gulpjs/gulp-util) | 820 | `jshint *.js lib/*.js test/*.js && mocha` | 
...
| [dareid/chakram](https://github.com/dareid/chakram) | 812 | `istanbul cover _mocha` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 811 | `npm run mocha:istanbul` | 
...
| [felixge/node-dateformat](https://github.com/felixge/node-dateformat) | 808 | `mocha` | 
...
| [image-size/image-size](https://github.com/image-size/image-size) | 799 | `nyc mocha specs` | 
...
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 785 | `babel-node node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
| [petecoop/generator-express](https://github.com/petecoop/generator-express) | 785 | `mocha` | 
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 783 | `./node_modules/.bin/mocha -R spec` | 
...
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 769 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
...
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 743 | `cross-env NODE_ENV=test nyc --reporter=text-summary mocha --recursive --throw-deprecation --require babel-polyfill --require babel-core/register` | 
...
| [radi-js/radi](https://github.com/radi-js/radi) | 719 | `nyc mocha` | 
...
| [webpack-contrib/html-loader](https://github.com/webpack-contrib/html-loader) | 710 | `mocha --harmony --full-trace --check-leaks` | 
...
| [james-proxy/james](https://github.com/james-proxy/james) | 706 | `mocha-webpack --reporter dot --webpack-config webpack.test.config.js --recursive test/unit` | 
...
| [tshelburne/redux-batched-actions](https://github.com/tshelburne/redux-batched-actions) | 705 | `node_modules/.bin/mocha --compilers js:babel-core/register` | 