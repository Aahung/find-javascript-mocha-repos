...
The list was updated at 02:06:18 01/07/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39457 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 38328 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35945 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 35600 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28364 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23064 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 20016 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17181 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 17038 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15274 | `mocha` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 14743 | `cross-env NODE_ENV=test mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14423 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13644 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12559 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12365 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11932 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11766 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11711 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11556 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11400 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10692 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10550 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10366 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9967 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9684 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9321 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9170 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9148 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9004 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [tmpvar/jsdom](https://github.com/tmpvar/jsdom) | 8975 | `mocha test/index.js` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8908 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 8770 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8761 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8416 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8208 | `mocha test/*-test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8111 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8033 | `mocha test/test.js` | 
...
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7630 | `./node_modules/.bin/mocha test/src` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7598 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7448 | `mocha --compilers js:babel-register test/test.js` | 
| [rstacruz/jquery.transit](https://github.com/rstacruz/jquery.transit) | 7431 | `mocha` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7423 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
...
| [websockets/ws](https://github.com/websockets/ws) | 7189 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7081 | `npm run build && istanbul cover _mocha` | 
| [amark/gun](https://github.com/amark/gun) | 7049 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7033 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6984 | `./node_modules/.bin/mocha test` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6981 | `mocha tests/*.js` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6550 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6485 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6477 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6358 | `xo && mocha test/*.js --timeout 100000` | 
...
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6274 | `mocha --require babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6163 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6101 | `mocha --opts mocha.opts` | 
| [almende/vis](https://github.com/almende/vis) | 6100 | `mocha --compilers js:babel-core/register` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6032 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5973 | `nyc mocha test/** -r ./test/before` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5928 | `mocha` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5925 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5788 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5719 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5718 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5656 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5514 | `npm run jshint && mocha test/` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5462 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5396 | `mocha tests/node.js` | 
...
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5273 | `mocha test --recursive` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5134 | `mocha test/test.js` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5120 | `mocha src/**/*Tests.js --harmony` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5014 | `mocha --timeout 10000 && npm run lint` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4851 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4835 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4791 | `mocha --compilers js:babel-core/register` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4740 | `gulp lint && mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4690 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
...
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4576 | `mocha -R spec 'tests/app'` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4572 | `mocha --reporter spec -t 8000` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4517 | `mocha ./test/runner.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4417 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4387 | `mocha --compilers js:babel-register src/**/*-test.js` | 
...
| [derbyjs/derby](https://github.com/derbyjs/derby) | 4306 | `./node_modules/.bin/mocha test/all/*.mocha.js; ./node_modules/.bin/jshint lib/*.js test/*.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4284 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4276 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4256 | `./node_modules/.bin/mocha` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4238 | `standard && mocha` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4129 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4125 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4113 | `mocha` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4031 | `mocha` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4016 | `mocha test` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 3999 | `mocha && ./bin/shipit staging test` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3715 | `mocha --recursive && make test` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3672 | `npm run build-cli && mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3664 | `NODE_ENV=test mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3640 | `mocha --require test/babel-hook test/*.js` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3635 | `npm run jshint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3570 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3570 | `npm run lint && npm run mocha` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3560 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
...
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3470 | `npm run lint ; mocha && mocha test/individual` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3437 | `nyc mocha` | 
...
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3351 | `node_modules/.bin/mocha` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3348 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
...
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 3135 | `mocha; jshint *.js lib` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3122 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3111 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3101 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3078 | `mocha` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3077 | `mocha --check-leaks --reporter spec --bail` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3069 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3061 | `mocha` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3052 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [shoutem/ui](https://github.com/shoutem/ui) | 2982 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 2947 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2934 | `npm run lint && npm run mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2925 | `nyc mocha "test/**/*.test.js"` | 
| [googlesamples/md2googleslides](https://github.com/googlesamples/md2googleslides) | 2897 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2886 | `mocha` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2858 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2801 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2791 | `mocha test/*.js` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2688 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2643 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2616 | `nyc mocha && tsc` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2599 | `mocha` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2598 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2567 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2565 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2563 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2544 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2535 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2511 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 2494 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2492 | `mocha --opts mocha.opts` | 
...
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2440 | `mocha --compilers js:babel-register --recursive spec` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2437 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2431 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2366 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2366 | `node node_modules/mocha/bin/_mocha` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2343 | `mocha` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2339 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [katiefenn/parker](https://github.com/katiefenn/parker) | 2319 | `mocha --no-colors --reporter spec` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2318 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2311 | `mocha` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2257 | `mocha -t 30000 -R spec tests/unit/index.js` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2255 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2253 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2242 | `mocha test` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2220 | `gulp && cd test && mocha . --reporter dot` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2212 | `NODE_ENV=test mocha` | 
...
| [octokit/node-github](https://github.com/octokit/node-github) | 2201 | `nyc mocha test/**/*-test.js` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2143 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [esbenp/pdf-bot](https://github.com/esbenp/pdf-bot) | 2142 | `nyc --reporter=lcov --reporter=text mocha test/*.test.js --recursive --coverage` | 
...
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2110 | `mocha -R spec` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2042 | `mocha --require should --reporter spec` | 
| [carlsednaoui/ouibounce](https://github.com/carlsednaoui/ouibounce) | 2022 | `mocha` | 
| [slate/slate](https://github.com/slate/slate) | 2022 | `mocha --require babel-core/register ./packages/*/test/index.js` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2014 | `cross-env BABEL_ENV=test mocha` | 
...
| [sandeepmistry/noble](https://github.com/sandeepmistry/noble) | 1922 | `mocha -R spec test/*.js` | 
...
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1866 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1863 | `mocha test/index.js --reporter dot` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 1859 | `mocha ./test/*.spec.js` | 
...
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1840 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1826 | `mocha` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1825 | `mocha test && npm run lint` | 
...
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1815 | `mocha -c test/index.js` | 
| [diegonetto/generator-ionic](https://github.com/diegonetto/generator-ionic) | 1809 | `mocha --timeout 5000` | 
| [Qix-/color](https://github.com/Qix-/color) | 1803 | `mocha` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1795 | `mocha test.js` | 
...
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1744 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1743 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1733 | `mocha --compilers js:babel-register` | 
...
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1716 | `./node_modules/.bin/mocha tests/*.js --exit` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1698 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [trailsjs/trails](https://github.com/trailsjs/trails) | 1696 | `eslint --ignore-path .gitignore index.js lib/ test/ && nyc mocha` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1695 | `mocha --compilers js:babel-core/register __tests__` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1680 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
| [addyosmani/tmi](https://github.com/addyosmani/tmi) | 1671 | `xo && mocha` | 
| [Hardmath123/nearley](https://github.com/Hardmath123/nearley) | 1671 | `mocha test/*.test.js` | 
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1666 | `mocha test` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1663 | `npm run lint && npm run compile && mocha --reporter spec test/*.js` | 
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1659 | `mocha` | 
| [Kong/mashape-oauth](https://github.com/Kong/mashape-oauth) | 1656 | `mocha` | 
| [KunalKapadia/express-mongoose-es6-rest-api](https://github.com/KunalKapadia/express-mongoose-es6-rest-api) | 1655 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
| [pstadler/flightplan](https://github.com/pstadler/flightplan) | 1651 | `./node_modules/.bin/mocha` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1617 | `lint && mocha --recursive` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 1613 | `node ./node_modules/mocha/bin/mocha --reporter spec --full-trace` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1610 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1594 | `npm run lint && mocha -R dot && npm run cover` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1589 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [gitsummore/nile.js](https://github.com/gitsummore/nile.js) | 1581 | `./node_modules/mocha/bin/mocha ./test.js` | 
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1581 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1573 | `npm run mocha && npm run karma` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1517 | `nyc npm run _mocha` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1502 | `mocha tests --compilers js:babel-core/register` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1474 | `mocha test/` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1474 | `mocha spec/` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1473 | `mocha ./test/basic.js -t 5000` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1470 | `mocha test/* --reporter spec` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1451 | `mocha` | 
| [thejameskyle/babel-react-optimize](https://github.com/thejameskyle/babel-react-optimize) | 1449 | `eslint packages/*/test packages/*/src && mocha packages/*/test/index.js --compilers js:babel-register` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1414 | `mocha --reporter spec test/*.js` | 
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1407 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [superscriptjs/superscript](https://github.com/superscriptjs/superscript) | 1389 | `mocha --compilers js:babel-register test -R spec -s 1700 -t 300000 --recursive` | 
| [share/sharedb](https://github.com/share/sharedb) | 1378 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [webpack-contrib/npm-install-webpack-plugin](https://github.com/webpack-contrib/npm-install-webpack-plugin) | 1317 | `cross-env NODE_ENV=test nyc mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1310 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1303 | `mocha --recursive` | 
...
| [letsgetrandy/DICSS](https://github.com/letsgetrandy/DICSS) | 1258 | `mocha-phantomjs tests/index.html` | 
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1256 | `npm run build && mocha -r should` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1242 | `mocha test --timeout 600000` | 
| [sandeepmistry/bleno](https://github.com/sandeepmistry/bleno) | 1240 | `mocha -R spec test/*.js` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1237 | `mocha --check-leaks --reporter spec --bail` | 
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1237 | `mocha --timeout 10000 ./tests/lib.js` | 
| [zeit/ms](https://github.com/zeit/ms) | 1233 | `mocha tests.js` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1224 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [FormidableLabs/rapscallion](https://github.com/FormidableLabs/rapscallion) | 1220 | `mocha spec/exec.js` | 
| [yyx990803/pod](https://github.com/yyx990803/pod) | 1216 | `mocha test/api.js -r jscoverage -R spec --slow 1250 --timeout 5000 && bash test/cli.sh` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1211 | `mocha` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1188 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [shakiba/stage.js](https://github.com/shakiba/stage.js) | 1186 | `mocha test/*.js` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1180 | `mocha compiled_tests/` | 
...
| [andywer/leakage](https://github.com/andywer/leakage) | 1177 | `mocha --timeout 10000 test/ && standard src/**/*.js test/**/*.js` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1120 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1117 | `mocha --check-leaks --require @babel/register` | 
...
| [variety/variety](https://github.com/variety/variety) | 1083 | `node_modules/.bin/mocha --compilers js:babel-core/register --require babel-polyfill  --recursive --reporter spec --timeout 15000 spec` | 
...
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1060 | `mocha src/test.js` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1054 | `eslint . && mocha -t 5000` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1037 | `mocha --reporter dot` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1036 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1025 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1017 | `eslint src && mocha && karma start --single-run` | 
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1015 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1010 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [vuejs/vueify](https://github.com/vuejs/vueify) | 1004 | `eslint index.js lib && mocha test/test.js --slow=5000 --timeout=10000` | 
...
| [oakmac/chessboardjs](https://github.com/oakmac/chessboardjs) | 970 | `mocha` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 966 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
| [FormidableLabs/redux-little-router](https://github.com/FormidableLabs/redux-little-router) | 960 | `BABEL_ENV=commonjs mocha test/.setup.js 'test/**/*.spec.js'` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 928 | ` NODE_ENV=test mocha --compilers js:babel-register` | 
| [gulpjs/vinyl](https://github.com/gulpjs/vinyl) | 927 | `mocha --async-only` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 914 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 905 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 903 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 825 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [kriasoft/universal-router](https://github.com/kriasoft/universal-router) | 807 | `nyc mocha --require babel-register` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 798 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
| [neumino/rethinkdbdash](https://github.com/neumino/rethinkdbdash) | 795 | `mocha --check-leaks -t 20000` | 
| [reactivestack/cookies](https://github.com/reactivestack/cookies) | 792 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 792 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 792 | `mocha ./test/test*.js --reporter spec` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 765 | `mocha -R spec ./test/unit/**` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 752 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [react-materialize/react-materialize](https://github.com/react-materialize/react-materialize) | 745 | `mocha` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 728 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 661 | `npm run mocha:istanbul` | 
...
| [volumio/Volumio2](https://github.com/volumio/Volumio2) | 655 | `npm install fs-extra && npm install --only=dev && ./node_modules/.bin/mocha --reporter spec` | 