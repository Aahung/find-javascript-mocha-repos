...
The list was updated at 02:06:22 12/16/17 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39314 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 37882 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35601 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 34967 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28184 | `mocha --reporter spec` | 
| [caolan/async](https://github.com/caolan/async) | 22922 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 21259 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19646 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 16982 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16739 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15151 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14221 | `mocha test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13588 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12339 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12224 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11900 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11677 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11580 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11497 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11281 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10426 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 10390 | `cross-env NODE_ENV=test mocha` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10344 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10266 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9782 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9520 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9200 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9098 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9018 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 8905 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [tmpvar/jsdom](https://github.com/tmpvar/jsdom) | 8881 | `mocha test/index.js` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8817 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8696 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [svg/svgo](https://github.com/svg/svgo) | 8643 | `set NODE_ENV=test && mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8364 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8114 | `mocha test/*-test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8098 | `mocha --check-leaks -R dot` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8020 | `grunt clean:test && mocha` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 7985 | `mocha test/test.js` | 
...
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7510 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7323 | `mocha --compilers js:babel-register test/test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7225 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7180 | `npm run eslint && npm run mocha` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7041 | `npm run build && istanbul cover _mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 7005 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6928 | `./node_modules/.bin/mocha test` | 
| [amark/gun](https://github.com/amark/gun) | 6906 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 6848 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6836 | `mocha tests/*.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6439 | `mocha $HARMONY_OPTS` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6373 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6344 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6292 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6168 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6159 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6070 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 6000 | `mocha --compilers js:babel-core/register` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 5940 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5935 | `mocha` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5808 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5804 | `nyc mocha test/** -r ./test/before` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5658 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5646 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5621 | `mocha --opts mocha.opts` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5538 | `npm run test:mocha:src` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5515 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5441 | `npm run jshint && mocha test/` | 
...
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5358 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
...
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5190 | `mocha test --recursive` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5065 | `mocha test/test.js` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 4952 | `mocha --timeout 10000 && npm run lint` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4801 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4757 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4725 | `gulp lint && mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4670 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4622 | `mocha --compilers js:babel-core/register` | 
...
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4555 | `mocha -R spec 'tests/app'` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4553 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
...
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4343 | `gulp build; mocha;` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4318 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4308 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [derbyjs/derby](https://github.com/derbyjs/derby) | 4297 | `./node_modules/.bin/mocha test/all/*.mocha.js; ./node_modules/.bin/jshint lib/*.js test/*.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4250 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4226 | `mocha -R spec ./test --recursive` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4224 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4210 | `./node_modules/.bin/mocha` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4021 | `mocha` | 
...
| [peterramsing/lost](https://github.com/peterramsing/lost) | 3930 | `nyc mocha` | 
...
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3857 | `mocha` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 3822 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [tj/ejs](https://github.com/tj/ejs) | 3698 | `mocha --require should --reporter spec` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3654 | `mocha --recursive && make test` | 
...
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3534 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3529 | `standard && mocha --timeout 60000 test/test.js` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3517 | `mocha --require test/babel-hook test/*.js` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3513 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3503 | `npm run lint && npm run mocha` | 
...
| [henryboldi/felony](https://github.com/henryboldi/felony) | 3405 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js test/**/*.spec.js` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3369 | `nyc mocha` | 
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3329 | `node_modules/.bin/mocha` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3313 | `npm run build-cli && mocha` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3278 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3274 | `npm run lint && mocha && EIO_WS_ENGINE=ws mocha` | 
| [easy-mock/easy-mock](https://github.com/easy-mock/easy-mock) | 3100 | `cross-env NODE_ENV=test istanbul cover _mocha test/*` | 
...
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3056 | `mocha` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3040 | `./node_modules/.bin/mocha test/test.*.js` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3032 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3022 | `mocha --check-leaks --reporter spec --bail` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 2960 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
...
| [shoutem/ui](https://github.com/shoutem/ui) | 2918 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 2882 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 2881 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2876 | `mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2866 | `nyc mocha "test/**/*.test.js"` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2815 | `npm run lint && npm run mocha` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2808 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2772 | `mocha test/*.js` | 
...
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2732 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 2715 | `mocha; jshint *.js lib` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2595 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2585 | `xo && mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2583 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
...
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2511 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
...
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2497 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2495 | `mocha` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2491 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [css/csso](https://github.com/css/csso) | 2489 | `mocha --reporter dot` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2482 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2471 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2469 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2469 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2451 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2438 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2403 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2366 | `mocha --opts mocha.opts` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2316 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
...
| [developit/unfetch](https://github.com/developit/unfetch) | 2299 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
...
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2266 | `npm run compile && mocha --compilers js:babel-core/register` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2213 | `mocha test` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2198 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2194 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2139 | `NODE_ENV=test mocha` | 
...
| [mozilla/send](https://github.com/mozilla/send) | 2120 | `mocha test/unit` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2091 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2089 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2088 | `mocha -R spec` | 
...
| [json5/json5](https://github.com/json5/json5) | 2061 | `mocha --ui exports --reporter spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2024 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2013 | `mocha` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2006 | `cross-env BABEL_ENV=test mocha` | 
| [mde/ejs](https://github.com/mde/ejs) | 1979 | `mocha --require should --reporter spec` | 
...
| [sandeepmistry/noble](https://github.com/sandeepmistry/noble) | 1897 | `mocha -R spec test/*.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1796 | `mocha test && npm run lint` | 
| [Qix-/color](https://github.com/Qix-/color) | 1788 | `mocha` | 
...
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1772 | `mocha` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1772 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 1759 | `export TESTING=true; mocha --reporter list` | 
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1758 | `cross-env NODE_ENV=test mocha` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1750 | `mocha -c test/index.js` | 
...
| [lipp/login-with](https://github.com/lipp/login-with) | 1712 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1705 | `mocha -R landing test/index` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1695 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [BinaryMuse/fluxxor](https://github.com/BinaryMuse/fluxxor) | 1690 | `npm run jshint && mocha --recursive` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1681 | `mocha --compilers js:babel-register` | 
| [Automattic/knox](https://github.com/Automattic/knox) | 1678 | `mocha` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1674 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [addyosmani/tmi](https://github.com/addyosmani/tmi) | 1672 | `xo && mocha` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1671 | `./node_modules/.bin/mocha tests/*.js --exit` | 
...
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1665 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1640 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
...
| [KunalKapadia/express-mongoose-es6-rest-api](https://github.com/KunalKapadia/express-mongoose-es6-rest-api) | 1617 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1584 | `mocha` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1523 | `npm run mocha && npm run karma` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1518 | `npm run lint && mocha` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1470 | `mocha tests --compilers js:babel-core/register` | 
...
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1452 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1414 | `mocha` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1344 | `mocha --reporter spec test/*.js` | 
| [ebidel/appmetrics.js](https://github.com/ebidel/appmetrics.js) | 1342 | `./node_modules/mocha/bin/mocha` | 
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1338 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1330 | `./node_modules/.bin/mocha && npm run jshint` | 
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1325 | `mocha --check-leaks -R dot` | 
| [trufflesuite/ganache-cli](https://github.com/trufflesuite/ganache-cli) | 1323 | `mocha` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1318 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1289 | `mocha --recursive` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1277 | `mocha test.js` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1265 | `standard "src/*.js" && npm run build && mocha` | 
| [enyo/opentip](https://github.com/enyo/opentip) | 1259 | `node_modules/mocha-phantomjs/bin/mocha-phantomjs test/test.html` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1254 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [dlmanning/gulp-sass](https://github.com/dlmanning/gulp-sass) | 1223 | `./node_modules/.bin/mocha test` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1192 | `mocha test/setup.js test/spec/*.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1181 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1173 | `mocha` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1163 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1159 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1155 | `npm run lint && npm run mocha` | 
...
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1092 | `mocha --check-leaks --require @babel/register` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1074 | `mocha test --timeout 600000` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1049 | `mocha` | 
| [brigand/react-mixin](https://github.com/brigand/react-mixin) | 1048 | `mocha test/*` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1043 | `mocha src/test.js` | 
...
| [terinjokes/gulp-uglify](https://github.com/terinjokes/gulp-uglify) | 1035 | `nyc --reporter=lcov --reporter=text mocha --require intelli-espower-loader` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 991 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [zcreativelabs/react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) | 982 | `mocha './tests/**/*.spec.js' --compilers js:babel-core/register` | 
...
| [googlevr/webvr-polyfill](https://github.com/googlevr/webvr-polyfill) | 962 | `mocha` | 
| [expressjs/csurf](https://github.com/expressjs/csurf) | 961 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 955 | `NODE_PATH=. mocha **/*.spec.js` | 
...
| [pauldijou/redux-act](https://github.com/pauldijou/redux-act) | 943 | `NODE_ENV=test mocha --recursive --compilers js:babel-core/register --reporter mocha-better-spec-reporter` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 892 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 890 | `npm run prepublish && mocha test/test.js` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 881 | `mocha test` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 855 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 829 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 814 | `nyc mocha --timeout=20000 test.js` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 802 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [open-xml-templating/docxtemplater](https://github.com/open-xml-templating/docxtemplater) | 786 | `npm run convertto:es5 && npm run mocha` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 762 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [yahoo/blink-diff](https://github.com/yahoo/blink-diff) | 743 | `istanbul cover -- _mocha --reporter spec` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 731 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 728 | `mocha -R spec` | 
...
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 725 | `mocha -t 600000` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 719 | `mocha -R spec --compilers js:babel-core/register ./tests/setup.js ./tests/** --recursive` | 
...
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 689 | `cross-env NODE_ENV=test nyc mocha` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 663 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require babel-register --no-timeouts` | 
