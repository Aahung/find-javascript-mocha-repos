...
The list was updated at 02:07:01 08/08/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 43101 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 41086 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 39582 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 30044 | `mocha --async-only` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 25570 | `cross-env NODE_ENV=test mocha` | 
| [caolan/async](https://github.com/caolan/async) | 24424 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 23091 | `mocha test/index.js` | 
| [developit/preact](https://github.com/developit/preact) | 19632 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 18909 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 16750 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 16498 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 15076 | `node_modules/.bin/mocha test/*.*.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 14315 | `nyc --reporter=html --reporter=text mocha` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13901 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 13381 | `cross-env BABEL_ENV=cjs mocha --require babel-register --reporter spec` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 13086 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) | 12659 | `./node_modules/.bin/mocha test/` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12611 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12286 | `mocha --reporter spec test/*-test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12235 | `mocha` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 11725 | `istanbul cover _mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11443 | `nyc grunt mocha-and-karma` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 11075 | `mocha --reporter dot` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 11071 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 10394 | `mocha test/index.js` | 
| [RelaxedJS/ReLaXed](https://github.com/RelaxedJS/ReLaXed) | 10078 | `mocha` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 10070 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 10067 | `set NODE_ENV=test && mocha` | 
| [tj/co](https://github.com/tj/co) | 10001 | `mocha --harmony` | 
| [reduxjs/redux-devtools](https://github.com/reduxjs/redux-devtools) | 9924 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 9608 | `mocha` | 
| [reduxjs/redux-thunk](https://github.com/reduxjs/redux-thunk) | 9537 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9342 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 9294 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 9053 | `nyc --reporter=text --reporter=lcov npm run mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 8983 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8972 | `grunt mocha` | 
| [amark/gun](https://github.com/amark/gun) | 8671 | `mocha` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8654 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 8594 | `mocha tests/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8476 | `mocha test/test.js` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 8425 | `mocha test/src` | 
...
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 8176 | `cross-env BABEL_ENV=test FORBID_DEPRECATIONS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 8158 | `mocha --compilers js:babel-register test/test.js` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 8049 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7937 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7882 | `npm run eslint && npm run mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7680 | `./node_modules/.bin/mocha test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 7670 | `mocha --opts mocha.opts` | 
...
| [tgriesser/knex](https://github.com/tgriesser/knex) | 7534 | `npm run pre_test && nyc mocha --exit --check-leaks -t 10000 -R spec test/index.js && npm run tape` | 
...
| [aui/art-template](https://github.com/aui/art-template) | 7202 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 7184 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 7161 | `eslint lib/**/*.js test/**/*.js index.js && mocha --exit --require should --reporter spec --check-leaks` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 7018 | `xo && mocha test/*.js --timeout 100000` | 
...
| [almende/vis](https://github.com/almende/vis) | 6954 | `mocha --compilers js:babel-core/register` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6876 | `mocha $HARMONY_OPTS` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6778 | `mocha --timeout 10000 ./test/*/*.test.js` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 6429 | `npm run jshint && mocha test/` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 6354 | `mocha; jshint *.js lib` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 6292 | `mocha --exit --require babel-core/register` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6156 | `mocha test/test.js` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 6046 | `mocha` | 
...
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5878 | `mocha tests/node.js` | 
| [shipshapecode/shepherd](https://github.com/shipshapecode/shepherd) | 5810 | `mocha` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5790 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5715 | `mocha && eslint lib/**` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5684 | `mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5582 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
...
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 5536 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha --timeout 60000 ./infra/testing/auto-stub-logger.mjs` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5409 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 5297 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 5246 | `standard && mocha` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 5084 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 5072 | `npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4949 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4946 | `gulp lint && mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4914 | `mocha` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4730 | `mocha test` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4724 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4693 | `mocha --reporter spec -t 8000` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4595 | `./node_modules/.bin/mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4569 | `mocha ./test/runner.js` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 4511 | `NODE_ENV=test mocha --timeout 8000 -r ts-node/register --exit` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4460 | `mocha` | 
...
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 4395 | `nyc mocha --exit` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4394 | `mocha --recursive` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 4377 | `npm run lint && npm run mocha` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 4154 | `npm run lint && npm run mocha` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 4074 | `nyc mocha` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 4045 | `node_modules/.bin/mocha test/tests.js` | 
| [ramboxapp/community-edition](https://github.com/ramboxapp/community-edition) | 4013 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [muicss/mui](https://github.com/muicss/mui) | 4010 | `mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 4004 | `mocha --require test/babel-hook test/*.js` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3976 | `npm run lint ; mocha && mocha test/individual` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3975 | `mocha --timeout=15000 tests/*.test.js` | 
| [tj/ejs](https://github.com/tj/ejs) | 3969 | `mocha --require should --reporter spec` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3834 | `prettier-check src/**/*.js && mocha ./test/*.spec.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3828 | `cross-env NODE_ENV=test mocha --require babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3815 | `mocha --check-leaks --reporter spec --bail` | 
| [erming/shout](https://github.com/erming/shout) | 3803 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 3745 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3744 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3742 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [teambit/bit](https://github.com/teambit/bit) | 3737 | `mocha --require babel-core/register './src/**/*.spec.js'` | 
...
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3661 | `standard && mocha --timeout 60000 test/test.js` | 
| [primus/primus](https://github.com/primus/primus) | 3646 | `npm run build && mocha test/*.test.js` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3636 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3601 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [blakeembrey/code-problems](https://github.com/blakeembrey/code-problems) | 3577 | `mocha tests/javascript` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3568 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3537 | `mocha --reporter spec --timeout 3000` | 
...
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3493 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3443 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [dthree/vantage](https://github.com/dthree/vantage) | 3435 | `mocha` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 3423 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 3369 | `NODE_ENV=test mocha --exit` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 3312 | `cross-env BABEL_ENV=test mocha --require babel-register test/test.js` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 3219 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 3064 | `export TESTING=true; mocha --reporter list` | 
...
| [aui/font-spider](https://github.com/aui/font-spider) | 3036 | `mocha test/index.js && npm run demo` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 3035 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 3033 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 3026 | `mocha` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 3025 | `mocha` | 
...
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 3005 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 3001 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2979 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2958 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2945 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests --exclude "tests/unit/relations/files/**"` | 
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2918 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2885 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2879 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2877 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2877 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2874 | `mocha -R spec --recursive src/test` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2863 | `mocha` | 
...
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2823 | `istanbul cover _mocha` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2819 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [developit/unfetch](https://github.com/developit/unfetch) | 2805 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [github-tools/github](https://github.com/github-tools/github) | 2797 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2797 | `npm run mocha && npm run lint` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2774 | `mocha -R landing test/index` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2773 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2750 | `mocha --require babel-register --recursive spec` | 
| [mdaines/viz.js](https://github.com/mdaines/viz.js) | 2743 | `mocha test-node` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2718 | `node_modules/.bin/mocha --reporter spec` | 
| [css/csso](https://github.com/css/csso) | 2714 | `mocha --reporter dot` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2682 | `mocha --require should --reporter spec` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2668 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 2663 | `mocha -R spec spec spec/reporters` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 2578 | `eslint . && mocha -t 5000` | 
...
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2526 | `nyc mocha` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2511 | `mocha` | 
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2500 | `mocha "test/**/*-test.js"` | 
| [negomi/react-burger-menu](https://github.com/negomi/react-burger-menu) | 2486 | `cross-env NODE_ENV=test mocha --require babel-register --require jsdom-global/register --reporter list` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2469 | `mocha --reporter=spec test/*-test.js` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2449 | `mocha test` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2437 | `mocha test/unit --require mochahook` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2435 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2427 | `mocha` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2331 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2310 | `mocha -R spec` | 
...
| [panzerdp/voca](https://github.com/panzerdp/voca) | 2286 | `mocha test/index.js --reporter dot` | 
| [davidmerfield/Typeset](https://github.com/davidmerfield/Typeset) | 2280 | `mocha -u bdd -R spec -t 500 --recursive` | 
...
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2257 | `mocha && eslint .` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 2193 | `mocha test/ --no-timeouts` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 2038 | `nyc npm run _mocha` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 2037 | `mocha --timeout 10000 --exit test/*-test.js test/security/*.js` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1974 | `mocha` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1966 | `mocha -c test/index.js` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1965 | `mocha --compilers js:babel-core/register __tests__` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1954 | `mocha && eslint *.js` | 
...
| [then/promise](https://github.com/then/promise) | 1917 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1911 | `rimraf dbtest && npm run lint && SQLPAD_DB_PATH='./dbtest' mocha server/test --timeout 10000 --recursive --exit` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1909 | `mocha --require ./test/common --growl test/expect.js` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1901 | `npm run lint && npm run mocha` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1869 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1810 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1808 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [diegonetto/generator-ionic](https://github.com/diegonetto/generator-ionic) | 1802 | `mocha --timeout 5000` | 
| [seaneking/rucksack](https://github.com/seaneking/rucksack) | 1797 | `mocha test` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1796 | `mocha --reporter spec test/*.js` | 
...
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1786 | `mocha test` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1786 | `mocha tests --compilers js:babel-core/register` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1772 | `mocha --compilers js:babel-register` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1751 | `mocha test/**/*.js` | 
...
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1729 | `mocha test -u bdd -R spec` | 
...
| [Automattic/knox](https://github.com/Automattic/knox) | 1710 | `mocha` | 
...
| [freeCodeCamp/guide](https://github.com/freeCodeCamp/guide) | 1657 | `mocha  -R spec "./{,!(node_modules)/**/}*.test.js"` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1635 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1626 | `mocha compiled_tests/` | 
| [jakiestfu/himawari.js](https://github.com/jakiestfu/himawari.js) | 1626 | `mocha tests/test.js` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1626 | `mocha compiled_tests/` | 
| [ai/visibilityjs](https://github.com/ai/visibilityjs) | 1624 | `mocha && size-limit` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1608 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1560 | `node node_modules/mocha/bin/mocha --check-leaks -R dot` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1556 | `mocha test` | 
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1551 | `standard "./src/*.js" && mocha` | 
...
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1521 | `mocha test.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1504 | `nyc npm run mocha` | 
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1503 | `mocha -u tdd` | 
...
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1316 | `mocha --recursive` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1301 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1301 | `standard && istanbul cover _mocha` | 
...
| [messageformat/messageformat](https://github.com/messageformat/messageformat) | 1280 | `mocha` | 
| [andywer/leakage](https://github.com/andywer/leakage) | 1268 | `mocha --timeout 60000 test/` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 1265 | `NODE_ENV=test mocha tests/*.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 1252 | `mocha ./test/test*.js --reporter spec` | 
...
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1367 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1352 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 1344 | `TEST=all mocha` | 
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1340 | `mocha` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1338 | `npm run lint && mocha && karma start --single-run` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1254 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 1252 | `mocha ./test/test*.js --reporter spec` | 
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1268 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
| [andywer/leakage](https://github.com/andywer/leakage) | 1268 | `mocha --timeout 60000 test/` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 1265 | `NODE_ENV=test mocha tests/*.js` | 
...
| [yanyiwu/nodejieba](https://github.com/yanyiwu/nodejieba) | 1247 | `node test/demo.js && node test/load_dict_demo.js && mocha --timeout 10s -R spec test/test.js && mocha --timeout 10s -R spec test/load_dict_test.js` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1246 | `mocha -R spec ./test/unit/**` | 
...
| [firebase/firebase-tools](https://github.com/firebase/firebase-tools) | 1234 | `npm run lint && npm run mocha` | 
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1234 | `mocha --check-leaks --reporter spec --bail test/` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1227 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 1225 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1214 | `mocha` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1210 | `npm run prepublishOnly && mocha test/test.js` | 
| [Tencent/TSW](https://github.com/Tencent/TSW) | 1209 | `mocha --recursive test/bin` | 
...
| [btmills/geopattern](https://github.com/btmills/geopattern) | 1202 | `npm run lint && npm run mocha` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1186 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 1161 | `mocha --compilers js:babel-core/register` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 1148 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [localtunnel/server](https://github.com/localtunnel/server) | 1138 | `mocha --check-leaks --require esm './**/*.test.js'` | 
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 1136 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1131 | `mocha` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 1124 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
| [3rd-Eden/memcached](https://github.com/3rd-Eden/memcached) | 1123 | `mocha $(find test -name '*.test.js')` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 1122 | `mocha` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 1122 | `webpack && npm run lint && npm run mocha` | 
...
| [Ziv-Barber/officegen](https://github.com/Ziv-Barber/officegen) | 1115 | `mocha test/test-docx.js test/test-xlsx.js test/test-pptx-nocharts.js test/test-pptx-charts.js` | 
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 1114 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 1068 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 1035 | `mocha` | 
...
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 1064 | `webpack && mocha test/unit` | 
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 1062 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [levelgraph/levelgraph](https://github.com/levelgraph/levelgraph) | 1058 | `mocha --recursive --bail --reporter spec test` | 
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1054 | `mocha test/tests.js` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 1053 | `mocha` | 
...
| [yeoman/generator-webapp_DEPRECATED](https://github.com/yeoman/generator-webapp_DEPRECATED) | 1037 | `mocha --reporter spec --timeout 3000` | 
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 1037 | `standard && mocha -b` | 
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 1035 | `mocha` | 
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 1031 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
| [RisingStack/graffiti](https://github.com/RisingStack/graffiti) | 1044 | `NODE_ENV=test mocha --compilers js:babel-register 'src/**/*.spec.js'` | 
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 1041 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 1019 | `eslint src test && mocha --compilers babel-register` | 
...
| [tomas/needle](https://github.com/tomas/needle) | 1018 | `mocha test` | 
...
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 971 | `standard src/index.js && mocha --compilers js:babel-register` | 
...
| [MohammadYounes/rtlcss](https://github.com/MohammadYounes/rtlcss) | 924 | `npm run lint && mocha -R spec` | 
...
| [gaearon/react-side-effect](https://github.com/gaearon/react-side-effect) | 907 | `mocha` | 
...
| [symfony/webpack-encore](https://github.com/symfony/webpack-encore) | 898 | `./node_modules/.bin/mocha --reporter spec test --recursive` | 
| [samgozman/YoptaScript](https://github.com/samgozman/YoptaScript) | 898 | `mocha` | 
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 892 | `mocha -t 600000` | 
...
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 878 | `mocha test` | 
...
| [ConsenSys/eth-lightwallet](https://github.com/ConsenSys/eth-lightwallet) | 866 | `./node_modules/.bin/mocha --reporter spec` | 
...
| [digitalbazaar/jsonld.js](https://github.com/digitalbazaar/jsonld.js) | 862 | `cross-env NODE_ENV=test mocha --delay -t 30000 -A -R ${REPORTER:-spec} tests/test.js` | 
...
| [pantsel/konga](https://github.com/pantsel/konga) | 849 | `mocha` | 
...
| [auth0-community/socketio-jwt](https://github.com/auth0-community/socketio-jwt) | 841 | `mocha` | 
...
| [dareid/chakram](https://github.com/dareid/chakram) | 839 | `istanbul cover _mocha` | 
| [GitbookIO/nuts](https://github.com/GitbookIO/nuts) | 837 | `mocha --reporter list` | 
| [james-proxy/james](https://github.com/james-proxy/james) | 837 | `mocha-webpack --reporter dot --webpack-config webpack.test.config.js --recursive test/unit` | 
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 836 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
| [gulpjs/gulp-util](https://github.com/gulpjs/gulp-util) | 835 | `jshint *.js lib/*.js test/*.js && mocha` | 
| [amplitude/redux-query](https://github.com/amplitude/redux-query) | 835 | `mocha --compilers js:babel-core/register --reporter spec test/**/*.test.js` | 
| [mridgway/hoist-non-react-statics](https://github.com/mridgway/hoist-non-react-statics) | 833 | `mocha tests/unit/ --recursive --compilers js:babel-register --reporter spec` | 
...
| [bubenshchykov/ngrok](https://github.com/bubenshchykov/ngrok) | 820 | `node ./node_modules/mocha/bin/_mocha --exit` | 
| [mjackson/mach](https://github.com/mjackson/mach) | 819 | `jshint . && mocha --require babel/register --reporter spec 'modules/**/__tests__/*-test.js'` | 
| [salomvary/soundcleod](https://github.com/salomvary/soundcleod) | 817 | `mocha` | 
| [fex-team/ua-device](https://github.com/fex-team/ua-device) | 815 | `mocha test/index.js` | 
...
| [yanhaijing/template.js](https://github.com/yanhaijing/template.js) | 805 | `mocha test` | 
...
| [mozilla/node-convict](https://github.com/mozilla/node-convict) | 793 | `mocha --check-leaks -R spec test/*-tests.js` | 
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 797 | `cross-env NODE_ENV=test nyc --reporter=text-summary mocha --recursive --throw-deprecation --require babel-polyfill --require babel-core/register` | 
| [natefaubion/matches.js](https://github.com/natefaubion/matches.js) | 797 | `mocha -u tdd` | 
| [fitzgen/wu.js](https://github.com/fitzgen/wu.js) | 795 | `npm run build && mocha --full-trace --no-colors --compilers js:babel/register` | 
| [mozilla/node-convict](https://github.com/mozilla/node-convict) | 793 | `mocha --check-leaks -R spec test/*-tests.js` | 
| [mozilla/awsbox](https://github.com/mozilla/awsbox) | 793 | `mocha -R spec tests/` | 
| [gre/bezier-easing](https://github.com/gre/bezier-easing) | 790 | `mocha` | 
...
| [ruanyf/es-checker](https://github.com/ruanyf/es-checker) | 781 | `mocha` | 
...
| [ianstormtaylor/react-values](https://github.com/ianstormtaylor/react-values) | 768 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./test/index.js` | 
...
| [crowi/crowi](https://github.com/crowi/crowi) | 757 | `mocha -r test/bootstrap.js --globals chai --reporter dot test/**/*.test.js` | 
| [jhusain/eslint-plugin-immutable](https://github.com/jhusain/eslint-plugin-immutable) | 755 | `mocha --recursive -s 15 test/` | 
| [syt123450/giojs](https://github.com/syt123450/giojs) | 753 | `mocha` | 
...
| [nodesecurity/eslint-plugin-security](https://github.com/nodesecurity/eslint-plugin-security) | 726 | `./node_modules/.bin/mocha test/**/*` | 
| [loganfsmyth/babel-plugin-transform-decorators-legacy](https://github.com/loganfsmyth/babel-plugin-transform-decorators-legacy) | 725 | `babel-node node_modules/.bin/_mocha -- test` | 
...
| [EOSIO/eosjs](https://github.com/EOSIO/eosjs) | 719 | `mocha --exit --use_strict src/*.test.js` | 
| [flickr/yakbak](https://github.com/flickr/yakbak) | 716 | `mocha` | 
...
| [sghiassy/react-native-sglistview](https://github.com/sghiassy/react-native-sglistview) | 723 | `yarn config:enable:babelrc; ./node_modules/.bin/mocha || yarn config:disable:babelrc` | 
| [fynyky/reactor.js](https://github.com/fynyky/reactor.js) | 723 | `mocha` | 
| [mondora/asteroid](https://github.com/mondora/asteroid) | 723 | `env NODE_ENV=test env NODE_PATH=src _mocha --compilers js:babel-core/register --recursive test/unit` | 
| [inikulin/publish-please](https://github.com/inikulin/publish-please) | 721 | `npm run prettier-format && npm run lint && npm run build && npm run mocha-with-coverage && npm run check-coverage` | 
| [omnidan/redux-ignore](https://github.com/omnidan/redux-ignore) | 720 | `NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register --recursive` | 
| [MaxArt2501/share-this](https://github.com/MaxArt2501/share-this) | 720 | `nyc --require babel-core/register mocha test/*.js test/sharers/*.js` | 
| [EOSIO/eosjs](https://github.com/EOSIO/eosjs) | 719 | `mocha --exit --use_strict src/*.test.js` | 