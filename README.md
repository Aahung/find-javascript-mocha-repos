...
The list was updated at 02:06:42 02/25/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39853 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39464 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 37421 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation` | 
| [expressjs/express](https://github.com/expressjs/express) | 36801 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28843 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23425 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22241 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 20787 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 19559 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 17820 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17566 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15611 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14922 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13817 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13157 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12703 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12109 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12104 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12013 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11726 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11711 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11366 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11080 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10629 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10559 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10001 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9701 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9554 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [tj/co](https://github.com/tj/co) | 9324 | `mocha --harmony` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9309 | `mocha test/index.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9280 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9141 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9071 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8894 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8557 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8401 | `mocha test/*-test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8327 | `mocha` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8153 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8141 | `mocha test/test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8084 | `grunt clean:test && mocha --exit` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7983 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7859 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7823 | `./node_modules/.bin/mocha test/src` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7753 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [websockets/ws](https://github.com/websockets/ws) | 7745 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7717 | `mocha --compilers js:babel-register test/test.js` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7503 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
...
| [amark/gun](https://github.com/amark/gun) | 7439 | `mocha` | 
| [rstacruz/jquery.transit](https://github.com/rstacruz/jquery.transit) | 7438 | `mocha` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7358 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7285 | `mocha tests/*.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7170 | `npm run build && istanbul cover _mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7132 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6929 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6901 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6658 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6559 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6509 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6443 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6394 | `mocha --opts mocha.opts` | 
...
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6368 | `nyc mocha test/**/* -r ./test/before` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6303 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [almende/vis](https://github.com/almende/vis) | 6281 | `mocha --compilers js:babel-core/register` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6278 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
...
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5847 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5813 | `npm run test:mocha:src` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5777 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5709 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5552 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5496 | `mocha tests/node.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5468 | `mocha test --recursive` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5387 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5386 | `mocha && eslint lib/**` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5355 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5347 | `mocha test/test.js` | 
...
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5135 | `mocha --exit --require babel-core/register` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5126 | `mocha --timeout 10000 && npm run lint` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4993 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 4832 | `mocha` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4778 | `gulp lint && mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4739 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4721 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4714 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 4700 | `npm run build-cli && mocha` | 
| [santinic/how2](https://github.com/santinic/how2) | 4627 | `mocha test` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4616 | `mocha --reporter spec -t 8000` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4608 | `mocha -R spec 'tests/app'` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4598 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4537 | `mocha ./test/runner.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4486 | `gulp build; mocha;` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4475 | `standard && mocha` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4414 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4396 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4391 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4355 | `mocha` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4344 | `./node_modules/.bin/mocha` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4295 | `mocha` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4223 | `mocha -R spec ./test --recursive` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4212 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4150 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4127 | `mocha; jshint *.js lib` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 4078 | `mocha && ./bin/shipit staging test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4008 | `nyc mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3901 | `mocha --require test/babel-hook test/*.js` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3901 | `mocha --recursive && make test` | 
...
| [muicss/mui](https://github.com/muicss/mui) | 3843 | `mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3826 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3770 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3750 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3649 | `nyc mocha` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3510 | `mocha ./test/*.spec.js` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3475 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [primus/primus](https://github.com/primus/primus) | 3466 | `npm run build && mocha test/*.test.js` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3432 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3319 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3253 | `mocha --check-leaks --reporter spec --bail` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3247 | `npm run lint && npm run mocha` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3207 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3145 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3109 | `nyc mocha "test/**/*.test.js"` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3099 | `mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3089 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [expressjs/session](https://github.com/expressjs/session) | 3086 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2982 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [ttezel/twit](https://github.com/ttezel/twit) | 2953 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2917 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2878 | `mocha test/*.js` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2875 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2812 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2760 | `nyc mocha && tsc` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2757 | `mocha --require should --reporter spec` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2755 | `mocha -R spec --recursive src/test` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2750 | `mocha` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2731 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2726 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2726 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2723 | `istanbul cover _mocha` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2720 | `mocha test/index.js && npm run demo` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2718 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2699 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2693 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [github-tools/github](https://github.com/github-tools/github) | 2683 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2658 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2658 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2655 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2653 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2640 | `mocha` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2624 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2614 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2611 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2589 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2580 | `mocha --opts mocha.opts` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2579 | `mocha-phantomjs ./test/index.html` | 
| [css/csso](https://github.com/css/csso) | 2569 | `mocha --reporter dot` | 
...
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2444 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2438 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2424 | `mocha --reporter=spec test/*-test.js` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2403 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2361 | `NODE_ENV=test mocha` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2336 | `mocha` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2335 | `mocha -t 30000 -R spec tests/unit/index.js` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2324 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [mozilla/send](https://github.com/mozilla/send) | 2309 | `mocha test/unit` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2301 | `npm run build && cd test && mocha . --reporter dot` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2298 | `mocha test/src/**/*.unit.js` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2295 | `mocha test` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2290 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2205 | `mocha` | 
...
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2193 | `mocha "test/**/*-test.js"` | 
...
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2161 | `mocha -R spec` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2154 | `mocha` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2148 | `export TESTING=true; mocha --reporter list` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2145 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2057 | `nyc --reporter=html --reporter=text mocha` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2050 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2008 | `mocha test.js` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1965 | `mocha -R landing test/index` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1933 | `mocha test && npm run lint` | 
| [hojberg/cssarrowplease](https://github.com/hojberg/cssarrowplease) | 1928 | `mocha --require=test/test_helper.js` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1915 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1889 | `mocha test/index.js --reporter dot` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1864 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [yeoman/generator-chrome-extension](https://github.com/yeoman/generator-chrome-extension) | 1839 | `mocha --reporter spec --timeout 5000` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1797 | `mocha test/runner.js --reporter spec` | 
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1788 | `cross-env NODE_ENV=test mocha` | 
...
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1786 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
...
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1760 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1737 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1710 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1679 | `npm run mocha && npm run karma` | 
...
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1669 | `mocha -R spec spec spec/reporters` | 
...
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1636 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1578 | `mocha` | 
...
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1572 | `npm run mocha && npm run lint` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1552 | `npm run lint && npm run mocha` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1546 | `./node_modules/.bin/mocha` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1541 | `mocha test -u bdd -R spec` | 
...
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 1529 | `npm run lint && mocha` | 
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1528 | `mocha` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1524 | `mocha spec` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1522 | `mocha test/* --reporter spec` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1513 | `mocha --reporter spec test/*.js` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1503 | `mocha test --timeout 600000` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1485 | `npm run lint && npm run mocha` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1482 | `standard "src/*.js" && npm run build && mocha` | 
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1479 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1391 | `nyc mocha` | 
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1389 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1389 | `eslint --cache . && tsc && mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1387 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1376 | `mocha test.js` | 
...
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1364 | `standard "./src/*.js" && mocha` | 
| [squaremo/rabbit.js](https://github.com/squaremo/rabbit.js) | 1364 | `./node_modules/mocha/bin/mocha --ui exports test` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1350 | `mocha --recursive` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1325 | `mocha tests.js` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1316 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1314 | `mocha --check-leaks --reporter spec --bail` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1308 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1296 | `eslint . && mocha -t 5000` | 
| [letsgetrandy/DICSS](https://github.com/letsgetrandy/DICSS) | 1292 | `mocha-phantomjs tests/index.html` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1291 | `mocha` | 
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1286 | `mocha --timeout 10000 ./tests/lib.js` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1284 | `mocha compiled_tests/` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1266 | `mocha test/setup.js test/spec/*.js` | 
| [enyo/opentip](https://github.com/enyo/opentip) | 1261 | `node_modules/mocha-phantomjs/bin/mocha-phantomjs test/test.html` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1259 | `npm run lint && npm run mocha` | 
...
| [markdalgleish/static-site-generator-webpack-plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin) | 1222 | `istanbul cover _mocha test -- --timeout 20000` | 
...
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1192 | `mocha --check-leaks --require @babel/register` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1132 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1131 | `mocha` | 
...
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1111 | `mocha test/unit` | 
| [normalize/mz](https://github.com/normalize/mz) | 1111 | `mocha --reporter spec` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1107 | `standard && istanbul cover _mocha` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1104 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1103 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1102 | `mocha --reporter dot` | 
...
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1094 | `node_modules/.bin/mocha` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1085 | `eslint src && mocha && karma start --single-run` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1061 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1044 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1035 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 1023 | `NODE_PATH=. mocha **/*.spec.js` | 
...
| [pauldijou/redux-act](https://github.com/pauldijou/redux-act) | 1011 | `NODE_ENV=test mocha --recursive --compilers js:babel-core/register --reporter mocha-better-spec-reporter` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1007 | `nyc mocha --timeout=20000 test.js` | 
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1006 | `mocha` | 
...
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 977 | `mocha` | 
...
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 950 | `mocha` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 946 | `mocha --recursive test` | 
...
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 937 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
...
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 932 | `standard && mocha -b` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 921 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 920 | `webpack && mocha test/unit` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 919 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [kriasoft/universal-router](https://github.com/kriasoft/universal-router) | 896 | `nyc mocha --require @babel/register` | 
...
| [electron/spectron](https://github.com/electron/spectron) | 893 | `mocha && standard` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 891 | `mocha ./test/test*.js --reporter spec` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 890 | `mocha -R spec ./test/unit/**` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 881 | `mocha` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 861 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [erelsgl/limdu](https://github.com/erelsgl/limdu) | 850 | `mocha` | 
...
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 841 | `npm run lint && npm run mocha` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 806 | `mocha -R spec` | 
...
| [gaearon/react-side-effect](https://github.com/gaearon/react-side-effect) | 787 | `mocha` | 
...
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 785 | `mocha -t 600000` | 
...
| [image-size/image-size](https://github.com/image-size/image-size) | 773 | `nyc mocha specs` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 766 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 743 | `mocha` | 
...
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 737 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
...
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 724 | `cross-env NODE_ENV=test nyc mocha` | 
...
| [fossasia/open-event-webapp](https://github.com/fossasia/open-event-webapp) | 690 | `mocha` | 
...
| [domchristie/humps](https://github.com/domchristie/humps) | 682 | `mocha` | 