...
The list was updated at 02:06:49 07/28/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 42962 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 41029 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 39428 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29968 | `mocha --async-only` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 25234 | `cross-env NODE_ENV=test mocha` | 
| [caolan/async](https://github.com/caolan/async) | 24379 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 24000 | `cross-env BABEL_ENV=test FORBID_DEPRECATIONS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 22957 | `mocha test/index.js` | 
| [developit/preact](https://github.com/developit/preact) | 19527 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 18815 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 16665 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 16407 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 14980 | `node_modules/.bin/mocha test/*.*.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 14288 | `nyc --reporter=html --reporter=text mocha` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13838 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 13247 | `cross-env BABEL_ENV=cjs mocha --require babel-register --reporter spec` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 13042 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) | 12605 | `./node_modules/.bin/mocha test/` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12602 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12259 | `mocha --reporter spec test/*-test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12226 | `mocha` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 11636 | `istanbul cover _mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11407 | `nyc grunt mocha-and-karma` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 10991 | `mocha --reporter dot` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 10984 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 10322 | `mocha test/index.js` | 
| [svg/svgo](https://github.com/svg/svgo) | 10010 | `set NODE_ENV=test && mocha` | 
| [RelaxedJS/ReLaXed](https://github.com/RelaxedJS/ReLaXed) | 10005 | `mocha` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9996 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [tj/co](https://github.com/tj/co) | 9969 | `mocha --harmony` | 
| [reduxjs/redux-devtools](https://github.com/reduxjs/redux-devtools) | 9892 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 9540 | `mocha` | 
| [reduxjs/redux-thunk](https://github.com/reduxjs/redux-thunk) | 9436 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9312 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 9217 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 9007 | `nyc --reporter=text --reporter=lcov npm run mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8950 | `grunt mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 8904 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8610 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [amark/gun](https://github.com/amark/gun) | 8527 | `mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 8487 | `mocha tests/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8460 | `mocha test/test.js` | 
...
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8282 | `grunt clean:test && mocha --exit` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 8140 | `mocha --compilers js:babel-register test/test.js` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 8053 | `cross-env BABEL_ENV=test FORBID_DEPRECATIONS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 8038 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7887 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
...
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 7595 | `mocha --opts mocha.opts` | 
...
| [tgriesser/knex](https://github.com/tgriesser/knex) | 7444 | `npm run pre_test && nyc mocha --exit --check-leaks -t 10000 -R spec test/index.js && npm run tape` | 
...
| [aui/art-template](https://github.com/aui/art-template) | 7160 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 7126 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 7119 | `eslint lib/**/*.js test/**/*.js index.js && mocha --exit --require should --reporter spec --check-leaks` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6977 | `xo && mocha test/*.js --timeout 100000` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6928 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [almende/vis](https://github.com/almende/vis) | 6909 | `mocha --compilers js:babel-core/register` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6863 | `mocha $HARMONY_OPTS` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6689 | `mocha --timeout 10000 ./test/*/*.test.js` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 6396 | `npm run jshint && mocha test/` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 6239 | `mocha; jshint *.js lib` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 6221 | `mocha --exit --require babel-core/register` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 6200 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 6195 | `npm run test:mocha:src` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6096 | `mocha test/test.js` | 
...
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 5942 | `mocha` | 
...
| [automerge/automerge](https://github.com/automerge/automerge) | 5670 | `mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5541 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 5535 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 5472 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha --timeout 60000 ./infra/testing/auto-stub-logger.mjs` | 
...
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 5051 | `npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 4954 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4943 | `gulp lint && mocha` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4911 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4875 | `mocha` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4703 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4698 | `mocha test` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4691 | `mocha --reporter spec -t 8000` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4574 | `./node_modules/.bin/mocha` | 
...
| [prerender/prerender](https://github.com/prerender/prerender) | 4574 | `./node_modules/.bin/mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4567 | `mocha ./test/runner.js` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 4468 | `NODE_ENV=test mocha --timeout 8000 -r ts-node/register --exit` | 
...
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 4365 | `nyc mocha --exit` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4357 | `mocha --recursive` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 4344 | `npm run lint && npm run mocha` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 4108 | `npm run lint && npm run mocha` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 4100 | `mocha -R spec ./test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 4057 | `nyc mocha` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 4005 | `node_modules/.bin/mocha test/tests.js` | 
...
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3779 | `mocha --check-leaks --reporter spec --bail` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3776 | `cross-env NODE_ENV=test mocha --require babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3731 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3679 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3670 | `npm run jshint && npm run mocha` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 3660 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [teambit/bit](https://github.com/teambit/bit) | 3656 | `mocha --require babel-core/register './src/**/*.spec.js'` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3655 | `standard && mocha --timeout 60000 test/test.js` | 
| [primus/primus](https://github.com/primus/primus) | 3634 | `npm run build && mocha test/*.test.js` | 
...
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3510 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3503 | `nyc --reporter=html --reporter=text --reporter lcovonly mocha` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 3386 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 3316 | `NODE_ENV=test mocha --exit` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 3276 | `cross-env BABEL_ENV=test mocha --require babel-register test/test.js` | 
| [express-validator/express-validator](https://github.com/express-validator/express-validator) | 3205 | `nyc mocha && tsc` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 3204 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 3030 | `mocha test/*.js` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 3007 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2999 | `mocha` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2912 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests --exclude "tests/unit/relations/files/**"` | 
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2880 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2925 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2912 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests --exclude "tests/unit/relations/files/**"` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2904 | `mocha` | 
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2880 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2874 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2870 | `mocha -R spec --recursive src/test` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2866 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2859 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2853 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2784 | `npm run mocha && npm run lint` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2781 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [mde/ejs](https://github.com/mde/ejs) | 2659 | `mocha --require should --reporter spec` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2649 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [json5/json5](https://github.com/json5/json5) | 2619 | `nyc --reporter=html --reporter=text mocha` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2608 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
...
| [reactGo/reactGo](https://github.com/reactGo/reactGo) | 2563 | `mocha ./app/tests/setup.js --compilers css:./app/tests/compilers/css ./app/**/*-test.js` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2508 | `nyc mocha` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2491 | `mocha` | 
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2610 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2608 | `mocha-phantomjs ./test/index.html` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2608 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2597 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2579 | `mocha test.js` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2572 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [yeoman/yo](https://github.com/yeoman/yo) | 2569 | `nyc mocha --timeout=10000` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2568 | `npm run build && cd test && mocha . --reporter dot` | 
| [reactGo/reactGo](https://github.com/reactGo/reactGo) | 2563 | `mocha ./app/tests/setup.js --compilers css:./app/tests/compilers/css ./app/**/*-test.js` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2508 | `nyc mocha` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 2501 | `eslint . && mocha -t 5000` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2491 | `mocha` | 
...
| [negomi/react-burger-menu](https://github.com/negomi/react-burger-menu) | 2464 | `cross-env NODE_ENV=test mocha --require babel-register --require jsdom-global/register --reporter list` | 
...
| [wix/react-templates](https://github.com/wix/react-templates) | 2431 | `mocha test/src/**/*.unit.js` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2423 | `mocha test/unit --require mochahook` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2416 | `mocha` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2415 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2405 | `mocha` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2396 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [katiefenn/parker](https://github.com/katiefenn/parker) | 2369 | `mocha --no-colors --reporter spec` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2298 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 2286 | `mocha test && npm run lint` | 
...
| [panzerdp/voca](https://github.com/panzerdp/voca) | 2257 | `mocha test/index.js --reporter dot` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2244 | `mocha && eslint .` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2231 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
...
| [noble/noble](https://github.com/noble/noble) | 2174 | `mocha -R spec test/*.js` | 
| [embark-framework/embark](https://github.com/embark-framework/embark) | 2160 | `mocha test/ --no-timeouts` | 
...
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 2134 | `mocha -R spec spec spec/reporters` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 2094 | `mocha` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 2039 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 2038 | `mocha test/runner.js --reporter spec` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 2021 | `mocha --timeout 10000 --exit test/*-test.js test/security/*.js` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 2002 | `nyc npm run _mocha` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1951 | `mocha` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1890 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1858 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1813 | `npm run mocha && npm run karma` | 
...
| [seaneking/rucksack](https://github.com/seaneking/rucksack) | 1793 | `mocha test` | 
...
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1786 | `mocha test/unit --recursive && mocha test/runner --recursive` | 
...
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1767 | `mocha --reporter spec --grep .` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1767 | `mocha --reporter spec --grep .` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1760 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1652 | `npm run lint && npm run mocha` | 
...
| [freeCodeCamp/guide](https://github.com/freeCodeCamp/guide) | 1641 | `mocha  -R spec "./{,!(node_modules)/**/}*.test.js"` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1640 | `mocha test/* --reporter spec` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1600 | `mocha compiled_tests/` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1559 | `mocha test/setup.js test/spec/*.js` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1551 | `node node_modules/mocha/bin/mocha --check-leaks -R dot` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1550 | `./node_modules/.bin/mocha` | 
| [zeit/ms](https://github.com/zeit/ms) | 1546 | `mocha tests.js` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1423 | `nyc mocha --timeout=20000 test.js` | 
...
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1362 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1361 | `mocha --check-leaks --require @babel/register` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1355 | `mocha` | 
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1348 | `mocha test/unit` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1328 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1324 | `eslint src && mocha && karma start --single-run` | 
...
| [markdalgleish/static-site-generator-webpack-plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin) | 1322 | `istanbul cover _mocha test -- --timeout 20000` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1321 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [dlmanning/gulp-sass](https://github.com/dlmanning/gulp-sass) | 1313 | `./node_modules/.bin/mocha test` | 
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 1310 | `TEST=all mocha` | 
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1310 | `mocha --recursive` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1287 | `standard && istanbul cover _mocha` | 
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1286 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1259 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1240 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1220 | `mocha -R spec ./test/unit/**` | 
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1220 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [firebase/firebase-tools](https://github.com/firebase/firebase-tools) | 1214 | `npm run lint && npm run mocha` | 
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1208 | `mocha` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 1207 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [flickr/justified-layout](https://github.com/flickr/justified-layout) | 1206 | `istanbul test _mocha` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1205 | `mocha` | 
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 1204 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [Tencent/TSW](https://github.com/Tencent/TSW) | 1196 | `mocha --recursive test/bin` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1182 | `npm run prepublishOnly && mocha test/test.js` | 
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1180 | ` NODE_ENV=test mocha --require babel-core/register` | 
| [variety/variety](https://github.com/variety/variety) | 1179 | `node_modules/.bin/mocha --compilers js:babel-core/register --require babel-polyfill  --recursive --reporter spec --timeout 15000 spec` | 
...
| [pauldijou/redux-act](https://github.com/pauldijou/redux-act) | 1174 | `NODE_ENV=test mocha --recursive --compilers js:babel-core/register --reporter mocha-better-spec-reporter` | 
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1172 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 1172 | `mocha` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1170 | `mocha --recursive test` | 
| [jkphl/svg-sprite](https://github.com/jkphl/svg-sprite) | 1169 | `istanbul test node_modules/mocha/bin/_mocha --report html -- test/svg-sprite.js --reporter spec` | 
...
| [localtunnel/server](https://github.com/localtunnel/server) | 1126 | `mocha --check-leaks --require esm './**/*.test.js'` | 
...
| [3rd-Eden/memcached](https://github.com/3rd-Eden/memcached) | 1120 | `mocha $(find test -name '*.test.js')` | 
...
| [immersive-web/webvr-polyfill](https://github.com/immersive-web/webvr-polyfill) | 1111 | `mocha -r test/init.js --compilers js:babel-core/register test/*.test.js` | 
...
| [ianstormtaylor/permit](https://github.com/ianstormtaylor/permit) | 1094 | `yarn build && yarn lint && mocha --require babel-core/register ./test/index.js` | 
...
| [router5/router5](https://github.com/router5/router5) | 1089 | `mocha --compilers js:babel-core/register --require test-helper.js --recursive 'packages/*/test/**/*.js'` | 
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 1054 | `webpack && mocha test/unit` | 
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 1053 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1051 | `mocha test/tests.js` | 
| [angular-redux/ng-redux](https://github.com/angular-redux/ng-redux) | 1048 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive` | 
...
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 1029 | `standard && mocha -b` | 
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 1026 | `mocha` | 
| [sghall/resonance](https://github.com/sghall/resonance) | 1022 | `cross-env NODE_ENV=test BABEL_ENV=test mocha "src/**/*.spec.js"` | 
| [electron/spectron](https://github.com/electron/spectron) | 1018 | `mocha && standard` | 
...
| [fbeline/Design-Patterns-JS](https://github.com/fbeline/Design-Patterns-JS) | 952 | `mocha test --compilers js:babel-core/register` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 940 | `mocha -R spec` | 
...
| [ctimmerm/axios-mock-adapter](https://github.com/ctimmerm/axios-mock-adapter) | 933 | `mocha` | 
...
| [azu/promises-book](https://github.com/azu/promises-book) | 924 | `mocha ./Ch**/test/*.js && npm run textlint` | 
...
| [microstates/microstates.js](https://github.com/microstates/microstates.js) | 884 | `mocha --recursive -r tests/setup tests` | 
| [symfony/webpack-encore](https://github.com/symfony/webpack-encore) | 882 | `./node_modules/.bin/mocha --reporter spec test --recursive` | 
...
| [ConsenSys/eth-lightwallet](https://github.com/ConsenSys/eth-lightwallet) | 855 | `./node_modules/.bin/mocha --reporter spec` | 
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 853 | `./node_modules/.bin/mocha -R spec` | 
...
| [pantsel/konga](https://github.com/pantsel/konga) | 834 | `mocha` | 
...
| [mozilla/node-convict](https://github.com/mozilla/node-convict) | 777 | `mocha --check-leaks -R spec test/*-tests.js` | 
...
| [serverless-heaven/serverless-webpack](https://github.com/serverless-heaven/serverless-webpack) | 770 | `nyc ./node_modules/mocha/bin/_mocha tests/all index.test.js "lib/**/*.test.js" -R spec --recursive` | 
...
| [apollographql/graphql-tag](https://github.com/apollographql/graphql-tag) | 763 | `mocha test/graphql.js test/graphql-v0.12.js && tav --ci --compat` | 
| [klei/gulp-inject](https://github.com/klei/gulp-inject) | 761 | `mocha -R spec src/**/*_test.js` | 
| [edwardhotchkiss/mongoose-paginate](https://github.com/edwardhotchkiss/mongoose-paginate) | 775 | `./node_modules/.bin/mocha tests/*.js -R spec --ui bdd --timeout 5000` | 
| [ruanyf/es-checker](https://github.com/ruanyf/es-checker) | 773 | `mocha` | 
| [kyledrake/coinpunk](https://github.com/kyledrake/coinpunk) | 771 | `NODE_ENV=test istanbul test ./node_modules/.bin/_mocha -- --reporter list test/coinpunk/*` | 
...
| [ianstormtaylor/react-values](https://github.com/ianstormtaylor/react-values) | 727 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./test/index.js` | 
| [syt123450/giojs](https://github.com/syt123450/giojs) | 727 | `mocha` | 
...
| [mongoosastic/mongoosastic](https://github.com/mongoosastic/mongoosastic) | 722 | `npm run lint && istanbul cover _mocha --report lcovonly -- test/*-test.js` | 
