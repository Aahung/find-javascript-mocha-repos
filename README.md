...
The list was updated at 02:06:47 03/17/18 PDT
...
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39959 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 37198 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28976 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23552 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22496 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21124 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20484 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18051 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17749 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15735 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15129 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13894 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13400 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12852 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12264 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12182 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12043 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11863 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11781 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11667 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11337 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10821 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10731 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10256 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9845 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9741 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9437 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9419 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9389 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9249 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9197 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8956 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8629 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8498 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8479 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8213 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8199 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8172 | `mocha test/test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8108 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7965 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [websockets/ws](https://github.com/websockets/ws) | 7962 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7910 | `./node_modules/.bin/mocha test/src` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7784 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7738 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7687 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7519 | `npm run eslint && npm run mocha` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7421 | `mocha tests/*.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7211 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7209 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7065 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7040 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6852 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6604 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6564 | `xo && mocha test/*.js --timeout 100000` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6537 | `nyc mocha test/**/* -r ./test/before` | 
| [aui/art-template](https://github.com/aui/art-template) | 6535 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6524 | `mocha --opts mocha.opts` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6484 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6424 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6413 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6381 | `mocha --compilers js:babel-core/register` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6008 | `npm run lint -s && npm run mocha -s` | 
...
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5937 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5925 | `mocha` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5914 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5871 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5783 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5614 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5550 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5539 | `mocha tests/node.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5452 | `mocha && eslint lib/**` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5431 | `mocha test/test.js` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5408 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5395 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5296 | `mocha --exit --require babel-core/register` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5173 | `mocha --timeout 10000 && npm run lint` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5167 | `mocha` | 
...
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5132 | `npm run build-cli && mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5060 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4833 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
...
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4689 | `mocha --compilers js:babel-register src/**/*-test.js` | 
...
| [expressjs/multer](https://github.com/expressjs/multer) | 4580 | `standard && mocha` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4551 | `mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4540 | `mocha; jshint *.js lib` | 
...
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4479 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4459 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4436 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4395 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4387 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4241 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4238 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4237 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4230 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 4107 | `mocha && ./bin/shipit staging test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4019 | `nyc mocha` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3970 | `mocha --recursive && make test` | 
...
| [luin/ioredis](https://github.com/luin/ioredis) | 3892 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3837 | `npm run lint && npm run mocha` | 
| [erming/shout](https://github.com/erming/shout) | 3808 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [tj/ejs](https://github.com/tj/ejs) | 3806 | `mocha --require should --reporter spec` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3797 | `istanbul test node_modules/mocha/bin/_mocha` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3615 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3581 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3564 | `standard && mocha --timeout 60000 test/test.js` | 
...
| [primus/primus](https://github.com/primus/primus) | 3494 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3463 | `mocha --reporter spec --timeout 3000` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3437 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3416 | `node_modules/.bin/mocha` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3413 | `npm run lint && npm run mocha` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3355 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3322 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3239 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3193 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3192 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3157 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3136 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3018 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2990 | `mocha` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2990 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2969 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2907 | `mocha test/*.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2855 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2836 | `nyc mocha && tsc` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2804 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2787 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2774 | `mocha` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2773 | `mocha -R spec --recursive src/test` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2769 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2763 | `mocha test/index.js && npm run demo` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2759 | `mocha --require should --reporter spec` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2758 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2755 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2715 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2710 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2706 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [github-tools/github](https://github.com/github-tools/github) | 2698 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2692 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2682 | `mocha` | 
...
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2665 | `mocha` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2662 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2646 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2644 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2636 | `xo && mocha` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2632 | `mocha --opts mocha.opts` | 
...
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2586 | `npm run mocha && npm run lint` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2585 | `mocha-phantomjs ./test/index.html` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2563 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2552 | `mocha` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2514 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2490 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2465 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2432 | `mocha --reporter=spec test/*-test.js` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2428 | `NODE_ENV=test mocha` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2396 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2390 | `node_modules/.bin/mocha --reporter spec` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2378 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2341 | `nyc mocha` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2339 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [postaljs/postal.js](https://github.com/postaljs/postal.js) | 2328 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2321 | `mocha test/src/**/*.unit.js` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2311 | `mocha test` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2310 | `npm run lint && mocha` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2265 | `export TESTING=true; mocha --reporter list` | 
| [mde/ejs](https://github.com/mde/ejs) | 2239 | `mocha --require should --reporter spec` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2216 | `mocha` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2204 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2180 | `mocha -R spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2178 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2102 | `mocha test.js` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2049 | `mocha -R landing test/index` | 
| [carlsednaoui/ouibounce](https://github.com/carlsednaoui/ouibounce) | 2048 | `mocha` | 
| [noble/noble](https://github.com/noble/noble) | 2028 | `mocha -R spec test/*.js` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2024 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
...
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1949 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 1905 | `mocha` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1887 | `mocha --compilers js:babel-register` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1841 | `mocha test/runner.js --reporter spec` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1795 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [kach/nearley](https://github.com/kach/nearley) | 1757 | `mocha test/*.test.js` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1739 | `npm run lint && mocha -R dot && npm run cover` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1735 | `mocha && eslint *.js` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1696 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1628 | `mocha` | 
...
| [JustinTulloss/zeromq.node](https://github.com/JustinTulloss/zeromq.node) | 1610 | `mocha --expose-gc --slow 300` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1594 | `npm run lint && npm run mocha` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1593 | `mocha tests --compilers js:babel-core/register` | 
...
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1556 | `mocha ./test/basic.js -t 5000` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1529 | `standard "src/*.js" && npm run build && mocha` | 
...
| [andreaferretti/paths-js](https://github.com/andreaferretti/paths-js) | 1499 | `mocha --reporter nyan --compilers js:babel/register --recursive test` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1473 | `mocha --compilers js:babel-register` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1424 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1423 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1409 | `mocha --check-leaks -R dot` | 
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1408 | `nyc mocha` | 
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1404 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1402 | `eslint . && mocha -t 5000` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1355 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1337 | `mocha compiled_tests/` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1323 | `mocha` | 
| [adleroliveira/dreamjs](https://github.com/adleroliveira/dreamjs) | 1323 | `mocha` | 
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1317 | `mocha test/setup.js test/spec/*.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1309 | `nyc npm run mocha` | 
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1301 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1298 | `mocha --timeout 10000 ./tests/lib.js` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1226 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
| [donejs/donejs](https://github.com/donejs/donejs) | 1226 | `npm run jshint && npm run mocha && npm run document && npm run test-guides` | 
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1222 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
| [shakiba/stage.js](https://github.com/shakiba/stage.js) | 1221 | `mocha test/*.js` | 
| [teambit/bit](https://github.com/teambit/bit) | 1219 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1200 | `mocha` | 
...
| [domenic/chai-as-promised](https://github.com/domenic/chai-as-promised) | 1193 | `mocha` | 
...
| [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) | 1152 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1144 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1136 | `standard && istanbul cover _mocha` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1123 | `mocha test` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1111 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [terinjokes/gulp-uglify](https://github.com/terinjokes/gulp-uglify) | 1086 | `nyc --reporter=lcov --reporter=text mocha --require intelli-espower-loader` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1073 | `nyc mocha --timeout=20000 test.js` | 
...
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 1062 | `mocha` | 
| [babel/gulp-babel](https://github.com/babel/gulp-babel) | 1062 | `xo && mocha` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1011 | ` NODE_ENV=test mocha --require babel-core/register` | 
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1011 | `mocha test/tests.js` | 
| [FormidableLabs/redux-little-router](https://github.com/FormidableLabs/redux-little-router) | 1007 | `BABEL_ENV=commonjs mocha test/.setup.js 'test/**/*.spec.js'` | 
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 998 | `mocha` | 
...
| [oakmac/chessboardjs](https://github.com/oakmac/chessboardjs) | 992 | `mocha` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 974 | `mocha --recursive test` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 964 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 952 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 947 | `mocha -R spec ./test/unit/**` | 
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 947 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
...
| [electron/asar](https://github.com/electron/asar) | 945 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 941 | `mocha tests/*.js` | 
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 939 | `standard && mocha -b` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 934 | `mocha ./test/test*.js --reporter spec` | 
...
| [electron/spectron](https://github.com/electron/spectron) | 917 | `mocha && standard` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 909 | `mocha` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 903 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [WP-API/node-wpapi](https://github.com/WP-API/node-wpapi) | 901 | `istanbul cover _mocha -- tests --recursive --reporter=nyan` | 
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 899 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [electron-userland/electron-compile](https://github.com/electron-userland/electron-compile) | 877 | `mocha --compilers js:babel-register test/*.js` | 
| [jeremyckahn/shifty](https://github.com/jeremyckahn/shifty) | 874 | `mocha ./node_modules/babel-core/register.js test/index.js` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 872 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 864 | `npm run lint && mocha --require @babel/register` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 853 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [bestiejs/punycode.js](https://github.com/bestiejs/punycode.js) | 843 | `mocha tests` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 831 | `mocha -R spec` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 818 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 808 | `mocha` | 
...
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 805 | `mocha -t 600000` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 801 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [yahoo/blink-diff](https://github.com/yahoo/blink-diff) | 784 | `istanbul cover -- _mocha --reporter spec` | 
| [mapmeld/gitjk](https://github.com/mapmeld/gitjk) | 783 | `mocha` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 780 | `npm run mocha:istanbul` | 
...
| [webpack-contrib/html-loader](https://github.com/webpack-contrib/html-loader) | 698 | `mocha --harmony --full-trace --check-leaks` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 696 | `mocha --timeout 20000` | 
