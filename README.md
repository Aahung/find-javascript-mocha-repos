...
The list was updated at 02:06:26 12/06/17 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39208 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 37645 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35423 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 34578 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28119 | `mocha --reporter spec` | 
| [caolan/async](https://github.com/caolan/async) | 22837 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19497 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 16912 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16497 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15092 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14130 | `mocha test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13561 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12231 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12153 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11880 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11629 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11478 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11457 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11204 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10272 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10233 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10216 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9652 | `NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9434 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9120 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9066 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 8933 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 8852 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [tmpvar/jsdom](https://github.com/tmpvar/jsdom) | 8819 | `mocha test/index.js` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8777 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8665 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [svg/svgo](https://github.com/svg/svgo) | 8562 | `set NODE_ENV=test && mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8332 | `grunt mocha` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8085 | `mocha --check-leaks -R dot` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8070 | `mocha test/*-test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8005 | `grunt clean:test && mocha` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 7963 | `mocha test/test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 7737 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7611 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7513 | `./node_modules/.bin/mocha test/src` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7452 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7305 | `mocha --compilers js:babel-register test/test.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7157 | `npm run eslint && npm run mocha` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7113 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7030 | `npm run build && istanbul cover _mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 6897 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6893 | `./node_modules/.bin/mocha test` | 
| [amark/gun](https://github.com/amark/gun) | 6851 | `mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6772 | `mocha tests/*.js` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 6767 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6417 | `mocha $HARMONY_OPTS` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6306 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6262 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6206 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6111 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6095 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6011 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 5967 | `mocha --compilers js:babel-core/register` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5930 | `mocha` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 5899 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5744 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5618 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
...
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5613 | `nyc mocha test/** -r ./test/before` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5551 | `mocha --opts mocha.opts` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5491 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5402 | `npm run jshint && mocha test/` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5401 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
...
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5314 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5246 | `mocha && eslint lib/**` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5232 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5162 | `mocha --color` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5140 | `mocha test --recursive` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5116 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5108 | `mocha src/**/*Tests.js --harmony` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5027 | `mocha test/test.js` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 4905 | `mocha --timeout 10000 && npm run lint` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4781 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4714 | `gulp lint && mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4714 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4655 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
...
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4544 | `mocha --compilers js:babel-core/register` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4527 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
...
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4257 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4239 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4223 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4175 | `./node_modules/.bin/mocha` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4168 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4118 | `standard && mocha` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4080 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4066 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 3988 | `mocha` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 3959 | `mocha && ./bin/shipit staging test` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 3922 | `mocha test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 3919 | `nyc mocha` | 
...
| [botpress/botpress](https://github.com/botpress/botpress) | 3820 | `BABEL_ENV=tests mocha --compilers js:babel-core/register --require tests/index.js tests/** extensions/**/tests/**` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 3780 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3778 | `mocha` | 
| [muicss/mui](https://github.com/muicss/mui) | 3718 | `mocha` | 
| [tj/ejs](https://github.com/tj/ejs) | 3681 | `mocha --require should --reporter spec` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3629 | `npm run jshint && npm run mocha` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3610 | `mocha && make test` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3557 | `NODE_ENV=test mocha` | 
...
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3521 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [blakeembrey/code-problems](https://github.com/blakeembrey/code-problems) | 3493 | `mocha tests/javascript` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3485 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3465 | `npm run lint && npm run mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3464 | `mocha --require test/babel-hook test/*.js` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3406 | `npm run lint ; mocha && mocha test/individual` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3340 | `nyc mocha` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3242 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3077 | `mocha` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3074 | `npm run build-cli && mocha` | 
...
| [easy-mock/easy-mock](https://github.com/easy-mock/easy-mock) | 3039 | `cross-env NODE_ENV=test istanbul cover _mocha test/*` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 2999 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 2988 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 2987 | `mocha --check-leaks --reporter spec --bail` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 2965 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 2897 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
...
| [lambci/lambci](https://github.com/lambci/lambci) | 2858 | `mocha` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 2795 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2770 | `npm run lint && npm run mocha` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2764 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2730 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
...
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2695 | `mocha -R spec --recursive src/test` | 
...
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2665 | `istanbul cover _mocha` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2608 | `mocha test/index.js && npm run demo` | 
...
| [github-tools/github](https://github.com/github-tools/github) | 2548 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2539 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2526 | `nyc mocha && tsc` | 
...
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 2517 | `mocha; jshint *.js lib` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2486 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [css/csso](https://github.com/css/csso) | 2485 | `mocha --reporter dot` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 2484 | `NODE_ENV=test mocha` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2478 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2472 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2467 | `mocha` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2461 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2460 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2454 | `mocha --recursive --watch` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2453 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [reactGo/reactGo](https://github.com/reactGo/reactGo) | 2449 | `mocha ./app/tests/setup.js --compilers css:./app/tests/compilers/css ./app/**/*-test.js` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2442 | `npm run mocha && npm run lint` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2430 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2405 | `mocha --compilers js:babel-register --recursive spec` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2403 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2392 | `mocha --reporter=spec test/*-test.js` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2392 | `mocha` | 
...
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2368 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2362 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2361 | `node node_modules/mocha/bin/_mocha` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2320 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2304 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2290 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2289 | `mocha --opts mocha.opts` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2276 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2270 | `mocha` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2254 | `mocha` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2250 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
...
| [wix/react-templates](https://github.com/wix/react-templates) | 2220 | `mocha test/src/**/*.unit.js` | 
...
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2206 | `npm run compile && mocha --compilers js:babel-core/register` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2195 | `mocha -t 30000 -R spec tests/unit/index.js` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2176 | `gulp && cd test && mocha . --reporter dot` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2164 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [octokit/node-github](https://github.com/octokit/node-github) | 2144 | `nyc mocha test/**/*-test.js` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2123 | `node_modules/.bin/mocha --reporter spec` | 
| [esbenp/pdf-bot](https://github.com/esbenp/pdf-bot) | 2114 | `nyc --reporter=lcov --reporter=text mocha test/*.test.js --recursive --coverage` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2100 | `NODE_ENV=test mocha` | 
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2095 | `npm run lint && npm run build && npm run mocha` | 
| [mozilla/send](https://github.com/mozilla/send) | 2094 | `mocha test/unit` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2088 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [gajus/swing](https://github.com/gajus/swing) | 2084 | `mocha --compilers js:babel-register` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2074 | `mocha -R spec` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2072 | `mocha` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2065 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2056 | `mocha test/unit --require mochahook` | 
| [json5/json5](https://github.com/json5/json5) | 2040 | `mocha --ui exports --reporter spec` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2006 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2001 | `cross-env BABEL_ENV=test mocha` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 1993 | `mocha` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 1935 | `mocha --require should --reporter spec` | 
...
| [sandeepmistry/noble](https://github.com/sandeepmistry/noble) | 1881 | `mocha -R spec test/*.js` | 
...
| [weui/react-weui](https://github.com/weui/react-weui) | 1840 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1836 | `mocha test/index.js --reporter dot` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1834 | `mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 1830 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 1819 | `mocha ./test/*.spec.js` | 
...
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1798 | `mocha --require ./test/common --growl test/expect.js` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1784 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1768 | `mocha test && npm run lint` | 
| [Qix-/color](https://github.com/Qix-/color) | 1762 | `mocha` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1761 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1716 | `mocha test.js` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 1713 | `export TESTING=true; mocha --reporter list` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1711 | `mocha` | 
| [then/promise](https://github.com/then/promise) | 1704 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1703 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1693 | `mocha test/runner.js --reporter spec` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1668 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1660 | `mocha --compilers js:babel-register` | 
...
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1655 | `mocha --compilers js:babel-core/register __tests__` | 
| [Kong/mashape-oauth](https://github.com/Kong/mashape-oauth) | 1649 | `mocha` | 
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1649 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [Hardmath123/nearley](https://github.com/Hardmath123/nearley) | 1636 | `mocha test/*.test.js` | 
| [guo-yu/douban.fm](https://github.com/guo-yu/douban.fm) | 1631 | `node_modules/mocha/bin/mocha tests/*.js --require tests/babelhook` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 1612 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [KunalKapadia/express-mongoose-es6-rest-api](https://github.com/KunalKapadia/express-mongoose-es6-rest-api) | 1601 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1597 | `mocha && eslint *.js` | 
...
| [JustinTulloss/zeromq.node](https://github.com/JustinTulloss/zeromq.node) | 1593 | `mocha --expose-gc --slow 300` | 
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1592 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1587 | `mocha -c test/index.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 1581 | `node ./node_modules/mocha/bin/mocha --reporter spec --full-trace` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1575 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [gitsummore/nile.js](https://github.com/gitsummore/nile.js) | 1565 | `./node_modules/mocha/bin/mocha ./test.js` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1523 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1499 | `mocha && npm run lint` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1496 | `npm run mocha && npm run karma` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1495 | `mocha --reporter spec --grep .` | 
...
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1475 | `npm run mocha && npm run lint` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1467 | `mocha` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1464 | `nyc npm run _mocha` | 
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1464 | `mocha` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1443 | `mocha test/` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1442 | `mocha test/* --reporter spec` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1439 | `mocha test -u bdd -R spec` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1396 | `mocha` | 
| [Caligatio/jsSHA](https://github.com/Caligatio/jsSHA) | 1390 | `mocha --reporter spec` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1316 | `mocha --reporter spec test/*.js` | 
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1314 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1306 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
| [kss-node/kss-node](https://github.com/kss-node/kss-node) | 1287 | `istanbul cover _mocha` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1284 | `mocha --recursive` | 
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1283 | `mocha --compilers js:babel-register` | 
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1279 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [trufflesuite/ganache-cli](https://github.com/trufflesuite/ganache-cli) | 1271 | `mocha` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1264 | `mocha test.js` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1229 | `standard "src/*.js" && npm run build && mocha` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1229 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [expressjs/compression](https://github.com/expressjs/compression) | 1198 | `mocha --check-leaks --reporter spec --bail` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1194 | `mocha tests.js` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1177 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [ToothlessGear/node-gcm](https://github.com/ToothlessGear/node-gcm) | 1175 | `mocha test/**/*Spec.js` | 
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1175 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1162 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1146 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1142 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
...
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1136 | `mocha --recursive` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1133 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1131 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1111 | `mocha compiled_tests/` | 
...
| [lodash/babel-plugin-lodash](https://github.com/lodash/babel-plugin-lodash) | 1072 | `mocha --check-leaks --require @babel/register` | 
...
| [gaearon/babel-plugin-react-transform](https://github.com/gaearon/babel-plugin-react-transform) | 1053 | `mocha --compilers js:babel-register` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1035 | `mocha` | 
| [3rd-Eden/memcached](https://github.com/3rd-Eden/memcached) | 1032 | `mocha $(find test -name '*.test.js')` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1030 | `mocha src/test.js` | 
| [sorrycc/roadhog](https://github.com/sorrycc/roadhog) | 1029 | `npm run lint && npm run build && cross-env NODE_ENV=test nyc mocha --no-timeouts test/**/*-test.js` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1025 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [jkphl/svg-sprite](https://github.com/jkphl/svg-sprite) | 1006 | `istanbul test _mocha --report html -- test/*.js --reporter spec` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1001 | `mocha --reporter dot` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 999 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
| [frctl/fractal](https://github.com/frctl/fractal) | 993 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 990 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 987 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
| [vuejs/vueify](https://github.com/vuejs/vueify) | 986 | `eslint index.js lib && mocha test/test.js --slow=5000 --timeout=10000` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 980 | `npm run lint && mocha -R dot && npm run cover` | 
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 980 | `mocha test/tests.js` | 
...
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 977 | `mocha` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 976 | `eslint src && mocha && karma start --single-run` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 975 | `mocha test --timeout 600000` | 
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 973 | `mocha` | 
| [zcreativelabs/react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) | 973 | `mocha './tests/**/*.spec.js' --compilers js:babel-core/register` | 
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 968 | `mocha test/unit` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 967 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [hokaccha/node-jwt-simple](https://github.com/hokaccha/node-jwt-simple) | 958 | `istanbul cover _mocha test/*.js` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 935 | `NODE_PATH=. mocha **/*.spec.js` | 
| [motdotla/node-lambda](https://github.com/motdotla/node-lambda) | 935 | `standard && standard bin/node-lambda && mocha` | 
| [SelectTransform/st.js](https://github.com/SelectTransform/st.js) | 934 | `mocha --recursive test/unit/` | 
| [FormidableLabs/redux-little-router](https://github.com/FormidableLabs/redux-little-router) | 934 | `mocha test/.setup.js 'test/**/*.spec.js'` | 
...
| [bigpipe/bigpipe](https://github.com/bigpipe/bigpipe) | 926 | `mocha $(find test -name '*.test.js')` | 
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 922 | `mocha` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 919 | `eslint . && mocha -t 5000` | 
...
| [gulpjs/vinyl](https://github.com/gulpjs/vinyl) | 914 | `mocha --async-only` | 
| [OverZealous/run-sequence](https://github.com/OverZealous/run-sequence) | 914 | `mocha --reporter spec` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 914 | `npm run lint && mocha test/unit test/integration` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 906 | `mocha tests/test-*` | 
...
| [dabeng/OrgChart](https://github.com/dabeng/OrgChart) | 895 | `mocha ./test/**/*-tests.js` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 889 | ` NODE_ENV=test mocha --compilers js:babel-register` | 
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 881 | `standard && mocha -b` | 
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 880 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 880 | `mocha` | 
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 880 | `mocha test/test.js` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 870 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 867 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 861 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 860 | `mocha test` | 
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 860 | `webpack && mocha test/unit` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 851 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
| [electron/asar](https://github.com/electron/asar) | 846 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 838 | `mocha --recursive test` | 
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 836 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
...
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 832 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 816 | `mocha` | 
| [mjackson/mach](https://github.com/mjackson/mach) | 816 | `jshint . && mocha --require babel/register --reporter spec 'modules/**/__tests__/*-test.js'` | 
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 814 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [lightning-viz/lightning](https://github.com/lightning-viz/lightning) | 814 | `mocha --timeout 200000` | 
| [electron/spectron](https://github.com/electron/spectron) | 811 | `mocha && standard` | 
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 808 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [claudioc/jingo](https://github.com/claudioc/jingo) | 800 | `node_modules/.bin/mocha test/spec` | 
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 796 | `mocha --reporter spec --bail --check-leaks test/` | 
| [erelsgl/limdu](https://github.com/erelsgl/limdu) | 793 | `mocha` | 
| [bestiejs/punycode.js](https://github.com/bestiejs/punycode.js) | 793 | `mocha tests` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 793 | `nyc mocha --timeout=20000 test.js` | 
...
| [kriasoft/universal-router](https://github.com/kriasoft/universal-router) | 771 | `nyc mocha --require babel-register` | 
...
| [dareid/chakram](https://github.com/dareid/chakram) | 770 | `istanbul cover _mocha` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 762 | `mocha ./test -R spec` | 
...
| [tj/node-migrate](https://github.com/tj/node-migrate) | 759 | `standard && standard ./bin/* && mocha` | 
...
| [felixge/node-dateformat](https://github.com/felixge/node-dateformat) | 748 | `mocha` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 742 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 733 | `mocha ./test/test*.js --reporter spec` | 
| [gulpjs/vinyl-fs](https://github.com/gulpjs/vinyl-fs) | 730 | `mocha --async-only` | 
...
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 726 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 722 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 718 | `mocha -t 600000` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 705 | `npm run lint && mocha --compilers js:babel-register` | 
| [jish/pre-commit](https://github.com/jish/pre-commit) | 705 | `mocha test.js` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 704 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 685 | `mocha -R spec --compilers js:babel-core/register ./tests/setup.js ./tests/** --recursive` | 
...
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 675 | `cross-env NODE_ENV=test nyc mocha` | 
| [taskrabbit/ReactNativeSampleApp](https://github.com/taskrabbit/ReactNativeSampleApp) | 673 | `npm run mocha-test test/integration` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 673 | `npm run lint && nyc mocha test/**` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 645 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require babel-register --no-timeouts` | 