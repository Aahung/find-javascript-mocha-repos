...
The list was updated at 02:06:48 03/18/18 PDT
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39996 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39970 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 37205 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28980 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23557 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22508 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21131 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20505 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18060 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17754 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15744 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15136 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13895 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13412 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12859 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12271 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12182 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12044 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11866 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11783 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11676 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11342 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10827 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10736 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10262 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9850 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9744 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9439 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9424 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9390 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9253 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9202 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8960 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8632 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8505 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8480 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8221 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8199 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8174 | `mocha test/test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8110 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7968 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [websockets/ws](https://github.com/websockets/ws) | 7968 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7913 | `./node_modules/.bin/mocha test/src` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7790 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7749 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7693 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7529 | `npm run eslint && npm run mocha` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7425 | `mocha tests/*.js` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7213 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7210 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7070 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7043 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6858 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6603 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6567 | `xo && mocha test/*.js --timeout 100000` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6542 | `nyc mocha test/**/* -r ./test/before` | 
| [aui/art-template](https://github.com/aui/art-template) | 6541 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6528 | `mocha --opts mocha.opts` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6485 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6428 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6415 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6384 | `mocha --compilers js:babel-core/register` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6009 | `npm run lint -s && npm run mocha -s` | 
...
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5944 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5925 | `mocha` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5918 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5873 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5784 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5616 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5552 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5541 | `mocha tests/node.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5453 | `mocha && eslint lib/**` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5437 | `mocha test/test.js` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5409 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5395 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5297 | `mocha --exit --require babel-core/register` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5173 | `mocha --timeout 10000 && npm run lint` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5169 | `mocha` | 
...
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5140 | `npm run build-cli && mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5063 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4836 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4793 | `gulp lint && mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4760 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4755 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4692 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [santinic/how2](https://github.com/santinic/how2) | 4646 | `mocha test` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4635 | `mocha -R spec 'tests/app'` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4627 | `mocha --reporter spec -t 8000` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4585 | `standard && mocha` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4553 | `mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4547 | `mocha; jshint *.js lib` | 
...
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4483 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4465 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4390 | `mocha` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4374 | `./node_modules/.bin/mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4246 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4239 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4239 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4232 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3974 | `mocha --recursive && make test` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3918 | `mocha --require test/babel-hook test/*.js` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3894 | `NODE_ENV=test mocha` | 
...
| [muicss/mui](https://github.com/muicss/mui) | 3878 | `mocha` | 
| [CodeboxIDE/codebox](https://github.com/CodeboxIDE/codebox) | 3855 | `export TESTING=true; mocha --reporter list` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3839 | `npm run lint && npm run mocha` | 
...
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3706 | `mocha -R spec ./test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3702 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3669 | `npm run lint ; mocha && mocha test/individual` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3622 | `mocha ./test/*.spec.js` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3620 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3582 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3532 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [primus/primus](https://github.com/primus/primus) | 3497 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3464 | `mocha --reporter spec --timeout 3000` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3419 | `npm run lint && npm run mocha` | 
...
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3372 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3357 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3327 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3241 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3195 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3193 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3158 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3137 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3103 | `mocha` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3077 | `./node_modules/.bin/mocha test/test.*.js` | 
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3073 | `mocha` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 3071 | `node_modules/.bin/mocha test/tests.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3036 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3020 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2991 | `mocha` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2991 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2972 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2889 | `NODE_ENV=test mocha test/**/*.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2864 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2859 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2839 | `nyc mocha && tsc` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2805 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2790 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2776 | `mocha` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2774 | `mocha -R spec --recursive src/test` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2772 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2764 | `mocha test/index.js && npm run demo` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2762 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2759 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2759 | `mocha --require should --reporter spec` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2746 | `node node_modules/mocha/bin/mocha test test/*.js` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2718 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2712 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2707 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [github-tools/github](https://github.com/github-tools/github) | 2699 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2695 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2685 | `mocha` | 
...
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2667 | `mocha` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2663 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2647 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2645 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2638 | `mocha --opts mocha.opts` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2638 | `xo && mocha` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2622 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2587 | `npm run mocha && npm run lint` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2586 | `mocha-phantomjs ./test/index.html` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2566 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2553 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2532 | `mocha --compilers js:babel-register --recursive spec` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2529 | `mocha --recursive --watch` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2526 | `mocha` | 
| [Reportr/dashboard](https://github.com/Reportr/dashboard) | 2520 | `export TESTING=true; mocha --reporter list` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2519 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2491 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2429 | `NODE_ENV=test mocha` | 
| [h2non/toxy](https://github.com/h2non/toxy) | 2407 | `standard index.js 'lib/**/*.js' 'test/**/*.js' && mocha --timeout 5000 --bail --reporter spec --ui tdd 'test/**/*.js'` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2398 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2393 | `node_modules/.bin/mocha --reporter spec` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2365 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2354 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [agershun/alasql](https://github.com/agershun/alasql) | 2342 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [postaljs/postal.js](https://github.com/postaljs/postal.js) | 2330 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2322 | `mocha test/src/**/*.unit.js` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2318 | `npm run lint && mocha` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2268 | `export TESTING=true; mocha --reporter list` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2242 | `mocha --require should --reporter spec` | 
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2235 | `mocha "test/**/*-test.js"` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2229 | `mocha test/unit --require mochahook` | 
| [davidmerfield/Typeset](https://github.com/davidmerfield/Typeset) | 2222 | `mocha -u bdd -R spec -t 500 --recursive` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2217 | `mocha` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2181 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [gajus/swing](https://github.com/gajus/swing) | 2142 | `mocha --compilers js:babel-register` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2111 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2106 | `mocha test.js` | 
...
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2068 | `cross-env BABEL_ENV=test mocha` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2050 | `mocha -R landing test/index` | 
| [carlsednaoui/ouibounce](https://github.com/carlsednaoui/ouibounce) | 2049 | `mocha` | 
| [noble/noble](https://github.com/noble/noble) | 2029 | `mocha -R spec test/*.js` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2025 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2024 | `mocha && eslint .` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1986 | `mocha test && npm run lint` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1950 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1918 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1914 | `mocha -c test/index.js` | 
| [Qix-/color](https://github.com/Qix-/color) | 1907 | `mocha` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1891 | `mocha --compilers js:babel-register` | 
...
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1827 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1822 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1799 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1786 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1774 | `./node_modules/.bin/mocha tests/*.js --exit` | 
| [kach/nearley](https://github.com/kach/nearley) | 1758 | `mocha test/*.test.js` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1743 | `./node_modules/.bin/mocha && npm run jshint` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1741 | `npm run lint && mocha -R dot && npm run cover` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1736 | `mocha && eslint *.js` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1713 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1713 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1700 | `mocha --reporter spec && npm run test-typescript` | 
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1699 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1693 | `npm run lint && mocha server/test --recursive --exit` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1689 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1689 | `nyc npm run _mocha` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1630 | `mocha && npm run lint` | 
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1629 | `mocha` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1615 | `mocha` | 
| [jakiestfu/himawari.js](https://github.com/jakiestfu/himawari.js) | 1613 | `mocha tests/test.js` | 
| [JustinTulloss/zeromq.node](https://github.com/JustinTulloss/zeromq.node) | 1611 | `mocha --expose-gc --slow 300` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1596 | `mocha tests --compilers js:babel-core/register` | 
| [pahen/madge](https://github.com/pahen/madge) | 1595 | `npm run lint && npm run mocha` | 
...
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1584 | `npm run lint && mocha test/unit && mocha test/runner` | 
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1580 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1575 | `mocha` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1571 | `mocha test -u bdd -R spec` | 
| [flitbit/diff](https://github.com/flitbit/diff) | 1570 | `mocha test/**/*.js` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1557 | `mocha ./test/basic.js -t 5000` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1553 | `mocha --reporter spec test/*.js` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1549 | `./node_modules/.bin/mocha` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1547 | `mocha test --timeout 600000` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1531 | `standard "src/*.js" && npm run build && mocha` | 
...
| [andreaferretti/paths-js](https://github.com/andreaferretti/paths-js) | 1500 | `mocha --reporter nyan --compilers js:babel/register --recursive test` | 
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1497 | `./node_modules/mocha/bin/mocha -R spec` | 
| [jamiebuilds/babel-react-optimize](https://github.com/jamiebuilds/babel-react-optimize) | 1486 | `eslint packages/*/test packages/*/src && mocha packages/*/test/index.js --compilers js:babel-register` | 
| [intercellular/cell](https://github.com/intercellular/cell) | 1479 | `npm run test:lint && npm run test:mocha` | 
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1475 | `mocha -u tdd` | 
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1474 | `mocha --compilers js:babel-register` | 
| [johntitus/node-horseman](https://github.com/johntitus/node-horseman) | 1469 | `mocha -R spec` | 
| [Caligatio/jsSHA](https://github.com/Caligatio/jsSHA) | 1463 | `mocha --reporter spec` | 
...
| [RobertWHurst/KeyboardJS](https://github.com/RobertWHurst/KeyboardJS) | 1435 | `mocha test/**/*.spec.js` | 
| [superscriptjs/superscript](https://github.com/superscriptjs/superscript) | 1427 | `mocha --compilers js:babel-register test -R spec -s 1700 -t 300000 --recursive` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1426 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1426 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1408 | `nyc mocha` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1405 | `eslint . && mocha -t 5000` | 
...
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1387 | `standard "./src/*.js" && mocha` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1357 | `mocha tests.js` | 
...
| [expressjs/compression](https://github.com/expressjs/compression) | 1355 | `mocha --check-leaks --reporter spec --bail` | 
| [ebidel/appmetrics.js](https://github.com/ebidel/appmetrics.js) | 1354 | `./node_modules/mocha/bin/mocha` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1346 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1341 | `mocha compiled_tests/` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1324 | `mocha` | 
...
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1310 | `nyc npm run mocha` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1299 | `mocha --timeout 10000 ./tests/lib.js` | 
| [letsgetrandy/DICSS](https://github.com/letsgetrandy/DICSS) | 1295 | `mocha-phantomjs tests/index.html` | 
| [noble/bleno](https://github.com/noble/bleno) | 1291 | `mocha -R spec test/*.js` | 
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1289 | `npm run build && mocha -r should` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1228 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1222 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1202 | `mocha` | 
...
| [marcelduran/webpagetest-api](https://github.com/marcelduran/webpagetest-api) | 1190 | `./node_modules/mocha/bin/mocha -R spec test/*-test.js` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1179 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1157 | `mocha` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1138 | `standard && istanbul cover _mocha` | 
...
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1136 | `mocha test/unit` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1136 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1124 | `mocha test` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1119 | `mocha src/test.js` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1119 | `node_modules/.bin/mocha` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1116 | `eslint src && mocha && karma start --single-run` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1112 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1091 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [yanyiwu/nodejieba](https://github.com/yanyiwu/nodejieba) | 1089 | `node test/demo.js && node test/load_dict_demo.js && mocha --timeout 10s -R spec test/test.js && mocha --timeout 10s -R spec test/load_dict_test.js` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1074 | `nyc mocha --timeout=20000 test.js` | 
...
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 1063 | `mocha` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1055 | `mocha tests/test-*` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1023 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1012 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 997 | `npm run prepublishOnly && mocha test/test.js` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 975 | `mocha --recursive test` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 966 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 966 | `mocha` | 
| [router5/router5](https://github.com/router5/router5) | 959 | `mocha --compilers js:babel-core/register --require test-helper.js --recursive 'packages/*/test/**/*.js'` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 954 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [yeoman/generator-mobile](https://github.com/yeoman/generator-mobile) | 954 | `mocha --timeout 5000` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 953 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 950 | `mocha -t 120000 test/*.test.js` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 943 | `mocha tests/*.js` | 
...
| [Ziv-Barber/officegen](https://github.com/Ziv-Barber/officegen) | 935 | `mocha test/test-docx.js test/test-xlsx.js test/test-pptx-nocharts.js test/test-pptx-charts.js` | 
| [expressjs/generator](https://github.com/expressjs/generator) | 930 | `nyc mocha` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 924 | `mocha` | 
| [pid/speakingurl](https://github.com/pid/speakingurl) | 919 | `mocha` | 
| [electron/spectron](https://github.com/electron/spectron) | 919 | `mocha && standard` | 
| [developit/snarkdown](https://github.com/developit/snarkdown) | 917 | `eslint src test && mocha --compilers babel-register` | 
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 916 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 907 | `standard src/index.js && mocha --compilers js:babel-register` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 906 | `npm run lint && npm run mocha` | 
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 905 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [WP-API/node-wpapi](https://github.com/WP-API/node-wpapi) | 901 | `istanbul cover _mocha -- tests --recursive --reporter=nyan` | 
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 901 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 895 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 883 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 873 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 866 | `npm run lint && mocha --require @babel/register` | 
| [azu/promises-book](https://github.com/azu/promises-book) | 865 | `mocha ./Ch**/test/*.js && npm run textlint` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 859 | `mocha ./test -R spec` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 855 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
| [MohammadYounes/rtlcss](https://github.com/MohammadYounes/rtlcss) | 852 | `npm run lint && mocha -R spec` | 
...
| [claudioc/jingo](https://github.com/claudioc/jingo) | 833 | `node_modules/.bin/mocha test/spec` | 
...
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 819 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 811 | `mocha` | 
| [basicallydan/interfake](https://github.com/basicallydan/interfake) | 810 | `mocha tests/*.test.js --reporter spec` | 
| [tj/node-migrate](https://github.com/tj/node-migrate) | 809 | `standard && standard ./bin/* && mocha` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 804 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 802 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 782 | `npm run mocha:istanbul` | 
| [EragonJ/Kaku](https://github.com/EragonJ/Kaku) | 779 | `./node_modules/mocha/bin/mocha -u tdd -t 5000 --reporter dot --compilers js:babel-core/register --require ./tests/unit/setup.js 'tests/unit/*.test.js'` | 
...
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 764 | `babel-node node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
...
| [bitpay/insight](https://github.com/bitpay/insight) | 744 | `mocha test` | 
...
| [fossasia/open-event-webapp](https://github.com/fossasia/open-event-webapp) | 724 | `mocha` | 
...
| [taskrabbit/ReactNativeSampleApp](https://github.com/taskrabbit/ReactNativeSampleApp) | 720 | `npm run mocha-test test/integration` | 
...
| [developit/decko](https://github.com/developit/decko) | 711 | `npm run test:ts && eslint {src,tests}/**.js && mocha --compilers js:babel/register tests/**/*.js` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 705 | `mocha --timeout 20000` | 
...
| [ruanyf/es-checker](https://github.com/ruanyf/es-checker) | 698 | `mocha` | 
