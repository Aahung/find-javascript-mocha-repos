...
The list was updated at 02:06:56 04/14/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40673 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40209 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 39840 | `npm run mocha` | 
| [expressjs/express](https://github.com/expressjs/express) | 37659 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29198 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23757 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22834 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21584 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 21364 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18390 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17994 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15949 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15406 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13979 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13785 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13096 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12465 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12270 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12085 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 12017 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11878 | `mocha --reporter spec test/*-test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11678 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 11201 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10853 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10542 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 10122 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 10002 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9626 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9536 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9526 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9412 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9393 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9029 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8760 | `mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8709 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8579 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8483 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8258 | `mocha test/test.js` | 
| [websockets/ws](https://github.com/websockets/ws) | 8245 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8235 | `mocha --check-leaks -R dot` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8154 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8118 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 8034 | `./node_modules/.bin/mocha test/src` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 8001 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7894 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7892 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7845 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7641 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7616 | `mocha tests/*.js` | 
...
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7326 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7320 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7268 | `npm run build && istanbul cover _mocha` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7222 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 7113 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6793 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6767 | `nyc mocha test/**/* -r ./test/before` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 6697 | `npm run mocha` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6682 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6663 | `xo && mocha test/*.js --timeout 100000` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6649 | `mocha $HARMONY_OPTS` | 
| [aui/art-template](https://github.com/aui/art-template) | 6646 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6621 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6619 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [almende/vis](https://github.com/almende/vis) | 6498 | `mocha --compilers js:babel-core/register` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6240 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6072 | `npm run lint -s && npm run mocha -s` | 
...
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 6006 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
...
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5916 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5727 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5657 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5618 | `mocha tests/node.js` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5562 | `mocha test/test.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5516 | `mocha && eslint lib/**` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5500 | `npm run build-cli && mocha` | 
...
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5481 | `mocha --exit --require babel-core/register` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5399 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5334 | `mocha` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5211 | `mocha --timeout 10000 && npm run lint` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5178 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
...
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4987 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4941 | `mocha; jshint *.js lib` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4830 | `gulp lint && mocha` | 
...
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4800 | `mocha` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4782 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4770 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4705 | `standard && mocha` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4682 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
...
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4573 | `gulp build; mocha;` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4570 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4545 | `mocha ./test/runner.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4499 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4488 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4367 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4330 | `mocha test` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4078 | `mocha --recursive && make test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4054 | `nyc mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 4016 | `NODE_ENV=test mocha` | 
...
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3924 | `istanbul test node_modules/mocha/bin/_mocha` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3829 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [erming/shout](https://github.com/erming/shout) | 3814 | `HOME=test/fixtures mocha test/**/*.js && npm run lint` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3813 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3787 | `mocha -R spec ./test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3780 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3732 | `npm run lint ; mocha && mocha test/individual` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3683 | `mocha ./test/*.spec.js` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3657 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3652 | `npm run jshint && npm run mocha` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3629 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3594 | `standard && mocha --timeout 60000 test/test.js` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3583 | `npm run lint && npm run mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3558 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [primus/primus](https://github.com/primus/primus) | 3529 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3479 | `mocha --reporter spec --timeout 3000` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3444 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
...
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3429 | `mocha --check-leaks --reporter spec --bail` | 
...
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3302 | `nyc mocha "test/**/*.test.js"` | 
...
| [shoutem/ui](https://github.com/shoutem/ui) | 3293 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [expressjs/session](https://github.com/expressjs/session) | 3266 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3246 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3184 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3130 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3116 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ttezel/twit](https://github.com/ttezel/twit) | 3041 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2976 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2938 | `nyc mocha && tsc` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2930 | `mocha test/*.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2916 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2875 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2864 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2847 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2845 | `yarn tsc && yarn lint && yarn mocha-exclude-redis-cache` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2822 | `mocha test/index.js && npm run demo` | 
| [kenwheeler/cash](https://github.com/kenwheeler/cash) | 2819 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2811 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2806 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2805 | `mocha -R spec --recursive src/test` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2780 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2765 | `mocha --require should --reporter spec` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2759 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2759 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2758 | `istanbul cover _mocha` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2757 | `NODE_ENV=test mocha` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2753 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2724 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2710 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2607 | `mocha` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2604 | `mocha --timeout 100000` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2603 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2585 | `mocha --compilers js:babel-register --recursive spec` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2584 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2583 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2464 | `node_modules/.bin/mocha --reporter spec` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2443 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2441 | `mocha --reporter=spec test/*-test.js` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2436 | `export TESTING=true; mocha --reporter list` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2430 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2420 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2394 | `npm run build && cd test && mocha . --reporter dot` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2383 | `nyc mocha` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2325 | `mocha --require should --reporter spec` | 
...
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2253 | `npm run lint && npm run build:test && npm run build:user && npm run mocha` | 
| [mplewis/src2png](https://github.com/mplewis/src2png) | 2235 | `mocha test test/unit/**/*_test.js` | 
| [davidmerfield/Typeset](https://github.com/davidmerfield/Typeset) | 2232 | `mocha -u bdd -R spec -t 500 --recursive` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2228 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2220 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [esbenp/pdf-bot](https://github.com/esbenp/pdf-bot) | 2220 | `nyc --reporter=lcov --reporter=text mocha test/*.test.js --recursive --coverage` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2205 | `mocha test.js` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2191 | `mocha -R landing test/index` | 
| [gajus/swing](https://github.com/gajus/swing) | 2159 | `mocha --compilers js:babel-register` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2142 | `nyc --reporter=html --reporter=text mocha` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2093 | `mocha` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2086 | `cross-env BABEL_ENV=test mocha` | 
...
| [noble/noble](https://github.com/noble/noble) | 2067 | `mocha -R spec test/*.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 2047 | `mocha test && npm run lint` | 
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2033 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1993 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1964 | `standard && mocha` | 
...
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1902 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1899 | `mocha test/runner.js --reporter spec` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1874 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1865 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1820 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1806 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [diegonetto/generator-ionic](https://github.com/diegonetto/generator-ionic) | 1802 | `mocha --timeout 5000` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1797 | `./node_modules/.bin/mocha tests/*.js --exit` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1781 | `npm run lint && mocha -R dot && npm run cover` | 
| [share/sharedb](https://github.com/share/sharedb) | 1781 | `./node_modules/.bin/mocha && npm run jshint` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1768 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1737 | `mocha --reporter spec && npm run test-typescript` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1690 | `mocha` | 
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1678 | `npm run lint && npm run mocha` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1677 | `eslint . && mocha -t 5000` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1660 | `mocha && npm run lint` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1634 | `mocha tests --compilers js:babel-core/register` | 
| [JustinTulloss/zeromq.node](https://github.com/JustinTulloss/zeromq.node) | 1620 | `mocha --expose-gc --slow 300` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1609 | `standard "src/*.js" && npm run build && mocha` | 
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1609 | `mocha test/*.js` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1609 | `mocha --reporter spec test/*.js` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1607 | `mocha test -u bdd -R spec` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1585 | `mocha test --timeout 600000` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1581 | `mocha ./test/basic.js -t 5000` | 
...
| [jamiebuilds/babel-react-optimize](https://github.com/jamiebuilds/babel-react-optimize) | 1503 | `eslint packages/*/test packages/*/src && mocha packages/*/test/index.js --compilers js:babel-register` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1456 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1428 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
...
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1412 | `mocha test.js` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1401 | `mocha compiled_tests/` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1392 | `mocha` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1389 | `mocha --recursive` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1352 | `mocha` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1351 | `nyc npm run mocha` | 
...
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1306 | `npm run build && mocha -r should` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1236 | `mocha` | 
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1234 | `mocha --recursive` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1198 | `mocha test` | 
...
| [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) | 1183 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
| [arqex/freezer](https://github.com/arqex/freezer) | 1182 | `node ./node_modules/mocha/bin/mocha tests` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1181 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1160 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1147 | `nyc mocha --timeout=20000 test.js` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1113 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1095 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [babel/gulp-babel](https://github.com/babel/gulp-babel) | 1073 | `xo && mocha` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1028 | `mocha -R spec ./test/unit/**` | 
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1027 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1020 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 1003 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
| [firebase/firebase-tools](https://github.com/firebase/firebase-tools) | 1002 | `npm run lint && npm run mocha` | 
...
| [angular-redux/ng-redux](https://github.com/angular-redux/ng-redux) | 995 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive` | 
...
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 986 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 985 | `mocha ./test/test*.js --reporter spec` | 
...
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 976 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
...
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 969 | `mocha -t 120000 test/*.test.js` | 
...
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 959 | `mocha` | 
...
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 945 | `npm run lint && npm run mocha` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 933 | `eslint src test && mocha --compilers babel-register` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 921 | `TEST=all mocha` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 868 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 863 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 856 | `mocha --timeout 20000` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 841 | `npm run mocha:istanbul` | 
...
| [felixge/node-dateformat](https://github.com/felixge/node-dateformat) | 814 | `mocha` | 
...
| [amplitude/redux-query](https://github.com/amplitude/redux-query) | 805 | `mocha --compilers js:babel-core/register --reporter spec test/**/*.test.js` | 
| [RisingStack/graphql-server](https://github.com/RisingStack/graphql-server) | 803 | `NODE_ENV=test mocha --compilers js:babel/register --require co-mocha $(find src -name "*.spec.js")` | 
...
| [JoshuaWise/better-sqlite3](https://github.com/JoshuaWise/better-sqlite3) | 759 | `$(npm bin)/mocha --bail --timeout 5000 --slow 5000` | 
...
| [peter-murray/node-hue-api](https://github.com/peter-murray/node-hue-api) | 720 | `mocha test` | 
...
| [ConsenSys/eth-lightwallet](https://github.com/ConsenSys/eth-lightwallet) | 712 | `./node_modules/.bin/mocha --reporter spec` | 
