...
The list was updated at 02:06:59 04/05/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40456 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40136 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 37515 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29119 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23693 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22728 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21431 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 21089 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18273 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17919 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15880 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15321 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13944 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13664 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13012 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12403 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12239 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12077 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11962 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11843 | `mocha --reporter spec test/*-test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11572 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 11099 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10812 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10460 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 10043 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9921 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9562 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9496 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9482 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9354 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9340 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9004 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8681 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8670 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8552 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8400 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8239 | `mocha test/test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8216 | `mocha --check-leaks -R dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 8164 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8146 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8060 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7995 | `./node_modules/.bin/mocha test/src` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7918 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7857 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7837 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7830 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7628 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7562 | `mocha tests/*.js` | 
...
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7291 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7253 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7226 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7177 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 7030 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6712 | `nyc mocha test/**/* -r ./test/before` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6711 | `mocha --opts mocha.opts` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6632 | `xo && mocha test/*.js --timeout 100000` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6628 | `mocha $HARMONY_OPTS` | 
| [aui/art-template](https://github.com/aui/art-template) | 6614 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6574 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6571 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6567 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6461 | `mocha --compilers js:babel-core/register` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6189 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
...
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5979 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5971 | `npm run test:mocha:src` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5925 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5875 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5704 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5625 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5591 | `mocha tests/node.js` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5529 | `mocha test/test.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5496 | `mocha && eslint lib/**` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5464 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5414 | `mocha --exit --require babel-core/register` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5395 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5391 | `npm run build-cli && mocha` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5300 | `mocha` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5198 | `mocha --timeout 10000 && npm run lint` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5138 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4936 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4833 | `mocha; jshint *.js lib` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4811 | `gulp lint && mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4804 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4762 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4758 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4727 | `mocha` | 
| [santinic/how2](https://github.com/santinic/how2) | 4668 | `mocha test` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4662 | `standard && mocha` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4652 | `mocha -R spec 'tests/app'` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4641 | `mocha --reporter spec -t 8000` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4594 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4552 | `gulp build; mocha;` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4551 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4542 | `mocha ./test/runner.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4478 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4458 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4328 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4294 | `mocha test` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4052 | `mocha --recursive && make test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4040 | `nyc mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3964 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3905 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3891 | `istanbul test node_modules/mocha/bin/_mocha` | 
...
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3768 | `mocha -R spec ./test` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3752 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3744 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3734 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3713 | `npm run lint ; mocha && mocha test/individual` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3660 | `mocha ./test/*.spec.js` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3609 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3579 | `standard && mocha --timeout 60000 test/test.js` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3527 | `npm run lint && npm run mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3520 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [primus/primus](https://github.com/primus/primus) | 3514 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3476 | `mocha --reporter spec --timeout 3000` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3415 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
...
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3405 | `mocha --check-leaks --reporter spec --bail` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3395 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3284 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3262 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3234 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3118 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3105 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3064 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 3027 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 3020 | `mocha` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2955 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2931 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2925 | `mocha test/*.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2913 | `nyc mocha && tsc` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2895 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2887 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2839 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2833 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2818 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2804 | `mocha` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2802 | `mocha test/index.js && npm run demo` | 
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2802 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2799 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2790 | `mocha -R spec --recursive src/test` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2773 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2746 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2735 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2714 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2712 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2706 | `mocha` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2679 | `mocha --opts mocha.opts` | 
| [tj/should.js](https://github.com/tj/should.js) | 2678 | `mocha -R mocha-better-spec-reporter --require ./cjs/should --color --check-leaks ./test/*.test.js ./test/**/*.test.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2657 | `NODE_ENV=test mocha` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2653 | `xo && mocha` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2645 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2624 | `yarn tsc && yarn lint && mocha` | 
...
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2604 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
...
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2570 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2558 | `mocha --compilers js:babel-register --recursive spec` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2551 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2545 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2541 | `mocha --recursive --watch` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2534 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2446 | `node_modules/.bin/mocha --reporter spec` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2426 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2403 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2377 | `npm run build && cd test && mocha . --reporter dot` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2373 | `nyc mocha` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2370 | `node node_modules/mocha/bin/_mocha` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2369 | `export TESTING=true; mocha --reporter list` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2350 | `mocha` | 
...
| [json5/json5](https://github.com/json5/json5) | 2323 | `nyc --reporter=html --reporter=text mocha` | 
| [mde/ejs](https://github.com/mde/ejs) | 2293 | `mocha --require should --reporter spec` | 
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2289 | `mocha "test/**/*-test.js"` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2267 | `mocha` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2265 | `mocha` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2258 | `mocha test/unit --require mochahook` | 
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2240 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2238 | `npm run lint && npm run build:test && npm run build:user && npm run mocha` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2204 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2199 | `mocha -R spec` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2182 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2168 | `mocha test.js` | 
| [gajus/swing](https://github.com/gajus/swing) | 2153 | `mocha --compilers js:babel-register` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2120 | `mocha -R landing test/index` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2119 | `nyc --reporter=html --reporter=text mocha` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2088 | `mocha` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2076 | `cross-env BABEL_ENV=test mocha` | 
| [lynndylanhurley/redux-auth](https://github.com/lynndylanhurley/redux-auth) | 2062 | `node_modules/.bin/_mocha --timeout 5000 --compilers .:test/compiler.js test/runner.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 2031 | `mocha test && npm run lint` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2001 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1956 | `standard && mocha` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1936 | `mocha --compilers js:babel-register` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1935 | `mocha -c test/index.js` | 
| [hojberg/cssarrowplease](https://github.com/hojberg/cssarrowplease) | 1934 | `mocha --require=test/test_helper.js` | 
| [Qix-/color](https://github.com/Qix-/color) | 1928 | `mocha` | 
...
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1892 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1887 | `mocha test/runner.js --reporter spec` | 
...
| [letsgetrandy/brototype](https://github.com/letsgetrandy/brototype) | 1854 | `mocha tests.js` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1851 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1850 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1844 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1826 | `mocha --compilers js:babel-core/register __tests__` | 
| [mjrussell/redux-auth-wrapper](https://github.com/mjrussell/redux-auth-wrapper) | 1819 | `mocha --compilers js:babel-core/register --recursive --require test/init.js test/authWrapper-test.js` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1799 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1793 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
...
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 1790 | `./node_modules/.bin/mocha tests/*.js --exit` | 
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1776 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1775 | `mocha && eslint *.js` | 
| [kach/nearley](https://github.com/kach/nearley) | 1774 | `mocha test/*.test.js` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1765 | `npm run lint && mocha -R dot && npm run cover` | 
| [share/sharedb](https://github.com/share/sharedb) | 1764 | `./node_modules/.bin/mocha && npm run jshint` | 
| [seaneking/rucksack](https://github.com/seaneking/rucksack) | 1763 | `mocha test` | 
| [lipp/login-with](https://github.com/lipp/login-with) | 1761 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1760 | `mocha` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1751 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [cliftonc/calipso](https://github.com/cliftonc/calipso) | 1751 | `NODE_ENV=mocha ./node_modules/.bin/mocha --reporter spec -t 80000 -s 500` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1740 | `npm run lint && mocha --reporter spec test/*.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1736 | `nyc npm run _mocha` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1729 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1717 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1714 | `npm run mocha && npm run karma` | 
| [toish/chromatism](https://github.com/toish/chromatism) | 1709 | `BABEL_ENV=test mocha --compilers js:babel-core/register` | 
...
| [pstadler/flightplan](https://github.com/pstadler/flightplan) | 1676 | `./node_modules/.bin/mocha` | 
...
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1664 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1663 | `mocha` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1648 | `mocha && npm run lint` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1636 | `npm run lint && npm run mocha` | 
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1624 | `mocha --reporter spec --grep .` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1622 | `mocha tests --compilers js:babel-core/register` | 
...
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1605 | `npm run lint && mocha test/unit && mocha test/runner` | 
...
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1598 | `npm run lint && mocha` | 
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1593 | `mocha test -u bdd -R spec` | 
| [flitbit/diff](https://github.com/flitbit/diff) | 1592 | `mocha test/**/*.js` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1580 | `mocha test --timeout 600000` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1578 | `mocha` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1577 | `standard "src/*.js" && npm run build && mocha` | 
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1575 | `mocha ./test/basic.js -t 5000` | 
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1565 | `mocha` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1557 | `mocha test/* --reporter spec` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1553 | `eslint . && mocha -t 5000` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1552 | `mocha spec` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1549 | `./node_modules/.bin/mocha` | 
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1530 | `npm run lint && npm run mocha` | 
| [helpers/handlebars-helpers](https://github.com/helpers/handlebars-helpers) | 1520 | `mocha` | 
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1506 | `mocha --compilers js:babel-register` | 
...
| [Caligatio/jsSHA](https://github.com/Caligatio/jsSHA) | 1477 | `mocha --reporter spec` | 
| [johntitus/node-horseman](https://github.com/johntitus/node-horseman) | 1469 | `mocha -R spec` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1466 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1418 | `nyc mocha` | 
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1418 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
| [kefirjs/kefir](https://github.com/kefirjs/kefir) | 1414 | `./configs/prettier.sh check && rollup -c ./configs/rollup.dev.js && mocha && flow check` | 
| [knrz/CSV.js](https://github.com/knrz/CSV.js) | 1413 | `mocha test.js` | 
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1410 | `standard "./src/*.js" && mocha` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1403 | `mocha test.js` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1398 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1397 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1385 | `mocha` | 
| [zeit/ms](https://github.com/zeit/ms) | 1381 | `mocha tests.js` | 
| [teambit/bit](https://github.com/teambit/bit) | 1381 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1380 | `mocha compiled_tests/` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1379 | `mocha --recursive` | 
| [expressjs/compression](https://github.com/expressjs/compression) | 1375 | `mocha --check-leaks --reporter spec --bail` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1343 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1341 | `mocha test/setup.js test/spec/*.js` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1340 | `mocha` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1338 | `nyc npm run mocha` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1314 | `mocha --timeout 10000 ./tests/lib.js` | 
| [noble/bleno](https://github.com/noble/bleno) | 1309 | `mocha -R spec test/*.js` | 
...
| [lukehaas/Scrollify](https://github.com/lukehaas/Scrollify) | 1274 | `mocha ./test/scrollify_test.js --recursive ./test` | 
...
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1269 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [FormidableLabs/rapscallion](https://github.com/FormidableLabs/rapscallion) | 1257 | `mocha spec/exec.js` | 
...
| [jhlywa/chess.js](https://github.com/jhlywa/chess.js) | 1225 | `mocha` | 
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1224 | `mocha --recursive` | 
| [andywer/leakage](https://github.com/andywer/leakage) | 1219 | `mocha --timeout 10000 test/ && standard src/**/*.js test/**/*.js` | 
| [oracle/node-oracledb](https://github.com/oracle/node-oracledb) | 1218 | `mocha --opts test/opts/mocha.opts` | 
...
| [messageformat/messageformat](https://github.com/messageformat/messageformat) | 1197 | `mocha` | 
...
| [paldepind/flyd](https://github.com/paldepind/flyd) | 1172 | `eslint --fix lib/ test/ module/ && mocha -R dot test/*.js module/**/test/*.js` | 
| [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) | 1170 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1165 | `standard && istanbul cover _mocha` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1164 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1162 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1160 | `eslint src && mocha && karma start --single-run` | 
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1159 | `mocha` | 
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1157 | `mocha --reporter dot` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1154 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1137 | `node_modules/.bin/mocha` | 
| [frctl/fractal](https://github.com/frctl/fractal) | 1136 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
| [normalize/mz](https://github.com/normalize/mz) | 1136 | `mocha --reporter spec` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1124 | `nyc mocha --timeout=20000 test.js` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1122 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
| [robrich/orchestrator](https://github.com/robrich/orchestrator) | 1121 | `mocha` | 
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1116 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
| [fent/randexp.js](https://github.com/fent/randexp.js) | 1115 | `istanbul cover node_modules/.bin/_mocha -- test/*-test.js` | 
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1105 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1088 | `mocha tests/test-*` | 
...
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1080 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [evanw/node-source-map-support](https://github.com/evanw/node-source-map-support) | 1072 | `mocha` | 
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1071 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [vuejs/vueify](https://github.com/vuejs/vueify) | 1056 | `eslint index.js lib && mocha test/test.js --slow=5000 --timeout=10000` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1034 | `npm run prepublishOnly && mocha test/test.js` | 
...
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1027 | `mocha` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1010 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1008 | `mocha -R spec ./test/unit/**` | 
...
| [oakmac/chessboardjs](https://github.com/oakmac/chessboardjs) | 1003 | `mocha` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1000 | `mocha --recursive test` | 
| [krasimir/cssx](https://github.com/krasimir/cssx) | 998 | `mocha --colors ./test/*.spec.js` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 997 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [angular-redux/ng-redux](https://github.com/angular-redux/ng-redux) | 989 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive` | 
...
| [router5/router5](https://github.com/router5/router5) | 983 | `mocha --compilers js:babel-core/register --require test-helper.js --recursive 'packages/*/test/**/*.js'` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 980 | `mocha tests/*.js` | 
...
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 969 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 968 | `mocha ./test/test*.js --reporter spec` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 950 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [expressjs/generator](https://github.com/expressjs/generator) | 943 | `mocha --reporter spec --bail --check-leaks test/` | 
| [electron/spectron](https://github.com/electron/spectron) | 938 | `mocha && standard` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 937 | `npm run lint && npm run mocha` | 
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 933 | `mocha --reporter spec --bail --check-leaks test/` | 
| [developit/snarkdown](https://github.com/developit/snarkdown) | 930 | `eslint src test && mocha --compilers babel-register` | 
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 926 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 923 | `mocha` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 902 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 902 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [domenic/sinon-chai](https://github.com/domenic/sinon-chai) | 900 | `mocha` | 
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 895 | `npm run lint && mocha --require @babel/register` | 
...
| [electron-userland/electron-compile](https://github.com/electron-userland/electron-compile) | 885 | `mocha --compilers js:babel-register test/*.js` | 
...
| [bestiejs/punycode.js](https://github.com/bestiejs/punycode.js) | 852 | `mocha tests` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 849 | `mocha -R spec` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 839 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 839 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
| [mikemintz/react-rethinkdb](https://github.com/mikemintz/react-rethinkdb) | 839 | `eslint test && mocha --compilers js:babel/register` | 
| [gkajs/gka](https://github.com/gkajs/gka) | 837 | `mocha --timeout 20000` | 
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 836 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
...
| [alexa-js/alexa-app](https://github.com/alexa-js/alexa-app) | 823 | `./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [neumino/rethinkdbdash](https://github.com/neumino/rethinkdbdash) | 817 | `mocha --check-leaks -t 20000` | 
...
| [tj/node-migrate](https://github.com/tj/node-migrate) | 813 | `standard && standard ./bin/* && mocha` | 
| [dareid/chakram](https://github.com/dareid/chakram) | 811 | `istanbul cover _mocha` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 810 | `npm run mocha:istanbul` | 
...
| [leizongmin/node-segment](https://github.com/leizongmin/node-segment) | 799 | `mocha -t 5000` | 
| [image-size/image-size](https://github.com/image-size/image-size) | 798 | `nyc mocha specs` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 782 | `./node_modules/.bin/mocha -R spec` | 
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 781 | `babel-node node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
...
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 775 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
...
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 767 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
...
| [JoshuaWise/better-sqlite3](https://github.com/JoshuaWise/better-sqlite3) | 750 | `$(npm bin)/mocha --bail --timeout 5000 --slow 5000` | 
...
| [saintedlama/passport-local-mongoose](https://github.com/saintedlama/passport-local-mongoose) | 742 | `cross-env NODE_ENV=test nyc --reporter=text-summary mocha --recursive --throw-deprecation --require babel-polyfill --require babel-core/register` | 
...
| [fbeline/Design-Patterns-JS](https://github.com/fbeline/Design-Patterns-JS) | 716 | `mocha test --compilers js:babel-core/register` | 
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 716 | `mocha test` | 
| [proj4js/proj4js](https://github.com/proj4js/proj4js) | 716 | `npm run build && istanbul test _mocha test/test.js` | 
| [domchristie/humps](https://github.com/domchristie/humps) | 716 | `mocha` | 
...
| [radi-js/radi](https://github.com/radi-js/radi) | 714 | `nyc mocha` | 
...
| [webpack-contrib/karma-webpack](https://github.com/webpack-contrib/karma-webpack) | 713 | `mocha --compilers js:babel-register --full-trace --check-leaks test/unit` | 
...
| [volumio/Volumio2](https://github.com/volumio/Volumio2) | 710 | `npm install fs-extra && npm install --only=dev && ./node_modules/.bin/mocha --reporter spec` | 
| [webpack-contrib/html-loader](https://github.com/webpack-contrib/html-loader) | 709 | `mocha --harmony --full-trace --check-leaks` | 
...
| [yanhaijing/template.js](https://github.com/yanhaijing/template.js) | 704 | `mocha test` | 