...
The list was updated at 02:07:00 03/09/18 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39942 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39761 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 37060 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28921 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23496 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22391 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 20994 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20170 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 17956 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17676 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15678 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15057 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13875 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13323 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12788 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12204 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12144 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12034 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11799 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11747 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11543 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11239 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10714 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10688 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10175 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9794 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9682 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [tj/co](https://github.com/tj/co) | 9387 | `mocha --harmony` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9386 | `mocha test/index.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9350 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9214 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9150 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8933 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8605 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8455 | `mocha test/*-test.js` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8447 | `mocha` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8175 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8165 | `mocha test/test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8123 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8100 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7918 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7880 | `./node_modules/.bin/mocha test/src` | 
| [websockets/ws](https://github.com/websockets/ws) | 7877 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7788 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7760 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7648 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7609 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [dthree/cash](https://github.com/dthree/cash) | 7457 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7369 | `mocha tests/*.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7196 | `npm run build && istanbul cover _mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7186 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7017 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6988 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6789 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6583 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6547 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6501 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6469 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6468 | `nyc mocha test/**/* -r ./test/before` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6451 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6380 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6366 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6346 | `mocha --compilers js:babel-core/register` | 
...
| [marko-js/marko](https://github.com/marko-js/marko) | 5989 | `npm run jshint -s && npm run mocha -s` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5926 | `mocha` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5877 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5868 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5851 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5758 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5603 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5521 | `mocha tests/node.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5513 | `mocha test --recursive` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5430 | `mocha && eslint lib/**` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5400 | `mocha test/test.js` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5389 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5387 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5238 | `mocha --exit --require babel-core/register` | 
...
| [automerge/automerge](https://github.com/automerge/automerge) | 5056 | `mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5030 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 4962 | `npm run build-cli && mocha` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4790 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4786 | `gulp lint && mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4753 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4742 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4656 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [santinic/how2](https://github.com/santinic/how2) | 4639 | `mocha test` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4620 | `mocha -R spec 'tests/app'` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4620 | `mocha --reporter spec -t 8000` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4544 | `standard && mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4532 | `mocha ./test/runner.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4517 | `gulp build; mocha;` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4467 | `mocha` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4444 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4420 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4403 | `mocha; jshint *.js lib` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4395 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4361 | `./node_modules/.bin/mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4349 | `mocha` | 
...
| [lebab/lebab](https://github.com/lebab/lebab) | 4223 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4223 | `mocha -R spec ./test --recursive` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4219 | `mocha` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4217 | `mocha test` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4208 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3934 | `mocha --recursive && make test` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3911 | `mocha --require test/babel-hook test/*.js` | 
...
| [luin/ioredis](https://github.com/luin/ioredis) | 3868 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3803 | `npm run lint && npm run mocha` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3783 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3675 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3645 | `npm run lint ; mocha && mocha test/individual` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3638 | `npm run jshint && npm run mocha` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3621 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3597 | `mocha ./test/*.spec.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3557 | `standard && mocha --timeout 60000 test/test.js` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3553 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3527 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3513 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
...
| [henryboldi/felony](https://github.com/henryboldi/felony) | 3439 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js test/**/*.spec.js` | 
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3405 | `node_modules/.bin/mocha` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3387 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3361 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3354 | `npm run lint && npm run mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3333 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3289 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3224 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3184 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3178 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3161 | `nyc mocha "test/**/*.test.js"` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3119 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [expressjs/session](https://github.com/expressjs/session) | 3118 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
...
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3067 | `./node_modules/.bin/mocha test/test.*.js` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 3057 | `node_modules/.bin/mocha test/tests.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3018 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2985 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2976 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2975 | `mocha` | 
...
| [googlesamples/md2googleslides](https://github.com/googlesamples/md2googleslides) | 2934 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2929 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2895 | `mocha test/*.js` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2854 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2803 | `nyc mocha && tsc` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2784 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2784 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2768 | `mocha -R spec --recursive src/test` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2766 | `mocha` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2759 | `mocha --require should --reporter spec` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2758 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2753 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2751 | `mocha test/index.js && npm run demo` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2738 | `node node_modules/mocha/bin/mocha test test/*.js` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 2734 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2726 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [github-tools/github](https://github.com/github-tools/github) | 2694 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2685 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2683 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2675 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2655 | `mocha` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2641 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2639 | `mocha` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2637 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2631 | `xo && mocha` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2614 | `mocha --opts mocha.opts` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2610 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2574 | `npm run mocha && npm run lint` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2542 | `mocha` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2539 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2526 | `mocha --recursive --watch` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2520 | `mocha --compilers js:babel-register --recursive spec` | 
| [reactGo/reactGo](https://github.com/reactGo/reactGo) | 2509 | `mocha ./app/tests/setup.js --compilers css:./app/tests/compilers/css ./app/**/*-test.js` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2504 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2500 | `mocha` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2485 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2459 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2453 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2434 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2400 | `NODE_ENV=test mocha` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2388 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2372 | `node_modules/.bin/mocha --reporter spec` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2367 | `node node_modules/mocha/bin/_mocha` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2360 | `nyc mocha test/mocha-node-setup.js 'test/**/*-test.js'` | 
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2355 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
...
| [agershun/alasql](https://github.com/agershun/alasql) | 2325 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2221 | `npm run lint && mocha` | 
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2219 | `mocha "test/**/*-test.js"` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2218 | `mocha test/unit --require mochahook` | 
...
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2203 | `npm run lint && npm run build && npm run mocha` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2196 | `mocha` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2173 | `mocha -R spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2164 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2084 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2067 | `mocha test.js` | 
| [ubolonton/js-csp](https://github.com/ubolonton/js-csp) | 2065 | `cross-env BABEL_ENV=test mocha` | 
| [lynndylanhurley/redux-auth](https://github.com/lynndylanhurley/redux-auth) | 2044 | `node_modules/.bin/_mocha --timeout 5000 --compilers .:test/compiler.js test/runner.js` | 
| [carlsednaoui/ouibounce](https://github.com/carlsednaoui/ouibounce) | 2042 | `mocha` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2018 | `mocha -R landing test/index` | 
...
| [noble/noble](https://github.com/noble/noble) | 2012 | `mocha -R spec test/*.js` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2008 | `mocha && eslint .` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 1960 | `mocha test && npm run lint` | 
| [hojberg/cssarrowplease](https://github.com/hojberg/cssarrowplease) | 1932 | `mocha --require=test/test_helper.js` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1929 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1925 | `standard && mocha` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1895 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1870 | `mocha --compilers js:babel-register` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1858 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1856 | `mocha --require ./test/common --growl test/expect.js` | 
| [letsgetrandy/brototype](https://github.com/letsgetrandy/brototype) | 1848 | `mocha tests.js` | 
...
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1796 | `cross-env NODE_ENV=test mocha` | 
...
| [then/promise](https://github.com/then/promise) | 1786 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1784 | `mocha --compilers js:babel-core/register __tests__` | 
...
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1777 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [kach/nearley](https://github.com/kach/nearley) | 1750 | `mocha test/*.test.js` | 
...
| [lipp/login-with](https://github.com/lipp/login-with) | 1742 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
| [facebookarchive/fb-flo](https://github.com/facebookarchive/fb-flo) | 1734 | `mocha test/**/*_test.js --bail` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1731 | `npm run lint && mocha -R dot && npm run cover` | 
| [share/sharedb](https://github.com/share/sharedb) | 1729 | `./node_modules/.bin/mocha && npm run jshint` | 
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1722 | `mocha && eslint *.js` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1721 | `npm run lint && mocha --reporter spec test/*.js` | 
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1715 | `mocha test` | 
...
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1699 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1687 | `mocha --reporter spec && npm run test-typescript` | 
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1687 | `npm run lint && mocha server/test --recursive --exit` | 
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1686 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1683 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1676 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1672 | `nyc npm run _mocha` | 
...
| [ifandelse/machina.js](https://github.com/ifandelse/machina.js) | 1643 | `./node_modules/mocha/bin/mocha -r spec/helpers/node-setup.js spec` | 
| [guo-yu/douban.fm](https://github.com/guo-yu/douban.fm) | 1634 | `node_modules/mocha/bin/mocha tests/*.js --require tests/babelhook` | 
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1621 | `mocha && npm run lint` | 
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1613 | `mocha` | 
...
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1599 | `mocha` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1580 | `npm run lint && npm run mocha` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1579 | `npm run lint && mocha` | 
| [ericclemmons/react-resolver](https://github.com/ericclemmons/react-resolver) | 1574 | `mocha` | 
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1574 | `npm run lint && mocha test/unit && mocha test/runner` | 
...
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1538 | `mocha` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1536 | `mocha spec` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1536 | `mocha --reporter spec test/*.js` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1536 | `mocha test/* --reporter spec` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1531 | `mocha test --timeout 600000` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1518 | `standard "src/*.js" && npm run build && mocha` | 
...
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1490 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [numbers/numbers.js](https://github.com/numbers/numbers.js) | 1472 | `mocha -u tdd` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1452 | `mocha --compilers js:babel-register` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1396 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [felixrieseberg/npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) | 1381 | `standard "./src/*.js" && mocha` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1356 | `eslint . && mocha -t 5000` | 
...
| [expressjs/compression](https://github.com/expressjs/compression) | 1340 | `mocha --check-leaks --reporter spec --bail` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1338 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1329 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1314 | `mocha compiled_tests/` | 
...
| [noble/bleno](https://github.com/noble/bleno) | 1285 | `mocha -R spec test/*.js` | 
...
| [lukehaas/Scrollify](https://github.com/lukehaas/Scrollify) | 1241 | `mocha ./test/scrollify_test.js --recursive ./test` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1209 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
...
| [ToothlessGear/node-gcm](https://github.com/ToothlessGear/node-gcm) | 1195 | `mocha test/**/*Spec.js` | 
| [messageformat/messageformat.js](https://github.com/messageformat/messageformat.js) | 1191 | `mocha` | 
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1190 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
...
| [domenic/chai-as-promised](https://github.com/domenic/chai-as-promised) | 1188 | `mocha` | 
...
| [paldepind/flyd](https://github.com/paldepind/flyd) | 1163 | `eslint --fix lib/ test/ module/ && mocha -R dot test/*.js module/**/test/*.js` | 
...
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1148 | `mocha` | 
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1145 | `mocha` | 
| [tediousjs/node-mssql](https://github.com/tediousjs/node-mssql) | 1144 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1130 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1127 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1125 | `standard && istanbul cover _mocha` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1117 | `mocha --reporter dot` | 
...
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1113 | `mocha src/test.js` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1107 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1102 | `eslint src && mocha && karma start --single-run` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1093 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1084 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [zcreativelabs/react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) | 1059 | `mocha './tests/**/*.spec.js' --compilers js:babel-core/register` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1046 | `nyc mocha --timeout=20000 test.js` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1043 | `mocha tests/test-*` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 997 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 985 | `mocha` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 983 | `standard && mocha` | 
| [yeoman/generator-polymer](https://github.com/yeoman/generator-polymer) | 983 | `jshint {app,el,gh,seed,test}/*.js script-base.js util.js && mocha --reporter spec` | 
| [angular-redux/ng-redux](https://github.com/angular-redux/ng-redux) | 977 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive` | 
...
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 964 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 960 | `mocha` | 
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 958 | `mocha --compilers js:babel-core/register` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 950 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 940 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 940 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 936 | `webpack && mocha test/unit` | 
...
| [electron/asar](https://github.com/electron/asar) | 927 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 926 | `mocha ./test/test*.js --reporter spec` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 918 | `mocha tests/*.js` | 
...
| [developit/snarkdown](https://github.com/developit/snarkdown) | 909 | `eslint src test && mocha --compilers babel-register` | 
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 908 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 888 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
| [kriasoft/aspnet-starter-kit](https://github.com/kriasoft/aspnet-starter-kit) | 887 | `mocha "client.test" --compilers js:babel-register` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 873 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 863 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 852 | `mocha ./test -R spec` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 843 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 834 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
| [andrewrk/node-s3-client](https://github.com/andrewrk/node-s3-client) | 834 | `mocha` | 
| [claudioc/jingo](https://github.com/claudioc/jingo) | 829 | `node_modules/.bin/mocha test/spec` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 822 | `mocha -R spec` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 792 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 783 | `mocha` | 
...
| [EragonJ/Kaku](https://github.com/EragonJ/Kaku) | 776 | `./node_modules/mocha/bin/mocha -u tdd -t 5000 --reporter dot --compilers js:babel-core/register --require ./tests/unit/setup.js 'tests/unit/*.test.js'` | 
...
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 768 | `mocha spec/*.js` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 765 | `./node_modules/.bin/mocha -R spec` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 762 | `npm run mocha:istanbul` | 
...
| [depcheck/depcheck](https://github.com/depcheck/depcheck) | 755 | `babel-node node_modules/mocha/bin/_mocha ./test ./test/special --timeout 10000` | 
...
| [bitpay/insight](https://github.com/bitpay/insight) | 738 | `mocha test` | 
...
| [indutny/node-ip](https://github.com/indutny/node-ip) | 731 | `jscs lib/*.js test/*.js && jshint lib/*.js && mocha --reporter spec test/*-test.js` | 
...
| [taskrabbit/ReactNativeSampleApp](https://github.com/taskrabbit/ReactNativeSampleApp) | 716 | `npm run mocha-test test/integration` | 
...
| [fossasia/open-event-webapp](https://github.com/fossasia/open-event-webapp) | 705 | `mocha` | 
| [peter-murray/node-hue-api](https://github.com/peter-murray/node-hue-api) | 705 | `mocha test` | 
| [proj4js/proj4js](https://github.com/proj4js/proj4js) | 705 | `npm run build && istanbul test _mocha test/test.js` | 
| [nfroidure/gulp-iconfont](https://github.com/nfroidure/gulp-iconfont) | 704 | `mocha tests/*.mocha.js` | 
| [webpack-contrib/karma-webpack](https://github.com/webpack-contrib/karma-webpack) | 704 | `mocha --compilers js:babel-register --full-trace --check-leaks test/unit` | 
