...
The list was updated at 02:06:16 12/24/17 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39368 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 38055 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35740 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 35197 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28247 | `mocha --reporter spec` | 
| [caolan/async](https://github.com/caolan/async) | 22965 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19783 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17040 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16850 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15208 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14284 | `mocha test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13607 | `nyc --reporter=html --reporter=text mocha` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 12714 | `cross-env NODE_ENV=test mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12401 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12289 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11912 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11702 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11640 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11527 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11323 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10534 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10426 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10302 | `nyc grunt mocha-and-karma` | 
...
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9577 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9257 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9124 | `mocha --harmony` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9065 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 8940 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
...
| [svg/svgo](https://github.com/svg/svgo) | 8686 | `set NODE_ENV=test && mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8385 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8156 | `mocha test/*-test.js` | 
...
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 7992 | `mocha test/test.js` | 
...
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7594 | `./node_modules/.bin/mocha test/src` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7543 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7342 | `mocha --compilers js:babel-register test/test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7313 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7188 | `npm run eslint && npm run mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 7067 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7059 | `npm run build && istanbul cover _mocha` | 
| [amark/gun](https://github.com/amark/gun) | 6954 | `mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 6953 | `./node_modules/.bin/mocha test` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 6909 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6894 | `mocha tests/*.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6453 | `mocha $HARMONY_OPTS` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6432 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6403 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6317 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6218 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6198 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6107 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 6036 | `mocha --compilers js:babel-core/register` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 5974 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5933 | `mocha` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5854 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5850 | `nyc mocha test/** -r ./test/before` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5705 | `mocha --opts mocha.opts` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5685 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5680 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5583 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5583 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5470 | `npm run jshint && mocha test/` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5393 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
...
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5259 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5229 | `mocha test --recursive` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5168 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
...
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 4980 | `mocha --timeout 10000 && npm run lint` | 
| [mozilla/nunjucks](https://github.com/mozilla/nunjucks) | 4817 | `jshint . && istanbul cover ./node_modules/mocha/bin/_mocha -- -R dot tests` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4786 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
...
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4664 | `mocha --compilers js:babel-core/register` | 
...
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4566 | `mocha --reporter spec -t 8000` | 
...
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4360 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4349 | `gulp build; mocha;` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4334 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [derbyjs/derby](https://github.com/derbyjs/derby) | 4301 | `./node_modules/.bin/mocha test/all/*.mocha.js; ./node_modules/.bin/jshint lib/*.js test/*.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4263 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4248 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [expressjs/multer](https://github.com/expressjs/multer) | 4188 | `standard && mocha` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4105 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4101 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4056 | `mocha` | 
...
| [peterramsing/lost](https://github.com/peterramsing/lost) | 3942 | `nyc mocha` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3913 | `mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 3860 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [luin/ioredis](https://github.com/luin/ioredis) | 3620 | `NODE_ENV=test mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3557 | `mocha --require test/babel-hook test/*.js` | 
...
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3538 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3533 | `standard && mocha --timeout 60000 test/test.js` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3521 | `npm run lint && npm run mocha` | 
| [blakeembrey/code-problems](https://github.com/blakeembrey/code-problems) | 3502 | `mocha tests/javascript` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3466 | `npm run build-cli && mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3440 | `npm run lint ; mocha && mocha test/individual` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3389 | `nyc mocha` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3312 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3057 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3053 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3048 | `mocha --check-leaks --reporter spec --bail` | 
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3041 | `./node_modules/.bin/mocha test/test.*.js` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3015 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
...
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 2969 | `node_modules/.bin/mocha test/tests.js` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 2945 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 2923 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2887 | `nyc mocha "test/**/*.test.js"` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2876 | `mocha` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2874 | `npm run lint && npm run mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 2851 | `mocha; jshint *.js lib` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2826 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 2817 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2780 | `mocha test/*.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2753 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2751 | `mocha --require should --reporter spec` | 
| [kenwheeler/cash](https://github.com/kenwheeler/cash) | 2738 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2708 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2635 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2612 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2596 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2578 | `nyc mocha && tsc` | 
...
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2538 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2524 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2523 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2507 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
| [css/csso](https://github.com/css/csso) | 2498 | `mocha --reporter dot` | 
...
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2487 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2481 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2475 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2427 | `mocha --opts mocha.opts` | 
...
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2425 | `mocha --compilers js:babel-register --recursive spec` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2386 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2373 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [s-a/iron-node](https://github.com/s-a/iron-node) | 2363 | `node node_modules/mocha/bin/_mocha` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2333 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [katiefenn/parker](https://github.com/katiefenn/parker) | 2322 | `mocha --no-colors --reporter spec` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2316 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2313 | `mocha` | 
| [uber-archive/image-diff](https://github.com/uber-archive/image-diff) | 2312 | `grunt jshint && mocha` | 
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2301 | `npm run compile && mocha --compilers js:babel-core/register` | 
| [devongovett/regexgen](https://github.com/devongovett/regexgen) | 2297 | `mocha` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2222 | `mocha test` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2221 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [octokit/node-github](https://github.com/octokit/node-github) | 2174 | `nyc mocha test/**/*-test.js` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2174 | `NODE_ENV=test mocha` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2157 | `node_modules/.bin/mocha --reporter spec` | 
| [mozilla/send](https://github.com/mozilla/send) | 2134 | `mocha test/unit` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2111 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
...
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2095 | `mocha test/unit --require mochahook` | 
| [json5/json5](https://github.com/json5/json5) | 2078 | `mocha --ui exports --reporter spec` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2025 | `mocha` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 1995 | `mocha --require should --reporter spec` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 1966 | `nyc --reporter=html --reporter=text mocha` | 
...
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1819 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1805 | `mocha test && npm run lint` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1799 | `mocha` | 
...
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1778 | `mocha -c test/index.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1761 | `mocha test.js` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1705 | `mocha --compilers js:babel-register` | 
...
| [verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) | 1668 | `mocha ./test/functional ./test/unit --reporter=spec --full-trace` | 
...
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 1657 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [Kong/mashape-oauth](https://github.com/Kong/mashape-oauth) | 1655 | `mocha` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1653 | `npm run lint && npm run compile && mocha --reporter spec test/*.js` | 
...
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1633 | `mocha` | 
...
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1607 | `npm run lint && npm run mocha` | 
...
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1585 | `./node_modules/mocha/bin/mocha -R spec` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1541 | `npm run mocha && npm run karma` | 
...
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1513 | `mocha --reporter spec --grep .` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1511 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1492 | `npm run mocha && npm run lint` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1442 | `npm run lint && npm run mocha` | 
| [pahen/madge](https://github.com/pahen/madge) | 1440 | `npm run lint && npm run mocha` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1430 | `mocha` | 
| [samccone/drool](https://github.com/samccone/drool) | 1428 | `mocha test/tests.js --timeout=10000` | 
| [Caligatio/jsSHA](https://github.com/Caligatio/jsSHA) | 1407 | `mocha --reporter spec` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1367 | `mocha --reporter spec test/*.js` | 
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1361 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [squaremo/rabbit.js](https://github.com/squaremo/rabbit.js) | 1353 | `./node_modules/mocha/bin/mocha --ui exports test` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1345 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1327 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1316 | `mocha --compilers js:babel-register` | 
...
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1296 | `mocha test.js` | 
| [kss-node/kss-node](https://github.com/kss-node/kss-node) | 1295 | `istanbul cover _mocha` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1293 | `mocha --recursive` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1288 | `standard "src/*.js" && npm run build && mocha` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1278 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1250 | `mocha` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1215 | `mocha tests.js` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1209 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1197 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1189 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [markdalgleish/static-site-generator-webpack-plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin) | 1162 | `istanbul cover _mocha test -- --timeout 20000` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1146 | `mocha test --timeout 600000` | 
...
| [sorrycc/roadhog](https://github.com/sorrycc/roadhog) | 1117 | `npm run lint && npm run build && cross-env NODE_ENV=test nyc mocha --no-timeouts test/**/*-test.js` | 
...
| [btmills/geopattern](https://github.com/btmills/geopattern) | 1085 | `npm run lint && npm run mocha` | 
...
| [patriksimek/node-mssql](https://github.com/patriksimek/node-mssql) | 1057 | `standard && node_modules/.bin/mocha test/common/unit.js` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1020 | `mocha --reporter dot` | 
...
| [frctl/fractal](https://github.com/frctl/fractal) | 1010 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 986 | `NODE_PATH=. mocha **/*.spec.js` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 984 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [hokaccha/node-jwt-simple](https://github.com/hokaccha/node-jwt-simple) | 975 | `istanbul cover _mocha test/*.js` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 933 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 910 | ` NODE_ENV=test mocha --compilers js:babel-register` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 900 | `npm run prepublish && mocha test/test.js` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 898 | `mocha test` | 
...
| [olahol/react-tagsinput](https://github.com/olahol/react-tagsinput) | 852 | `standard src/index.js && mocha --compilers js:babel-register` | 
...
| [kriasoft/universal-router](https://github.com/kriasoft/universal-router) | 794 | `nyc mocha --require babel-register` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 787 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [testdouble/testdouble.js](https://github.com/testdouble/testdouble.js) | 776 | `mocha --ui mocha-given --reporter $npm_package_config_mocha_reporter --compilers js:babel-core/register,coffee:coffee-script --recursive regression/node-helper.coffee regression/src` | 
...
| [start-react/sb-admin-react](https://github.com/start-react/sb-admin-react) | 765 | `mocha "src/**/*.test.js" --require test/setup.js --compilers js:babel-register` | 
...
| [yahoo/blink-diff](https://github.com/yahoo/blink-diff) | 751 | `istanbul cover -- _mocha --reporter spec` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 741 | `npm run lint && mocha --compilers js:babel-register` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 737 | `mocha -R spec --compilers js:babel-core/register ./tests/setup.js ./tests/** --recursive` | 
| [gaearon/react-side-effect](https://github.com/gaearon/react-side-effect) | 737 | `mocha` | 
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 736 | `mocha -t 600000` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 711 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 697 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 679 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require babel-register --no-timeouts` | 
