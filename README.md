...
The list was updated at 02:06:18 12/31/17 PST
...
| --- | --- | --- |
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 39414 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [socketio/socket.io](https://github.com/socketio/socket.io) | 38191 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 35842 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 35392 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28289 | `mocha --reporter spec` | 
| [caolan/async](https://github.com/caolan/async) | 23019 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 19881 | `mocha test/index.js` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17104 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [developit/preact](https://github.com/developit/preact) | 16956 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15246 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 14357 | `mocha test/*.test.js test/**/*.test.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 13911 | `cross-env NODE_ENV=test mocha` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13624 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 12469 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12319 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 11918 | `mocha` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 11734 | `mocha 'test/**/*.spec.js'` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 11675 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11543 | `mocha --reporter spec test/*-test.js` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11368 | `./node_modules/.bin/mocha test/` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 10610 | `cross-env BABEL_ENV=commonjs NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 10488 | `mocha --reporter spec` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10324 | `nyc grunt mocha-and-karma` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 9917 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 9631 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9293 | `mocha --reporter spec` | 
| [tj/co](https://github.com/tj/co) | 9146 | `mocha --harmony` | 
...
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 8880 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 8734 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8732 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8405 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8186 | `mocha test/*-test.js` | 
...
| [dcloudio/mui](https://github.com/dcloudio/mui) | 7965 | `mocha` | 
...
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7566 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
...
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 7370 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7369 | `mocha --compilers js:babel-register test/test.js` | 
| [giakki/uncss](https://github.com/giakki/uncss) | 7201 | `npm run eslint && npm run mocha` | 
| [websockets/ws](https://github.com/websockets/ws) | 7127 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7070 | `npm run build && istanbul cover _mocha` | 
...
| [lovell/sharp](https://github.com/lovell/sharp) | 6954 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 6938 | `mocha tests/*.js` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 6493 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6463 | `mocha $HARMONY_OPTS` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 6446 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6337 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6248 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6229 | `mocha --compilers js:babel-core/register ./packages/*/test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6131 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [almende/vis](https://github.com/almende/vis) | 6063 | `mocha --compilers js:babel-core/register` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6004 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5930 | `mocha` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 5902 | `nyc mocha test/** -r ./test/before` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 5893 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 5771 | `npm run jshint -s && npm run mocha -s && npm run test-components -s && npm run test-components-deprecated -s` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 5741 | `mocha --opts mocha.opts` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5703 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 5651 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation --check-leaks` | 
...
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5431 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
...
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5280 | `mocha && eslint lib/**` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5264 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5259 | `mocha test --recursive` | 
...
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5116 | `mocha test/test.js` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 4809 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4736 | `gulp lint && mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 4727 | `mocha --compilers js:babel-core/register` | 
...
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4590 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
...
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4387 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4368 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [reduxactions/redux-actions](https://github.com/reduxactions/redux-actions) | 4362 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4357 | `gulp build; mocha;` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4279 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4258 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [lebab/lebab](https://github.com/lebab/lebab) | 4119 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4119 | `mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4081 | `mocha` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4004 | `mocha test` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 3994 | `mocha && ./bin/shipit staging test` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 3973 | `mocha` | 
...
| [tj/ejs](https://github.com/tj/ejs) | 3714 | `mocha --require should --reporter spec` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3697 | `mocha --recursive && make test` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3645 | `NODE_ENV=test mocha` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3633 | `npm run jshint && npm run mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3597 | `mocha --require test/babel-hook test/*.js` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 3584 | `npm run build-cli && mocha` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3554 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3408 | `nyc mocha` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3075 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3067 | `mocha --check-leaks --reporter spec --bail` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3065 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
...
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3038 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
...
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 3015 | `mocha; jshint *.js lib` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3000 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 2972 | `node_modules/.bin/mocha test/tests.js` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 2963 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 2923 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 2904 | `nyc mocha "test/**/*.test.js"` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 2898 | `npm run lint && npm run mocha` | 
...
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 2768 | `yarn run build:cjs && mocha --require babel-core/register ./test/index.js` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2663 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2643 | `mocha test/index.js && npm run demo` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2621 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2598 | `nyc mocha && tsc` | 
...
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2551 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2516 | `mocha` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2507 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
...
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2498 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
...
| [expressjs/cors](https://github.com/expressjs/cors) | 2479 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2449 | `mocha --opts mocha.opts` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2447 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2401 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
...
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2347 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [hilongjw/vue-lazyload](https://github.com/hilongjw/vue-lazyload) | 2338 | `npm run compile && mocha --compilers js:babel-core/register` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2335 | `mocha` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2305 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2245 | `mocha -t 30000 -R spec tests/unit/index.js` | 
| [wix/react-templates](https://github.com/wix/react-templates) | 2242 | `mocha test/src/**/*.unit.js` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2234 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2194 | `NODE_ENV=test mocha` | 
...
| [mozilla/send](https://github.com/mozilla/send) | 2145 | `mocha test/unit` | 
...
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2119 | `npm run lint && npm run build && npm run mocha` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2033 | `mocha` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2014 | `mocha --require should --reporter spec` | 
...
| [sandeepmistry/noble](https://github.com/sandeepmistry/noble) | 1914 | `mocha -R spec test/*.js` | 
...
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 1838 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1815 | `mocha test && npm run lint` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1813 | `mocha --require ./test/common --growl test/expect.js` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1812 | `mocha -c test/index.js` | 
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1812 | `mocha` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 1776 | `mocha test.js` | 
| [actionhero/actionhero](https://github.com/actionhero/actionhero) | 1761 | `cross-env NODE_ENV=test mocha` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 1760 | `mocha -R landing test/index` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1727 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1668 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [google/closure-compiler-js](https://github.com/google/closure-compiler-js) | 1646 | `mocha` | 
...
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1611 | `npm run lint && npm run mocha` | 
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1611 | `lint && mocha --recursive` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 1608 | `node ./node_modules/mocha/bin/mocha --reporter spec --full-trace` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1560 | `npm run lint && mocha -R dot && npm run cover` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1557 | `npm run mocha && npm run karma` | 
...
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1531 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1528 | `mocha && npm run lint` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1507 | `nyc npm run _mocha` | 
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1503 | `mocha` | 
| [slackapi/node-slack-sdk](https://github.com/slackapi/node-slack-sdk) | 1503 | `npm run mocha && npm run lint` | 
...
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1465 | `mocha spec/` | 
...
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1396 | `mocha --reporter spec test/*.js` | 
...
| [iurimatias/embark-framework](https://github.com/iurimatias/embark-framework) | 1379 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1333 | `eslint --rulesdir=dev-tools/eslint --cache . && tsc && mocha` | 
...
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1312 | `standard "src/*.js" && npm run build && mocha` | 
...
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1196 | `mocha` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1188 | `mocha test --timeout 600000` | 
...
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1178 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
...
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1167 | `mocha compiled_tests/` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1061 | `mocha` | 
| [neumino/thinky](https://github.com/neumino/thinky) | 1058 | `mocha --check-leaks -t 20000` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1055 | `mocha src/test.js` | 
| [gaearon/babel-plugin-react-transform](https://github.com/gaearon/babel-plugin-react-transform) | 1054 | `mocha --compilers js:babel-register` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1049 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
...
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1006 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1006 | `eslint src && mocha && karma start --single-run` | 
...
| [z-pattern-matching/z](https://github.com/z-pattern-matching/z) | 997 | `NODE_PATH=. mocha **/*.spec.js` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 958 | `NODE_ENV=test mocha-webpack --opts test/mocha-webpack.opts` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 885 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [Ziv-Barber/officegen](https://github.com/Ziv-Barber/officegen) | 877 | `mocha test/test-docx.js test/test-xlsx.js test/test-pptx-nocharts.js test/test-pptx-charts.js` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 844 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [alexa-js/alexa-app](https://github.com/alexa-js/alexa-app) | 766 | `./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 756 | `npm run lint && mocha --compilers js:babel-register` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 745 | `mocha -R spec --compilers js:babel-core/register ./tests/setup.js ./tests/** --recursive` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 744 | `mocha -R spec` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 724 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 719 | `./node_modules/.bin/mocha -R spec` | 
...
| [raineroviir/react-redux-socketio-chat](https://github.com/raineroviir/react-redux-socketio-chat) | 689 | `mocha './test/**/*.test.js' --compilers js:babel-core/register --recursive` | 
