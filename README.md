...
The list was updated at 02:07:03 03/13/18 PDT
...
| [socketio/socket.io](https://github.com/socketio/socket.io) | 39853 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [expressjs/express](https://github.com/expressjs/express) | 37124 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28951 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23524 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22435 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21057 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20328 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18006 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17714 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15697 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15088 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13882 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13357 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12815 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12230 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12160 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12034 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11828 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11759 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11602 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11279 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10752 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10702 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10212 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9821 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9707 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9406 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9405 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9368 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9225 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9172 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 8941 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8613 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8472 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8463 | `mocha test/*-test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8178 | `mocha --check-leaks -R dot` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8166 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8165 | `mocha test/test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8104 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7933 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [websockets/ws](https://github.com/websockets/ws) | 7910 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7895 | `./node_modules/.bin/mocha test/src` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7797 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7773 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7709 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7636 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7399 | `mocha tests/*.js` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7392 | `npm run eslint && npm run mocha` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7201 | `npm run build && istanbul cover _mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7188 | `./node_modules/.bin/mocha test` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7042 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7013 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6815 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6591 | `mocha $HARMONY_OPTS` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6553 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6518 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6494 | `nyc mocha test/**/* -r ./test/before` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6490 | `mocha --opts mocha.opts` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6469 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6400 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6381 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6363 | `mocha --compilers js:babel-core/register` | 
...
| [marko-js/marko](https://github.com/marko-js/marko) | 5996 | `npm run lint -s && npm run mocha -s` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5926 | `mocha` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5905 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5888 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5861 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5766 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5610 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5528 | `mocha tests/node.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5521 | `mocha test --recursive` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5438 | `mocha && eslint lib/**` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5412 | `mocha test/test.js` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5396 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5390 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5269 | `mocha --exit --require babel-core/register` | 
...
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5140 | `mocha src/**/*Tests.js --harmony` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5123 | `mocha` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5043 | `npm run build-cli && mocha` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5041 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4807 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
...
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4672 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [santinic/how2](https://github.com/santinic/how2) | 4642 | `mocha test` | 
| [rmurphey/js-assessment](https://github.com/rmurphey/js-assessment) | 4626 | `mocha -R spec 'tests/app'` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4624 | `mocha --reporter spec -t 8000` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4557 | `standard && mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4535 | `mocha ./test/runner.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4525 | `gulp build; mocha;` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4520 | `mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4467 | `mocha; jshint *.js lib` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4454 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4427 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4394 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4369 | `mocha` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4367 | `./node_modules/.bin/mocha` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4230 | `mocha test` | 
...
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4223 | `mocha` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4218 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [shipitjs/shipit](https://github.com/shipitjs/shipit) | 4101 | `mocha && ./bin/shipit staging test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4017 | `nyc mocha` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3949 | `mocha --recursive && make test` | 
...
| [luin/ioredis](https://github.com/luin/ioredis) | 3881 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3820 | `npm run lint && npm run mocha` | 
...
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3689 | `nyc mocha` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3687 | `mocha -R spec ./test` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3656 | `npm run lint ; mocha && mocha test/individual` | 
...
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3607 | `mocha ./test/*.spec.js` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3581 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [nolanlawson/optimize-js](https://github.com/nolanlawson/optimize-js) | 3556 | `standard && mocha --timeout 60000 test/test.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3556 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3518 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [primus/primus](https://github.com/primus/primus) | 3488 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3462 | `mocha --reporter spec --timeout 3000` | 
...
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3404 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3388 | `npm run lint && npm run mocha` | 
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3367 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3345 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3305 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3233 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3197 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3183 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3176 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3135 | `mocha --check-leaks --bail --no-exit --reporter spec test/` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3124 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
...
| [KartikTalwar/gmail.js](https://github.com/KartikTalwar/gmail.js) | 3070 | `./node_modules/.bin/mocha test/test.*.js` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 3064 | `node_modules/.bin/mocha test/tests.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3026 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 2992 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2984 | `mocha` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2980 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2947 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2869 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2827 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2821 | `nyc mocha && tsc` | 
...
| [Yomguithereal/baobab](https://github.com/Yomguithereal/baobab) | 2789 | `mocha -R spec --require babel-core/register ./test/endpoint.js` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 2771 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
...
| [aui/font-spider](https://github.com/aui/font-spider) | 2752 | `mocha test/index.js && npm run demo` | 
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2742 | `istanbul cover _mocha` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2741 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2741 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2696 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [github-tools/github](https://github.com/github-tools/github) | 2696 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2692 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2689 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2680 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2674 | `mocha` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2652 | `mocha` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2650 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2618 | `mocha --opts mocha.opts` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2617 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2616 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
...
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2582 | `npm run mocha && npm run lint` | 
| [istarkov/google-map-react](https://github.com/istarkov/google-map-react) | 2553 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2542 | `mocha` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2527 | `mocha --recursive --watch` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2526 | `mocha --compilers js:babel-register --recursive spec` | 
| [Reportr/dashboard](https://github.com/Reportr/dashboard) | 2518 | `export TESTING=true; mocha --reporter list` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2513 | `mocha` | 
...
| [developit/unfetch](https://github.com/developit/unfetch) | 2508 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2494 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2472 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2463 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2413 | `NODE_ENV=test mocha` | 
...
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2381 | `node_modules/.bin/mocha --reporter spec` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2369 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2343 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [katiefenn/parker](https://github.com/katiefenn/parker) | 2332 | `mocha --no-colors --reporter spec` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2332 | `nyc mocha` | 
...
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2308 | `mocha test` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2274 | `npm run lint && mocha` | 
| [acdlite/redux-router](https://github.com/acdlite/redux-router) | 2265 | `mocha --compilers js:babel/register --recursive --require src/__tests__/init.js src/**/*-test.js` | 
| [json5/json5](https://github.com/json5/json5) | 2263 | `nyc --reporter=html --reporter=text mocha` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2240 | `export TESTING=true; mocha --reporter list` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2224 | `mocha --require should --reporter spec` | 
...
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2209 | `npm run lint && npm run build && npm run mocha` | 
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2204 | `mocha` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2200 | `mocha --recursive --bail --reporter spec test 2>&1` | 
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2173 | `mocha -R spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2169 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [gajus/swing](https://github.com/gajus/swing) | 2142 | `mocha --compilers js:babel-register` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2095 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2086 | `nyc --reporter=html --reporter=text mocha` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2083 | `mocha` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2081 | `mocha test.js` | 
...
| [carlsednaoui/ouibounce](https://github.com/carlsednaoui/ouibounce) | 2044 | `mocha` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2024 | `mocha -R landing test/index` | 
| [noble/noble](https://github.com/noble/noble) | 2021 | `mocha -R spec test/*.js` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2018 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2018 | `mocha && eslint .` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1974 | `mocha test && npm run lint` | 
| [hojberg/cssarrowplease](https://github.com/hojberg/cssarrowplease) | 1934 | `mocha --require=test/test_helper.js` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1932 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1907 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [Qix-/color](https://github.com/Qix-/color) | 1894 | `mocha` | 
...
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1879 | `mocha --compilers js:babel-register` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1861 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1831 | `mocha test/runner.js --reporter spec` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1822 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
...
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1813 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
...
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1788 | `mocha --compilers js:babel-core/register __tests__` | 
| [then/promise](https://github.com/then/promise) | 1788 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1785 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1776 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
...
| [lipp/login-with](https://github.com/lipp/login-with) | 1750 | `standard && cross-env NODE_ENV=test nyc mocha ./test/*.js` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1734 | `./node_modules/.bin/mocha && npm run jshint` | 
...
| [danvk/source-map-explorer](https://github.com/danvk/source-map-explorer) | 1725 | `mocha && eslint *.js` | 
| [gilbitron/Raneto](https://github.com/gilbitron/Raneto) | 1724 | `npm run lint && mocha --reporter spec test/*.js` | 
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1718 | `mocha test` | 
| [trailsjs/trails](https://github.com/trailsjs/trails) | 1715 | `eslint --ignore-path .gitignore index.js lib/ test/ && nyc mocha` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1708 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1707 | `mocha -R spec spec spec/reporters` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1700 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [Automattic/juice](https://github.com/Automattic/juice) | 1693 | `mocha --reporter spec && npm run test-typescript` | 
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1692 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
...
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1682 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1679 | `nyc npm run _mocha` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1621 | `mocha` | 
...
| [glenjamin/webpack-hot-middleware](https://github.com/glenjamin/webpack-hot-middleware) | 1604 | `mocha` | 
...
| [ashtuchkin/iconv-lite](https://github.com/ashtuchkin/iconv-lite) | 1595 | `mocha --reporter spec --grep .` | 
| [pahen/madge](https://github.com/pahen/madge) | 1587 | `npm run lint && npm run mocha` | 
...
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1575 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1575 | `mocha tests --compilers js:babel-core/register` | 
...
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1552 | `mocha ./test/basic.js -t 5000` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1549 | `./node_modules/.bin/mocha` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1546 | `mocha --reporter spec test/*.js` | 
...
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1536 | `mocha test --timeout 600000` | 
...
| [helpers/handlebars-helpers](https://github.com/helpers/handlebars-helpers) | 1506 | `mocha` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1461 | `mocha --compilers js:babel-register` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1419 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1412 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1404 | `mocha --check-leaks -R dot` | 
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1402 | `nyc mocha` | 
...
| [sasstools/sass-lint](https://github.com/sasstools/sass-lint) | 1395 | `istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -R spec -t 3000 tests tests/rules tests/helpers` | 
...
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1375 | `eslint . && mocha -t 5000` | 
...
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1361 | `mocha --recursive` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1359 | `mocha` | 
...
| [expressjs/compression](https://github.com/expressjs/compression) | 1346 | `mocha --check-leaks --reporter spec --bail` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1344 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1335 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [webpack-contrib/npm-install-webpack-plugin](https://github.com/webpack-contrib/npm-install-webpack-plugin) | 1330 | `cross-env NODE_ENV=test nyc mocha` | 
| [kss-node/kss-node](https://github.com/kss-node/kss-node) | 1330 | `istanbul cover _mocha` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1325 | `mocha compiled_tests/` | 
| [adleroliveira/dreamjs](https://github.com/adleroliveira/dreamjs) | 1323 | `mocha` | 
| [speakeasyjs/speakeasy](https://github.com/speakeasyjs/speakeasy) | 1316 | `mocha` | 
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1309 | `mocha test/setup.js test/spec/*.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1303 | `nyc npm run mocha` | 
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1295 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
...
| [twigjs/twig.js](https://github.com/twigjs/twig.js) | 1287 | `npm run build && mocha -r should` | 
...
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1246 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
...
| [donejs/donejs](https://github.com/donejs/donejs) | 1224 | `npm run jshint && npm run mocha && npm run document && npm run test-guides` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1212 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1209 | `mocha --recursive` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1203 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
...
| [oracle/node-oracledb](https://github.com/oracle/node-oracledb) | 1187 | `mocha --opts test/opts/mocha.opts` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1171 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1153 | `mocha` | 
...
| [rwieruch/favesound-redux](https://github.com/rwieruch/favesound-redux) | 1137 | `mocha --compilers js:babel-core/register --require ./test/setup.js 'src/**/spec.js'` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1132 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1130 | `mocha test/unit` | 
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1129 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
...
| [archiverjs/node-archiver](https://github.com/archiverjs/node-archiver) | 1123 | `mocha --reporter dot` | 
...
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1114 | `node_modules/.bin/mocha` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1108 | `mocha test` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1108 | `eslint src && mocha && karma start --single-run` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1101 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1083 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [yanyiwu/nodejieba](https://github.com/yanyiwu/nodejieba) | 1082 | `node test/demo.js && node test/load_dict_demo.js && mocha --timeout 10s -R spec test/test.js && mocha --timeout 10s -R spec test/load_dict_test.js` | 
...
| [brigand/react-mixin](https://github.com/brigand/react-mixin) | 1067 | `mocha test/*` | 
...
| [babel/gulp-babel](https://github.com/babel/gulp-babel) | 1060 | `xo && mocha` | 
...
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1057 | `nyc mocha --timeout=20000 test.js` | 
...
| [hokaccha/node-jwt-simple](https://github.com/hokaccha/node-jwt-simple) | 1027 | `istanbul cover _mocha test/*.js` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1020 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
| [immersive-web/webvr-polyfill](https://github.com/immersive-web/webvr-polyfill) | 1018 | `mocha -r test/init.js --compilers js:babel-core/register test/*.test.js` | 
...
| [YuzuJS/setImmediate](https://github.com/YuzuJS/setImmediate) | 1009 | `mocha test/tests.js` | 
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1004 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 993 | `npm run prepublishOnly && mocha test/test.js` | 
...
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 988 | `mocha` | 
...
| [levelgraph/levelgraph](https://github.com/levelgraph/levelgraph) | 979 | `mocha --recursive --bail --reporter spec test` | 
...
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 968 | `mocha --recursive test` | 
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 966 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 964 | `mocha --compilers js:babel-core/register` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 957 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [SelectTransform/st.js](https://github.com/SelectTransform/st.js) | 957 | `mocha --recursive test/unit/` | 
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 956 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 945 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 944 | `mocha -t 120000 test/*.test.js` | 
...
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 943 | `webpack && mocha test/unit` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 942 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 939 | `mocha -R spec ./test/unit/**` | 
| [LinusU/node-appdmg](https://github.com/LinusU/node-appdmg) | 939 | `standard && mocha -b` | 
| [electron/asar](https://github.com/electron/asar) | 935 | `xvfb-maybe electron-mocha --reporter spec && mocha --reporter spec && npm run lint` | 
...
| [expressjs/generator](https://github.com/expressjs/generator) | 927 | `nyc mocha` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 924 | `mocha tests/*.js` | 
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 922 | `mocha` | 
| [pid/speakingurl](https://github.com/pid/speakingurl) | 915 | `mocha` | 
...
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 911 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 902 | `mocha` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 900 | `npm run lint && npm run mocha` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 892 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
...
| [domenic/sinon-chai](https://github.com/domenic/sinon-chai) | 884 | `mocha` | 
...
| [krasimir/webpack-library-starter](https://github.com/krasimir/webpack-library-starter) | 876 | `mocha --require babel-core/register --colors ./test/*.spec.js` | 
...
| [expressjs/serve-static](https://github.com/expressjs/serve-static) | 868 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 857 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
| [erelsgl/limdu](https://github.com/erelsgl/limdu) | 857 | `mocha` | 
| [reactivestack/cookies](https://github.com/reactivestack/cookies) | 856 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 856 | `mocha ./test -R spec` | 
| [open-xml-templating/docxtemplater](https://github.com/open-xml-templating/docxtemplater) | 855 | `npm run convertto:es5 && npm run mocha` | 
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 855 | `npm run lint && mocha --require @babel/register` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 825 | `mocha -R spec` | 
...
| [alexa-js/alexa-app](https://github.com/alexa-js/alexa-app) | 816 | `./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [auth0-community/socketio-jwt](https://github.com/auth0-community/socketio-jwt) | 805 | `mocha` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 802 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 798 | `mocha` | 
...
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 796 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [digitalbazaar/jsonld.js](https://github.com/digitalbazaar/jsonld.js) | 783 | `cross-env NODE_ENV=test mocha --delay -t 30000 -A -R ${REPORTER:-spec} tests/test.js` | 
...
| [shanelau/zhihu](https://github.com/shanelau/zhihu) | 775 | `./node_modules/mocha/bin/mocha --timeout 15000` | 
| [GitbookIO/nuts](https://github.com/GitbookIO/nuts) | 771 | `mocha --reporter list` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 770 | `npm run mocha:istanbul` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 768 | `./node_modules/.bin/mocha -R spec` | 
...
| [jhusain/eslint-plugin-immutable](https://github.com/jhusain/eslint-plugin-immutable) | 729 | `mocha --recursive -s 15 test/` | 
...
| [joshwcomeau/panther](https://github.com/joshwcomeau/panther) | 698 | `NODE_ENV=test mocha --compilers js:babel-core/register --require ./test/test-helper.js --recursive` | 
