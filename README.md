...
The list was updated at 02:07:09 08/13/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 43147 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 41113 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 39639 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 30082 | `mocha --async-only` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 25689 | `cross-env NODE_ENV=test mocha` | 
| [caolan/async](https://github.com/caolan/async) | 24447 | `npm run lint && npm run mocha-node-test` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 23133 | `mocha test/index.js` | 
| [developit/preact](https://github.com/developit/preact) | 19697 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 18936 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 16775 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 16528 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 15134 | `node_modules/.bin/mocha test/*.*.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 14321 | `nyc --reporter=html --reporter=text mocha` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13932 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 13438 | `cross-env BABEL_ENV=cjs mocha --require babel-register --reporter spec` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 13111 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [highlightjs/highlight.js](https://github.com/highlightjs/highlight.js) | 12683 | `./node_modules/.bin/mocha test/` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12626 | `mocha 'test/**/*.spec.js'` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 12300 | `mocha --reporter spec test/*-test.js` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12235 | `mocha` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 11764 | `istanbul cover _mocha` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 11464 | `nyc grunt mocha-and-karma` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 11116 | `nyc --reporter=text --reporter lcov npm run test:mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 11109 | `mocha --reporter dot` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 10425 | `mocha test/index.js` | 
| [svg/svgo](https://github.com/svg/svgo) | 10095 | `set NODE_ENV=test && mocha` | 
| [RelaxedJS/ReLaXed](https://github.com/RelaxedJS/ReLaXed) | 10094 | `mocha` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 10083 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [tj/co](https://github.com/tj/co) | 10015 | `mocha --harmony` | 
| [reduxjs/redux-devtools](https://github.com/reduxjs/redux-devtools) | 9941 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 9628 | `mocha` | 
| [reduxjs/redux-thunk](https://github.com/reduxjs/redux-thunk) | 9584 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9365 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 9329 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 9067 | `nyc --reporter=text --reporter=lcov npm run mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 9019 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8985 | `grunt mocha` | 
| [amark/gun](https://github.com/amark/gun) | 8696 | `mocha` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8677 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 8625 | `mocha tests/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8487 | `mocha test/test.js` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 8445 | `mocha test/src` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8428 | `mocha --check-leaks -R dot` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8316 | `grunt clean:test && mocha --exit` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 8226 | `cross-env BABEL_ENV=test FORBID_DEPRECATIONS=true mocha --require babel-core/register ./packages/*/test/index.js` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 8162 | `mocha --compilers js:babel-register test/test.js` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 8055 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7961 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7891 | `npm run eslint && npm run mocha` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 7754 | `mocha --opts mocha.opts` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7689 | `./node_modules/.bin/mocha test` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 7559 | `npm run pre_test && nyc mocha --exit --check-leaks -t 10000 -R spec test/index.js && npm run tape` | 
...
| [aui/art-template](https://github.com/aui/art-template) | 7219 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 7196 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 7187 | `eslint lib/**/*.js test/**/*.js index.js && mocha --exit --require should --reporter spec --check-leaks` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 7036 | `xo && mocha test/*.js --timeout 100000` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 7008 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [almende/vis](https://github.com/almende/vis) | 6968 | `mocha --compilers js:babel-core/register` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6879 | `mocha $HARMONY_OPTS` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6815 | `mocha --timeout 10000 ./test/*/*.test.js` | 
| [remoteintech/remote-jobs](https://github.com/remoteintech/remote-jobs) | 6658 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 6440 | `npm run jshint && mocha test/` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 6393 | `mocha; jshint *.js lib` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 6319 | `mocha --exit --require babel-core/register` | 
...
| [cazala/synaptic](https://github.com/cazala/synaptic) | 6215 | `npm run test:mocha:src` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 6178 | `mocha test/test.js` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5410 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 5318 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5150 | `mocha --color` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 5135 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4963 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4951 | `gulp lint && mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4943 | `mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4840 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4740 | `gulp build; mocha;` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 5318 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 5271 | `standard && mocha` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5175 | `mocha src/**/*Tests.js --harmony` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5150 | `mocha --color` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 5135 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 5083 | `npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4963 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4951 | `gulp lint && mocha` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4943 | `mocha` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4840 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
...
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4728 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [sintaxi/harp](https://github.com/sintaxi/harp) | 4694 | `mocha --reporter spec -t 8000` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4610 | `./node_modules/.bin/mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4567 | `mocha ./test/runner.js` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 4535 | `NODE_ENV=test mocha --timeout 8000 -r ts-node/register --exit` | 
...
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4412 | `mocha --recursive` | 
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 4411 | `nyc mocha --exit` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4402 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 4396 | `npm run lint && npm run mocha` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 4165 | `npm run lint && npm run mocha` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4139 | `nyc mocha` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 4130 | `mocha -R spec src` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 4088 | `nyc mocha` | 
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 4060 | `node_modules/.bin/mocha test/tests.js` | 
...
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3992 | `npm run lint ; mocha && mocha test/individual` | 
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3991 | `mocha --timeout=15000 tests/*.test.js` | 
...
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3860 | `cross-env NODE_ENV=test mocha --require babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 3773 | `mocha --require babel-core/register './src/**/*.spec.js'` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 3771 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3768 | `npm run lint && mocha --recursive --colors --reporter spec` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3746 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3702 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
...
| [expressjs/session](https://github.com/expressjs/session) | 3609 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3578 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3541 | `mocha --reporter spec --timeout 3000` | 
...
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3504 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 3431 | `NODE_ENV=test mocha test/**/*.js` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 3332 | `cross-env BABEL_ENV=test mocha --require babel-register test/test.js` | 
| [express-validator/express-validator](https://github.com/express-validator/express-validator) | 3234 | `nyc mocha && tsc` | 
| [expressjs/body-parser](https://github.com/expressjs/body-parser) | 3233 | `mocha --require test/support/env --reporter spec --check-leaks --bail test/` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 3231 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [lambci/lambci](https://github.com/lambci/lambci) | 3165 | `mocha` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 3151 | `./node_modules/.bin/mocha tests/*.js --exit` | 
...
| [kenwheeler/cash](https://github.com/kenwheeler/cash) | 3111 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 3171 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 3165 | `mocha` | 
| [o1lab/xmysql](https://github.com/o1lab/xmysql) | 3151 | `./node_modules/.bin/mocha tests/*.js --exit` | 
| [codemix/fast.js](https://github.com/codemix/fast.js) | 3142 | `mocha` | 
...
| [broccolijs/broccoli](https://github.com/broccolijs/broccoli) | 3129 | `mocha` | 
| [kenwheeler/cash](https://github.com/kenwheeler/cash) | 3111 | `gulp builder; ./node_modules/istanbul/lib/cli.js cover --root './dist' -x './dist/lib/sugar.js' _mocha -- -R spec && npm run lint` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 3095 | `export TESTING=true; mocha --reporter list` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 3052 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 3047 | `mocha` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 3041 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
...
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 3017 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2973 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2957 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests --exclude "tests/unit/relations/files/**"` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2889 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2885 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2875 | `mocha -R spec --recursive src/test` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2874 | `mocha` | 
| [konvajs/konva](https://github.com/konvajs/konva) | 2868 | `mocha-headless-chrome -f ./test/runner.html -a disable-web-security` | 
...
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2844 | `mocha` | 
...
| [react-webpack-generators/generator-react-webpack](https://github.com/react-webpack-generators/generator-react-webpack) | 2825 | `istanbul cover _mocha` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2817 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2817 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2804 | `npm run mocha && npm run lint` | 
...
| [digitalbazaar/forge](https://github.com/digitalbazaar/forge) | 2645 | `cross-env NODE_ENV=test mocha -t 30000 -R ${REPORTER:-spec} tests/unit/index.js` | 
| [jaredhanson/oauth2orize](https://github.com/jaredhanson/oauth2orize) | 2627 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2622 | `mocha test.js` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 2615 | `eslint . && mocha -t 5000` | 
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2610 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2522 | `mocha` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 2209 | `mocha test/ --no-timeouts` | 
| [noble/noble](https://github.com/noble/noble) | 2190 | `mocha -R spec test/*.js` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 2173 | `mocha --compilers js:babel-register` | 
...
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 2103 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [paulsonnentag/swip](https://github.com/paulsonnentag/swip) | 2097 | `mocha` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 2088 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
| [h2non/toxy](https://github.com/h2non/toxy) | 2487 | `standard index.js 'lib/**/*.js' 'test/**/*.js' && mocha --timeout 5000 --bail --reporter spec --ui tdd 'test/**/*.js'` | 
| [spdy-http2/node-spdy](https://github.com/spdy-http2/node-spdy) | 2471 | `mocha --reporter=spec test/*-test.js` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2454 | `mocha test` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2442 | `mocha --recursive --bail --reporter spec test 2>&1` | 
...
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2385 | `nyc --reporter=html --reporter=text mocha` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2347 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2316 | `mocha -R spec` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 2209 | `mocha test/ --no-timeouts` | 
| [kach/nearley](https://github.com/kach/nearley) | 1886 | `mocha test/*.test.js` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1877 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1836 | `mocha --reporter spec && npm run test-typescript` | 
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1831 | `npm run mocha && npm run karma` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1822 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1820 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [diegonetto/generator-ionic](https://github.com/diegonetto/generator-ionic) | 1802 | `mocha --timeout 5000` | 
| [seaneking/rucksack](https://github.com/seaneking/rucksack) | 1800 | `mocha test` | 
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1800 | `mocha && npm run lint` | 
...
| [webpack-contrib/webpack-hot-middleware](https://github.com/webpack-contrib/webpack-hot-middleware) | 1778 | `mocha` | 
| [simplecrawler/simplecrawler](https://github.com/simplecrawler/simplecrawler) | 1760 | `npm run lint && npm run mocha` | 
| [flitbit/diff](https://github.com/flitbit/diff) | 1755 | `mocha test/**/*.js` | 
...
| [booleanhunter/ReactJS-AdminLTE](https://github.com/booleanhunter/ReactJS-AdminLTE) | 1733 | `mocha test -u bdd -R spec` | 
...
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1700 | `mocha ./test/basic.js -t 5000` | 
...
| [freeCodeCamp/guide](https://github.com/freeCodeCamp/guide) | 1678 | `yarn ensure-page-naming && mocha  -R spec "./{,!(node_modules)/**/}*.test.js"` | 
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1677 | `mocha test/*.js` | 
...
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1663 | `npm run lint && npm run mocha` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1642 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1640 | `mocha compiled_tests/` | 
...
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1619 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1640 | `mocha compiled_tests/` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1573 | `mocha test` | 
| [node-webot/weixin-robot](https://github.com/node-webot/weixin-robot) | 1570 | `./node_modules/mocha/bin/mocha -R spec` | 
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1568 | `eslint --cache . && tsc && mocha` | 
| [zeit/ms](https://github.com/zeit/ms) | 1567 | `mocha tests.js` | 
...
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1525 | `mocha test.js` | 
...
| [retejs/rete](https://github.com/retejs/rete) | 1478 | `BABEL_ENV=test mocha --compilers js:babel-core/register` | 
...
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1417 | `mocha --timeout 10000 ./tests/lib.js` | 
...
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1368 | `mocha test/unit` | 
...
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 1358 | `TEST=all mocha` | 
| [electron/devtron](https://github.com/electron/devtron) | 1348 | `mocha test/unit/*-test.js test/integration/*-test.js && standard` | 
| [frctl/fractal](https://github.com/frctl/fractal) | 1348 | `./node_modules/.bin/_mocha --require test/support/env --reporter spec` | 
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1347 | `mocha` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1337 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
| [oracle/node-oracledb](https://github.com/oracle/node-oracledb) | 1335 | `mocha --opts test/opts/mocha.opts` | 
| [markdalgleish/static-site-generator-webpack-plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin) | 1332 | `istanbul cover _mocha test -- --timeout 20000` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1320 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1318 | `mocha tests/test-*` | 
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1317 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1317 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [yyx990803/pod](https://github.com/yyx990803/pod) | 1309 | `mocha test/api.js -r jscoverage -R spec --slow 1250 --timeout 5000 && bash test/cli.sh` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1307 | `standard && istanbul cover _mocha` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 1277 | `NODE_ENV=test mocha tests/*.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 1263 | `mocha ./test/test*.js --reporter spec` | 
| [donejs/donejs](https://github.com/donejs/donejs) | 1261 | `npm run jshint && npm run mocha && npm run document && npm run test-guides` | 
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1260 | `mocha -R spec ./test/unit/**` | 
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1259 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
| [yanyiwu/nodejieba](https://github.com/yanyiwu/nodejieba) | 1257 | `node test/demo.js && node test/load_dict_demo.js && mocha --timeout 10s -R spec test/test.js && mocha --timeout 10s -R spec test/load_dict_test.js` | 
...
| [domenic/chai-as-promised](https://github.com/domenic/chai-as-promised) | 1252 | `mocha` | 
...
| [shakiba/stage.js](https://github.com/shakiba/stage.js) | 1248 | `mocha test/*.js` | 
...
| [firebase/firebase-tools](https://github.com/firebase/firebase-tools) | 1243 | `npm run lint && npm run mocha` | 
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1242 | `mocha --check-leaks --reporter spec --bail test/` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 1236 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [web-push-libs/web-push](https://github.com/web-push-libs/web-push) | 1226 | `node --harmony node_modules/.bin/istanbul cover node_modules/.bin/_mocha -- --ui tdd test/test*` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1220 | `mocha src/test.js` | 
| [coryhouse/pluralsight-redux-starter](https://github.com/coryhouse/pluralsight-redux-starter) | 1217 | `mocha --reporter progress tools/testSetup.js "src/**/*.test.js"` | 
...
| [Tencent/TSW](https://github.com/Tencent/TSW) | 1214 | `mocha --recursive test/bin` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 1192 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 1159 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [primus/eventemitter3](https://github.com/primus/eventemitter3) | 1143 | `nyc --reporter=html --reporter=text mocha test/test.js` | 
...
| [zeeshanu/dumper.js](https://github.com/zeeshanu/dumper.js) | 1132 | `./node_modules/.bin/istanbul cover node_modules/mocha/bin/_mocha && ./node_modules/.bin/codecov` | 
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 1128 | `webpack && npm run lint && npm run mocha` | 
...
| [Ziv-Barber/officegen](https://github.com/Ziv-Barber/officegen) | 1121 | `mocha test/test-docx.js test/test-xlsx.js test/test-pptx-nocharts.js test/test-pptx-charts.js` | 
...
| [vuejs/babel-plugin-transform-vue-jsx](https://github.com/vuejs/babel-plugin-transform-vue-jsx) | 1116 | `npm run lint && mocha --require @babel/register` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 1110 | `npm run mocha:istanbul` | 
| [vuejs/vueify](https://github.com/vuejs/vueify) | 1109 | `eslint index.js lib && mocha test/test.js --slow=5000 --timeout=10000` | 
...
| [openstyles/stylus](https://github.com/openstyles/stylus) | 1095 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 1067 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 1072 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 1067 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
...
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 1037 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
| [yeoman/generator-webapp_DEPRECATED](https://github.com/yeoman/generator-webapp_DEPRECATED) | 1037 | `mocha --reporter spec --timeout 3000` | 
| [electron/spectron](https://github.com/electron/spectron) | 1026 | `mocha && standard` | 
| [sghall/resonance](https://github.com/sghall/resonance) | 1023 | `cross-env NODE_ENV=test BABEL_ENV=test mocha "src/**/*.spec.js"` | 
| [justadudewhohacks/face-recognition.js](https://github.com/justadudewhohacks/face-recognition.js) | 1022 | `mocha --timeout 30000 --recursive ./tests` | 
| [tomas/needle](https://github.com/tomas/needle) | 1021 | `mocha test` | 
...
| [jeremyckahn/shifty](https://github.com/jeremyckahn/shifty) | 909 | `mocha test` | 
| [ryanflorence/ember-tools](https://github.com/ryanflorence/ember-tools) | 907 | `node_modules/.bin/mocha --require should --reporter dot --ui bdd --growl $(find test -name "*.spec.js")` | 
| [symfony/webpack-encore](https://github.com/symfony/webpack-encore) | 904 | `./node_modules/.bin/mocha --reporter spec test --recursive` | 
...
| [lmatteis/peer-tweet](https://github.com/lmatteis/peer-tweet) | 884 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive --require ./test/setup.js test/**/*.spec.js` | 
| [alexa-js/alexa-app](https://github.com/alexa-js/alexa-app) | 884 | `./node_modules/.bin/mocha --compilers js:babel-core/register` | 
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 883 | `mocha test` | 
...
| [pantsel/konga](https://github.com/pantsel/konga) | 857 | `mocha` | 
| [mikemintz/react-rethinkdb](https://github.com/mikemintz/react-rethinkdb) | 857 | `eslint test && mocha --compilers js:babel/register` | 
| [tj/node-migrate](https://github.com/tj/node-migrate) | 856 | `standard && standard ./bin/* && mocha` | 
...
| [kisenka/svg-sprite-loader](https://github.com/kisenka/svg-sprite-loader) | 851 | `nyc --check-coverage mocha test/*.test.js` | 
...
| [zzarcon/microm](https://github.com/zzarcon/microm) | 851 | `mocha-phantomjs -s localToRemoteUrlAccessEnabled=true -s webSecurityEnabled=false --reporter spec test/runner.html` | 
| [sliptree/bootstrap-tokenfield](https://github.com/sliptree/bootstrap-tokenfield) | 847 | `mocha --ui bdd --recursive --reporter spec --require must` | 
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 842 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
| [auth0-community/socketio-jwt](https://github.com/auth0-community/socketio-jwt) | 842 | `mocha` | 
| [mridgway/hoist-non-react-statics](https://github.com/mridgway/hoist-non-react-statics) | 841 | `mocha tests/unit/ --recursive --compilers js:babel-register --reporter spec` | 
...
| [johnagan/clean-webpack-plugin](https://github.com/johnagan/clean-webpack-plugin) | 834 | `mocha --recursive ./test/*_spec.js` | 
...
| [acss-io/atomizer](https://github.com/acss-io/atomizer) | 783 | `./node_modules/.bin/mocha tests/ --recursive --reporter spec` | 
...
| [apollographql/graphql-tag](https://github.com/apollographql/graphql-tag) | 776 | `mocha test/graphql.js test/graphql-v0.12.js && tav --ci --compat` | 
...
| [gulpjs/vinyl-fs](https://github.com/gulpjs/vinyl-fs) | 806 | `mocha --async-only` | 
...
| [jaredhanson/passport-http-bearer](https://github.com/jaredhanson/passport-http-bearer) | 755 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [nodesecurity/eslint-plugin-security](https://github.com/nodesecurity/eslint-plugin-security) | 751 | `./node_modules/.bin/mocha test/**/*` | 
| [troybetz/react-youtube](https://github.com/troybetz/react-youtube) | 743 | `mocha` | 
| [schrodinger/fixed-data-table-2](https://github.com/schrodinger/fixed-data-table-2) | 740 | `mocha-webpack --webpack-config webpack.config-test.js "src/**/*-test.js" --require build_helpers/test-globals.js` | 
...
| [jhusain/eslint-plugin-immutable](https://github.com/jhusain/eslint-plugin-immutable) | 756 | `mocha --recursive -s 15 test/` | 
| [jaredhanson/passport-http-bearer](https://github.com/jaredhanson/passport-http-bearer) | 755 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
| [mthenw/frontail](https://github.com/mthenw/frontail) | 753 | `mocha -r should --reporter spec test/*.js` | 
| [bjornharrtell/jsts](https://github.com/bjornharrtell/jsts) | 752 | `NODE_PATH=src nyc mocha --timeout 10s -r esm --recursive test/auto/node test/manual` | 
...
| [erikolson186/zangodb](https://github.com/erikolson186/zangodb) | 716 | `mocha --reporter spec build/test/index.js` | 
...
| [erikras/redux-form-material-ui](https://github.com/erikras/redux-form-material-ui) | 706 | `mocha --compilers js:babel-register --recursive --recursive "src/**/__tests__/*" --require src/__tests__/setup.js` | 
