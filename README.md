...
The list was updated at 02:07:04 03/20/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40028 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40007 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [expressjs/express](https://github.com/expressjs/express) | 37228 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 28999 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23573 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22536 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21176 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 20569 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18087 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17769 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15750 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15157 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13901 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13431 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 12878 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12293 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12187 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12046 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11874 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11791 | `mocha --reporter spec test/*-test.js` | 
| [reactjs/react-redux](https://github.com/reactjs/react-redux) | 11711 | `cross-env BABEL_ENV=test NODE_ENV=test mocha --recursive --require babel-register --require ./test/setup.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11356 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 10853 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10742 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10287 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 9867 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9759 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9448 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9438 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9395 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9262 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9217 | `set NODE_ENV=test && mocha` | 
...
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8641 | `grunt mocha` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8528 | `mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8487 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8240 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8205 | `mocha --check-leaks -R dot` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8181 | `mocha test/test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8115 | `grunt clean:test && mocha --exit` | 
| [websockets/ws](https://github.com/websockets/ws) | 7998 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 7979 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 7927 | `./node_modules/.bin/mocha test/src` | 
...
| [reactide/reactide](https://github.com/reactide/reactide) | 7804 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7761 | `mocha` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7720 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7566 | `npm run eslint && npm run mocha` | 
...
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7441 | `mocha tests/*.js` | 
| [rstacruz/jquery.transit](https://github.com/rstacruz/jquery.transit) | 7438 | `mocha` | 
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7225 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7221 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7088 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7060 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 6876 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6607 | `mocha $HARMONY_OPTS` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6571 | `nyc mocha test/**/* -r ./test/before` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6571 | `xo && mocha test/*.js --timeout 100000` | 
| [aui/art-template](https://github.com/aui/art-template) | 6548 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6534 | `mocha --opts mocha.opts` | 
| [visionmedia/supertest](https://github.com/visionmedia/supertest) | 6498 | `eslint lib/**/*.js test/**/*.js && mocha --require should --reporter spec --check-leaks` | 
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6442 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6429 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
| [almende/vis](https://github.com/almende/vis) | 6393 | `mocha --compilers js:babel-core/register` | 
| [marko-js/marko](https://github.com/marko-js/marko) | 6013 | `npm run lint -s && npm run mocha -s` | 
| [angular-fullstack/generator-angular-fullstack](https://github.com/angular-fullstack/generator-angular-fullstack) | 6004 | `mocha --require should --require babel-register --require ./mocha.conf --reporter spec --timeout 120000 test/pre.test.js test/*.test.js` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 5966 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
| [mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) | 5929 | `./node_modules/.bin/istanbul cover ./node_modules/.bin/_mocha -- --compilers js:babel-register --require babel-polyfill --recursive test/unit` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5927 | `mocha` | 
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5881 | `npm run test:mocha:src` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5792 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5619 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5556 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5549 | `mocha tests/node.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5459 | `mocha && eslint lib/**` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5447 | `mocha test/test.js` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5418 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5394 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5306 | `mocha --exit --require babel-core/register` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5176 | `mocha` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5175 | `npm run build-cli && mocha` | 
...
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5072 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4846 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4790 | `gulp lint && mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4769 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4755 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4696 | `mocha --compilers js:babel-register src/**/*-test.js` | 
...
| [expressjs/multer](https://github.com/expressjs/multer) | 4595 | `standard && mocha` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4587 | `mocha; jshint *.js lib` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4577 | `mocha` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4535 | `mocha ./test/runner.js` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4534 | `gulp build; mocha;` | 
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4502 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4468 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4402 | `mocha` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4392 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4379 | `./node_modules/.bin/mocha` | 
...
| [yargs/yargs](https://github.com/yargs/yargs) | 4252 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4248 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4240 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4237 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4023 | `nyc mocha` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 3977 | `mocha --recursive && make test` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3916 | `mocha --require test/babel-hook test/*.js` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3903 | `NODE_ENV=test mocha` | 
...
| [agenda/agenda](https://github.com/agenda/agenda) | 3849 | `npm run lint && npm run mocha` | 
...
| [paulmillr/chokidar](https://github.com/paulmillr/chokidar) | 3804 | `istanbul test node_modules/mocha/bin/_mocha` | 
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3712 | `mocha -R spec ./test` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3703 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3674 | `npm run lint ; mocha && mocha test/individual` | 
| [jspm/jspm-cli](https://github.com/jspm/jspm-cli) | 3642 | `npm run jshint && npm run mocha` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3632 | `mocha ./test/*.spec.js` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3631 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [jsbin/jsbin](https://github.com/jsbin/jsbin) | 3629 | `node_modules/mocha/bin/_mocha -t 25000 --ui bdd test/unit/**/*.test.js` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3595 | `mocha -r intelli-espower-loader -t 20000 test` | 
...
| [bda-research/node-crawler](https://github.com/bda-research/node-crawler) | 3536 | `./node_modules/mocha/bin/mocha --reporter spec --bail --timeout 10000 tests/*.js` | 
| [primus/primus](https://github.com/primus/primus) | 3497 | `npm run build && mocha test/*.test.js` | 
| [yeoman/generator-webapp](https://github.com/yeoman/generator-webapp) | 3466 | `mocha --reporter spec --timeout 3000` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3451 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3436 | `npm run lint && npm run mocha` | 
| [node-apn/node-apn](https://github.com/node-apn/node-apn) | 3418 | `node_modules/.bin/mocha` | 
...
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3373 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3362 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
| [expressjs/morgan](https://github.com/expressjs/morgan) | 3334 | `mocha --check-leaks --reporter spec --bail` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3248 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3212 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3199 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3197 | `nyc mocha "test/**/*.test.js"` | 
| [expressjs/session](https://github.com/expressjs/session) | 3166 | `mocha --require test/support/env --check-leaks --bail --no-exit --reporter spec test/` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3144 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
...
| [ecrmnn/collect.js](https://github.com/ecrmnn/collect.js) | 3074 | `node_modules/.bin/mocha test/tests.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3044 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3028 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [ttezel/twit](https://github.com/ttezel/twit) | 2995 | `./node_modules/.bin/mocha tests/* -t 70000 -R spec --bail --globals domain,_events,_maxListeners` | 
| [lambci/lambci](https://github.com/lambci/lambci) | 2993 | `mocha` | 
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 2981 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [googlesamples/md2googleslides](https://github.com/googlesamples/md2googleslides) | 2940 | `npm run compile && mocha --compilers js:babel-core/register --timeout 5000` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2908 | `mocha test/*.js` | 
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2896 | `NODE_ENV=test mocha test/**/*.js` | 
| [heroku/react-refetch](https://github.com/heroku/react-refetch) | 2872 | `mocha --compilers js:babel-core/register --recursive --require ./test/setup.js` | 
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2869 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2843 | `nyc mocha && tsc` | 
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2817 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [sitespeedio/sitespeed.io](https://github.com/sitespeedio/sitespeed.io) | 2780 | `mocha` | 
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2775 | `mocha -R spec --recursive src/test` | 
| [nadbm/react-datasheet](https://github.com/nadbm/react-datasheet) | 2775 | `standard src/*.js && NODE_ENV=test nyc --  mocha ./test/**/*.js --compilers js:babel-register` | 
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2770 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
| [aui/font-spider](https://github.com/aui/font-spider) | 2769 | `mocha test/index.js && npm run demo` | 
| [expressjs/cors](https://github.com/expressjs/cors) | 2769 | `npm run lint && nyc --reporter=html --reporter=text mocha` | 
...
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2725 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) | 2719 | `jshint src/ua-parser.js && mocha -R nyan test/test.js` | 
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2710 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [jsoma/tabletop](https://github.com/jsoma/tabletop) | 2698 | `node node_modules/mocha/bin/mocha --timeout 5000 && node node_modules/nsp/bin/nsp check` | 
| [github-tools/github](https://github.com/github-tools/github) | 2698 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2688 | `mocha` | 
...
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2674 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
| [taskrabbit/elasticsearch-dump](https://github.com/taskrabbit/elasticsearch-dump) | 2672 | `mocha` | 
| [GetStream/Winds](https://github.com/GetStream/Winds) | 2652 | `NODE_ENV=testing node ./node_modules/mocha/bin/mocha test/bootstrap.test.js test/integration/**/*.test.js` | 
| [Yomguithereal/react-blessed](https://github.com/Yomguithereal/react-blessed) | 2650 | `mocha -R spec --require babel-register ./test/endpoint.js` | 
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2641 | `mocha --opts mocha.opts` | 
| [addyosmani/psi](https://github.com/addyosmani/psi) | 2640 | `xo && mocha` | 
| [draft-js-plugins/draft-js-plugins](https://github.com/draft-js-plugins/draft-js-plugins) | 2624 | `node_modules/.bin/mocha --compilers js:babel-core/register --require testHelper.js "./{,!(node_modules)/**/}/__test__/*.js"` | 
| [mattallty/Caporal.js](https://github.com/mattallty/Caporal.js) | 2613 | `./node_modules/mocha/bin/mocha --require ./tests/utils/bootstrap.js --full-trace --recursive -R mocha-unfunk-reporter tests/` | 
| [tilemill-project/tilemill](https://github.com/tilemill-project/tilemill) | 2597 | `mocha --timeout 100000` | 
| [css/csso](https://github.com/css/csso) | 2595 | `mocha --reporter dot` | 
| [mongo-express/mongo-express](https://github.com/mongo-express/mongo-express) | 2591 | `npm run mocha && npm run lint` | 
| [NeXTs/Jets.js](https://github.com/NeXTs/Jets.js) | 2588 | `mocha-phantomjs ./test/index.html` | 
...
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2556 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2534 | `mocha --compilers js:babel-register --recursive spec` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2534 | `mocha` | 
| [RafalWilinski/express-status-monitor](https://github.com/RafalWilinski/express-status-monitor) | 2529 | `mocha --recursive --watch` | 
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2525 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [Reportr/dashboard](https://github.com/Reportr/dashboard) | 2520 | `export TESTING=true; mocha --reporter list` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2517 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [reactGo/reactGo](https://github.com/reactGo/reactGo) | 2516 | `mocha ./app/tests/setup.js --compilers css:./app/tests/compilers/css ./app/**/*-test.js` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2498 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
...
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2469 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2434 | `NODE_ENV=test mocha` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2403 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2399 | `npm run lint && mocha` | 
| [auth0/express-jwt](https://github.com/auth0/express-jwt) | 2396 | `node_modules/.bin/mocha --reporter spec` | 
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2383 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [istanbuljs/nyc](https://github.com/istanbuljs/nyc) | 2361 | `npm run clean && npm run build && npm run instrument && npm run test-integration && npm run test-mocha && npm run report` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2345 | `npm run build && cd test && mocha . --reporter dot` | 
| [benjamine/jsondiffpatch](https://github.com/benjamine/jsondiffpatch) | 2344 | `nyc mocha` | 
...
| [wix/react-templates](https://github.com/wix/react-templates) | 2324 | `mocha test/src/**/*.unit.js` | 
| [fex-team/fis3](https://github.com/fex-team/fis3) | 2313 | `mocha test` | 
| [json5/json5](https://github.com/json5/json5) | 2277 | `nyc --reporter=html --reporter=text mocha` | 
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2274 | `export TESTING=true; mocha --reporter list` | 
...
| [mde/ejs](https://github.com/mde/ejs) | 2245 | `mocha --require should --reporter spec` | 
| [mroderick/PubSubJS](https://github.com/mroderick/PubSubJS) | 2241 | `mocha` | 
| [apiaryio/dredd](https://github.com/apiaryio/dredd) | 2240 | `mocha "test/**/*-test.js"` | 
| [Dash-Industry-Forum/dash.js](https://github.com/Dash-Industry-Forum/dash.js) | 2232 | `mocha test/unit --require mochahook` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2221 | `mocha` | 
| [h5bp/server-configs-apache](https://github.com/h5bp/server-configs-apache) | 2217 | `npm run lint && npm run build && npm run mocha` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2210 | `mocha --recursive --bail --reporter spec test 2>&1` | 
...
| [jhnns/rewire](https://github.com/jhnns/rewire) | 2187 | `mocha -R spec` | 
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2186 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
| [gajus/swing](https://github.com/gajus/swing) | 2143 | `mocha --compilers js:babel-register` | 
| [jpuri/react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg) | 2118 | `cross-env BABEL_ENV=test mocha --compilers js:config/test-compiler.js config/test-setup.js src/**/*Test.js` | 
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2111 | `mocha test.js` | 
...
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2059 | `mocha -R landing test/index` | 
...
| [noble/noble](https://github.com/noble/noble) | 2032 | `mocha -R spec test/*.js` | 
| [weui/react-weui](https://github.com/weui/react-weui) | 2029 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2028 | `mocha && eslint .` | 
...
| [tapio/live-server](https://github.com/tapio/live-server) | 1993 | `mocha test && npm run lint` | 
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1958 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
...
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 1929 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [panzerdp/voca](https://github.com/panzerdp/voca) | 1900 | `mocha test/index.js --reporter dot` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1896 | `mocha --compilers js:babel-register` | 
...
| [WeiChiaChang/stacks-cli](https://github.com/WeiChiaChang/stacks-cli) | 1886 | `mocha` | 
| [vpulim/node-soap](https://github.com/vpulim/node-soap) | 1868 | `mocha --timeout 10000 test/*-test.js test/security/*.js` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1858 | `mocha --require ./test/common --growl test/expect.js` | 
| [letsgetrandy/brototype](https://github.com/letsgetrandy/brototype) | 1851 | `mocha tests.js` | 
| [yeoman/generator-chrome-extension](https://github.com/yeoman/generator-chrome-extension) | 1850 | `mocha --reporter spec --timeout 5000` | 
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1848 | `mocha test/runner.js --reporter spec` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1829 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1825 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [wdjungst/react-project](https://github.com/wdjungst/react-project) | 1820 | `npm run build && NODE_ENV=test mocha tests.js --compilers js:babel-register` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1804 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors --compilers js:babel-core/register server/tests --recursive` | 
...
| [then/promise](https://github.com/then/promise) | 1800 | `mocha --bail --timeout 200 --slow 99999 -R dot && npm run test-memory-leak` | 
| [borisyankov/react-sparklines](https://github.com/borisyankov/react-sparklines) | 1798 | `mocha --compilers js:babel-core/register __tests__` | 
...
| [brenden/node-webshot](https://github.com/brenden/node-webshot) | 1781 | `mocha --ui bdd --reporter spec --require should ./test/core.js ./test/options/*` | 
...
| [kach/nearley](https://github.com/kach/nearley) | 1761 | `mocha test/*.test.js` | 
...
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1747 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1722 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
| [peers/peerjs-server](https://github.com/peers/peerjs-server) | 1721 | `mocha test` | 
| [lindell/JsBarcode](https://github.com/lindell/JsBarcode) | 1717 | `gulp babel && node_modules/mocha/bin/mocha test/node/ -R spec` | 
...
| [Automattic/juice](https://github.com/Automattic/juice) | 1703 | `mocha --reporter spec && npm run test-typescript` | 
| [apocas/dockerode](https://github.com/apocas/dockerode) | 1701 | `./node_modules/mocha/bin/mocha -R spec --exit` | 
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1697 | `nyc npm run _mocha` | 
...
| [reactjs/react-a11y](https://github.com/reactjs/react-a11y) | 1692 | `npm run mocha && npm run karma` | 
...
| [pstadler/flightplan](https://github.com/pstadler/flightplan) | 1670 | `./node_modules/.bin/mocha` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1635 | `mocha` | 
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1633 | `mocha && npm run lint` | 
...
| [pahen/madge](https://github.com/pahen/madge) | 1598 | `npm run lint && npm run mocha` | 
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1598 | `mocha tests --compilers js:babel-core/register` | 
| [alexei/sprintf.js](https://github.com/alexei/sprintf.js) | 1594 | `mocha test/*.js` | 
| [Codeception/CodeceptJS](https://github.com/Codeception/CodeceptJS) | 1588 | `npm run lint && mocha test/unit && mocha test/runner` | 
...
| [sintaxi/surge](https://github.com/sintaxi/surge) | 1560 | `mocha ./test/basic.js -t 5000` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1556 | `mocha --reporter spec test/*.js` | 
| [cazala/coin-hive](https://github.com/cazala/coin-hive) | 1551 | `mocha test --timeout 600000` | 
| [kissjs/node-mongoskin](https://github.com/kissjs/node-mongoskin) | 1548 | `./node_modules/.bin/mocha` | 
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1545 | `mocha` | 
| [OptimalBits/redbird](https://github.com/OptimalBits/redbird) | 1544 | `mocha test/* --reporter spec` | 
| [FormidableLabs/freactal](https://github.com/FormidableLabs/freactal) | 1543 | `mocha spec` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1536 | `standard "src/*.js" && npm run build && mocha` | 
| [stripe/stripe-node](https://github.com/stripe/stripe-node) | 1511 | `npm run lint && npm run mocha` | 
...
| [RobertWHurst/KeyboardJS](https://github.com/RobertWHurst/KeyboardJS) | 1437 | `mocha test/**/*.spec.js` | 
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1431 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1431 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
| [superscriptjs/superscript](https://github.com/superscriptjs/superscript) | 1431 | `mocha --compilers js:babel-register test -R spec -s 1700 -t 300000 --recursive` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1419 | `eslint . && mocha -t 5000` | 
...
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1411 | `mocha --check-leaks -R dot` | 
...
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1367 | `mocha` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1366 | `mocha --recursive` | 
| [webrtc/adapter](https://github.com/webrtc/adapter) | 1359 | `grunt && grunt downloadBrowser && mocha test/unit && karma start test/karma.conf.js` | 
...
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1352 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1343 | `mocha compiled_tests/` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1320 | `mocha test/setup.js test/spec/*.js` | 
| [webpack/webpack-dev-middleware](https://github.com/webpack/webpack-dev-middleware) | 1311 | `nyc npm run mocha` | 
| [arnaudbenard/redux-mock-store](https://github.com/arnaudbenard/redux-mock-store) | 1304 | `mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [wit-ai/node-wit](https://github.com/wit-ai/node-wit) | 1301 | `mocha --timeout 10000 ./tests/lib.js` | 
...
| [yyx990803/pod](https://github.com/yyx990803/pod) | 1252 | `mocha test/api.js -r jscoverage -R spec --slow 1250 --timeout 5000 && bash test/cli.sh` | 
| [zalmoxisus/remote-redux-devtools](https://github.com/zalmoxisus/remote-redux-devtools) | 1252 | `NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [lukehaas/Scrollify](https://github.com/lukehaas/Scrollify) | 1252 | `mocha ./test/scrollify_test.js --recursive ./test` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1239 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1235 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
| [donejs/donejs](https://github.com/donejs/donejs) | 1226 | `npm run jshint && npm run mocha && npm run document && npm run test-guides` | 
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1224 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
...
| [johnpapa/lite-server](https://github.com/johnpapa/lite-server) | 1181 | `eslint *.js lib/*.js && istanbul cover _mocha -- -R spec` | 
| [web-pal/DBGlass](https://github.com/web-pal/DBGlass) | 1174 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --recursive --require ./test/setup.js test/**/*.spec.js` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1159 | `mocha` | 
...
| [catamphetamine/webpack-isomorphic-tools](https://github.com/catamphetamine/webpack-isomorphic-tools) | 1152 | `mocha --compilers js:babel-core/register --colors --bail --reporter spec test/ --recursive` | 
...
| [benmosher/eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) | 1140 | `cross-env BABEL_ENV=test NODE_PATH=./src nyc -s mocha -R dot --recursive tests/src -t 5s` | 
| [jeffbski/redux-logic](https://github.com/jeffbski/redux-logic) | 1138 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-register --recursive -r ./test/setup.js` | 
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1130 | `mocha test` | 
...
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1121 | `mocha src/test.js` | 
| [Schmavery/facebook-chat-api](https://github.com/Schmavery/facebook-chat-api) | 1121 | `node_modules/.bin/mocha` | 
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1121 | `eslint src && mocha && karma start --single-run` | 
...
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1117 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1116 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
...
| [Yomguithereal/mnemonist](https://github.com/Yomguithereal/mnemonist) | 1102 | `mocha` | 
...
| [yahoo/serialize-javascript](https://github.com/yahoo/serialize-javascript) | 1095 | `istanbul cover -- ./node_modules/mocha/bin/_mocha test/unit/ --reporter spec` | 
...
| [jkphl/svg-sprite](https://github.com/jkphl/svg-sprite) | 1079 | `istanbul test _mocha --report html -- test/*.js --reporter spec` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1077 | `nyc mocha --timeout=20000 test.js` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1058 | `mocha tests/test-*` | 
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1056 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1030 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
| [pauldijou/redux-act](https://github.com/pauldijou/redux-act) | 1025 | `NODE_ENV=test mocha --recursive --compilers js:babel-core/register --reporter mocha-better-spec-reporter` | 
...
| [gajus/babel-plugin-react-css-modules](https://github.com/gajus/babel-plugin-react-css-modules) | 1015 | ` NODE_ENV=test mocha --require babel-core/register` | 
...
| [punkave/sanitize-html](https://github.com/punkave/sanitize-html) | 1002 | `npm run prepublishOnly && mocha test/test.js` | 
| [xiongwilee/Gracejs](https://github.com/xiongwilee/Gracejs) | 1000 | `mocha` | 
...
| [themikenicholson/passport-jwt](https://github.com/themikenicholson/passport-jwt) | 983 | `./node_modules/.bin/mocha --reporter spec --require test/bootstrap test/*test.js` | 
...
| [abouolia/sticky-sidebar](https://github.com/abouolia/sticky-sidebar) | 972 | `mocha --compilers js:babel-core/register` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 970 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 968 | `mocha` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 959 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 957 | `mocha test/config/setup.js test/__tests__/**/*` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 953 | `mocha -R spec ./test/unit/**` | 
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 953 | `mocha -t 120000 test/*.test.js` | 
...
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 948 | `webpack && mocha test/unit` | 
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 946 | `mocha tests/*.js` | 
...
| [electron/spectron](https://github.com/electron/spectron) | 922 | `mocha && standard` | 
...
| [expressjs/cookie-parser](https://github.com/expressjs/cookie-parser) | 918 | `mocha --reporter spec --bail --check-leaks test/` | 
| [webpack-contrib/style-loader](https://github.com/webpack-contrib/style-loader) | 912 | `mocha` | 
| [ryanflorence/ember-tools](https://github.com/ryanflorence/ember-tools) | 911 | `node_modules/.bin/mocha --require should --reporter dot --ui bdd --growl $(find test -name "*.spec.js")` | 
| [huttarichard/instagram-private-api](https://github.com/huttarichard/instagram-private-api) | 909 | `./node_modules/mocha/bin/mocha --inline-diffs --timeout 1000000 tests/run.js` | 
...
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 880 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [js-joda/js-joda](https://github.com/js-joda/js-joda) | 867 | `./node_modules/.bin/mocha --timeout 5000 --compilers js:babel-core/register ./test/*Test.js ./test/**/*Test.js ./test/**/**/*Test.js ./test/*Test_mochaOnly.js` | 
| [azu/promises-book](https://github.com/azu/promises-book) | 866 | `mocha ./Ch**/test/*.js && npm run textlint` | 
| [erelsgl/limdu](https://github.com/erelsgl/limdu) | 863 | `mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 862 | `mocha ./test -R spec` | 
| [matteodem/meteor-boilerplate](https://github.com/matteodem/meteor-boilerplate) | 861 | `meteor test --port 4400 --driver-package=practicalmeteor:mocha` | 
| [open-xml-templating/docxtemplater](https://github.com/open-xml-templating/docxtemplater) | 861 | `npm run convertto:es5 && npm run mocha` | 
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 860 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 834 | `mocha -R spec` | 
| [react-materialize/react-materialize](https://github.com/react-materialize/react-materialize) | 833 | `mocha` | 
| [sliptree/bootstrap-tokenfield](https://github.com/sliptree/bootstrap-tokenfield) | 832 | `mocha --ui bdd --recursive --reporter spec --require must` | 
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 824 | `mocha` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 811 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
| [basicallydan/interfake](https://github.com/basicallydan/interfake) | 810 | `mocha tests/*.test.js --reporter spec` | 
| [tj/node-migrate](https://github.com/tj/node-migrate) | 810 | `standard && standard ./bin/* && mocha` | 
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 807 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
...
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 786 | `npm run mocha:istanbul` | 
...
| [image-size/image-size](https://github.com/image-size/image-size) | 783 | `nyc mocha specs` | 
...
| [tdegrunt/jsonschema](https://github.com/tdegrunt/jsonschema) | 774 | `./node_modules/.bin/mocha -R spec` | 
| [AlexGilleran/jsx-control-statements](https://github.com/AlexGilleran/jsx-control-statements) | 774 | `mocha spec/*.js` | 
...
| [gajus/eslint-plugin-flowtype](https://github.com/gajus/eslint-plugin-flowtype) | 756 | `mocha --compilers js:babel-register ./tests/rules/index.js` | 
...
| [bitpay/insight](https://github.com/bitpay/insight) | 747 | `mocha test` | 
| [klei/gulp-inject](https://github.com/klei/gulp-inject) | 744 | `mocha -R spec src/**/*_test.js` | 
| [gkajs/gka](https://github.com/gkajs/gka) | 742 | `mocha --timeout 20000` | 
...
| [indutny/node-ip](https://github.com/indutny/node-ip) | 738 | `jscs lib/*.js test/*.js && jshint lib/*.js && mocha --reporter spec test/*-test.js` | 
...
| [domchristie/humps](https://github.com/domchristie/humps) | 705 | `mocha` | 
| [webpro/DOMtastic](https://github.com/webpro/DOMtastic) | 704 | `npm run bundle && mocha` | 
| [volumio/Volumio2](https://github.com/volumio/Volumio2) | 700 | `npm install fs-extra && npm install --only=dev && ./node_modules/.bin/mocha --reporter spec` | 
| [MaxArt2501/share-this](https://github.com/MaxArt2501/share-this) | 700 | `nyc --require babel-core/register mocha test/*.js test/sharers/*.js` | 
| [ruanyf/es-checker](https://github.com/ruanyf/es-checker) | 700 | `mocha` | 
...
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 696 | `mocha test` | 
