...
The list was updated at 02:06:45 04/08/18 PDT
...
| --- | --- | --- |
| [socketio/socket.io](https://github.com/socketio/socket.io) | 40520 | `nyc mocha --reporter spec --slow 200 --bail --timeout 10000 test/socket.io.js` | 
| [h5bp/html5-boilerplate](https://github.com/h5bp/html5-boilerplate) | 40155 | `gulp archive && mocha --require babel-core/register --reporter spec --timeout 5000` | 
| [webpack/webpack](https://github.com/webpack/webpack) | 39565 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation` | 
| [expressjs/express](https://github.com/expressjs/express) | 37559 | `mocha --require test/support/env --reporter spec --bail --check-leaks --no-exit test/ test/acceptance/` | 
| [gulpjs/gulp](https://github.com/gulpjs/gulp) | 29143 | `mocha --async-only` | 
| [caolan/async](https://github.com/caolan/async) | 23706 | `npm run lint && npm run mocha-node-test` | 
| [lord/slate](https://github.com/lord/slate) | 22758 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [hexojs/hexo](https://github.com/hexojs/hexo) | 21475 | `mocha test/index.js` | 
| [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) | 21151 | `cross-env NODE_ENV=test mocha` | 
| [developit/preact](https://github.com/developit/preact) | 18300 | `npm-run-all lint --parallel test:mocha test:karma test:ts test:flow test:size` | 
| [GitbookIO/gitbook](https://github.com/GitbookIO/gitbook) | 17932 | `./node_modules/.bin/mocha ./testing/setup.js "./lib/**/*/__tests__/*.js" --bail --reporter=list --timeout=10000` | 
| [rstacruz/nprogress](https://github.com/rstacruz/nprogress) | 15898 | `mocha` | 
| [Automattic/mongoose](https://github.com/Automattic/mongoose) | 15340 | `mocha --exit test/*.test.js test/**/*.test.js` | 
| [hubotio/hubot](https://github.com/hubotio/hubot) | 13955 | `nyc --reporter=html --reporter=text mocha` | 
| [Marak/faker.js](https://github.com/Marak/faker.js) | 13704 | `node_modules/.bin/mocha test/*.*.js` | 
| [jaredhanson/passport](https://github.com/jaredhanson/passport) | 13040 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js test/**/*.test.js` | 
| [keystonejs/keystone](https://github.com/keystonejs/keystone) | 12431 | `mocha && mocha --opts test/mocha-admin.opts` | 
| [FormidableLabs/webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) | 12250 | `mocha 'test/**/*.spec.js'` | 
| [node-inspector/node-inspector](https://github.com/node-inspector/node-inspector) | 12078 | `mocha` | 
| [isagalaev/highlight.js](https://github.com/isagalaev/highlight.js) | 11976 | `./node_modules/.bin/mocha test/` | 
| [janl/mustache.js](https://github.com/janl/mustache.js) | 11851 | `mocha --reporter spec test/*-test.js` | 
| [ramda/ramda](https://github.com/ramda/ramda) | 11598 | `mocha --reporter spec` | 
| [JedWatson/react-select](https://github.com/JedWatson/react-select) | 11127 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register` | 
| [strongloop/loopback](https://github.com/strongloop/loopback) | 10826 | `nyc grunt mocha-and-karma` | 
| [nswbmw/N-blog](https://github.com/nswbmw/N-blog) | 10474 | `istanbul cover _mocha` | 
| [chriso/validator.js](https://github.com/chriso/validator.js) | 10069 | `mocha --reporter spec` | 
| [winstonjs/winston](https://github.com/winstonjs/winston) | 9938 | `nyc mocha test/*.test.js test/**/*.test.js` | 
| [jsdom/jsdom](https://github.com/jsdom/jsdom) | 9578 | `mocha test/index.js` | 
| [tj/co](https://github.com/tj/co) | 9511 | `mocha --harmony` | 
| [gaearon/redux-devtools](https://github.com/gaearon/redux-devtools) | 9497 | `cross-env NODE_ENV=test mocha --compilers js:babel-core/register --recursive` | 
| [NodeRedis/node_redis](https://github.com/NodeRedis/node_redis) | 9370 | `nyc --cache mocha ./test/*.js ./test/commands/*.js --timeout=8000` | 
| [svg/svgo](https://github.com/svg/svgo) | 9355 | `set NODE_ENV=test && mocha` | 
| [stylus/stylus](https://github.com/stylus/stylus) | 9009 | `mocha test/ test/middleware/ --require should --bail --check-leaks --reporter dot` | 
| [dcloudio/mui](https://github.com/dcloudio/mui) | 8690 | `mocha` | 
| [ccampbell/mousetrap](https://github.com/ccampbell/mousetrap) | 8688 | `grunt mocha` | 
| [nodejitsu/node-http-proxy](https://github.com/nodejitsu/node-http-proxy) | 8562 | `mocha test/*-test.js` | 
| [gaearon/redux-thunk](https://github.com/gaearon/redux-thunk) | 8418 | `cross-env BABEL_ENV=commonjs mocha --compilers js:babel-core/register --reporter spec test/*.js` | 
| [qrohlf/trianglify](https://github.com/qrohlf/trianglify) | 8243 | `mocha test/test.js` | 
| [arasatasaygin/is.js](https://github.com/arasatasaygin/is.js) | 8221 | `mocha --check-leaks -R dot` | 
| [websockets/ws](https://github.com/websockets/ws) | 8187 | `eslint . && nyc --reporter=html --reporter=text mocha test/*.test.js` | 
| [hacksalot/HackMyResume](https://github.com/hacksalot/HackMyResume) | 8145 | `grunt clean:test && mocha --exit` | 
| [louischatriot/nedb](https://github.com/louischatriot/nedb) | 8077 | `./node_modules/.bin/mocha --reporter spec --timeout 10000` | 
| [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) | 8006 | `./node_modules/.bin/mocha test/src` | 
| [lovell/sharp](https://github.com/lovell/sharp) | 7943 | `semistandard && cc && nyc --reporter=lcov --branches=99 mocha --slow=5000 --timeout=60000 ./test/unit/*.js && prebuild-ci` | 
| [reactide/reactide](https://github.com/reactide/reactide) | 7872 | `mocha --compilers js:babel-register test/test.js` | 
| [amark/gun](https://github.com/amark/gun) | 7865 | `mocha` | 
| [senchalabs/connect](https://github.com/senchalabs/connect) | 7836 | `mocha --require test/support/env --reporter spec --bail --check-leaks test/` | 
| [uncss/uncss](https://github.com/uncss/uncss) | 7631 | `npm run eslint && npm run mocha` | 
| [JedWatson/classnames](https://github.com/JedWatson/classnames) | 7574 | `mocha tests/*.js` | 
...
| [gabrielbull/react-desktop](https://github.com/gabrielbull/react-desktop) | 7308 | `./node_modules/.bin/mocha test` | 
| [Mango/slideout](https://github.com/Mango/slideout) | 7259 | `npm run build && istanbul cover _mocha` | 
| [auth0/node-jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) | 7254 | `mocha --require test/util/fakeDate && nsp check && cost-of-modules` | 
| [brave/browser-laptop](https://github.com/brave/browser-laptop) | 7186 | `cross-env NODE_ENV=test mocha "test/**/*Test.js"` | 
| [ianstormtaylor/slate](https://github.com/ianstormtaylor/slate) | 7049 | `cross-env BABEL_ENV=test mocha --require babel-core/register ./packages/*/test/index.js` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 6743 | `mocha --opts mocha.opts` | 
| [SBoudrias/Inquirer.js](https://github.com/SBoudrias/Inquirer.js) | 6727 | `nyc mocha test/**/* -r ./test/before` | 
| [addyosmani/critical](https://github.com/addyosmani/critical) | 6639 | `xo && mocha test/*.js --timeout 100000` | 
| [vuejs-templates/webpack](https://github.com/vuejs-templates/webpack) | 6637 | `mocha test/*.test.js test/*.unittest.js --max-old-space-size=4096 --harmony --trace-deprecation` | 
| [segmentio/metalsmith](https://github.com/segmentio/metalsmith) | 6636 | `mocha $HARMONY_OPTS` | 
| [aui/art-template](https://github.com/aui/art-template) | 6620 | `export NODE_ENV=production && istanbul cover node_modules/mocha/bin/_mocha -- --ui exports --colors 'test/**/*.js'` | 
| [tgriesser/knex](https://github.com/tgriesser/knex) | 6595 | `npm run pre_test && istanbul --config=test/.istanbul.yml cover node_modules/mocha/bin/_mocha -- --check-leaks -t 10000 -b -R spec test/index.js && npm run tape` | 
...
| [localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) | 6577 | `mocha --ui qunit --reporter list --timeout 10000 -- test/index.js` | 
| [almende/vis](https://github.com/almende/vis) | 6473 | `mocha --compilers js:babel-core/register` | 
| [MichMich/MagicMirror](https://github.com/MichMich/MagicMirror) | 6200 | `NODE_ENV=test ./node_modules/mocha/bin/mocha tests --recursive` | 
...
| [cazala/synaptic](https://github.com/cazala/synaptic) | 5978 | `npm run test:mocha:src` | 
| [yeoman/generator-angular](https://github.com/yeoman/generator-angular) | 5928 | `mocha` | 
| [apidoc/apidoc](https://github.com/apidoc/apidoc) | 5881 | `npm run jshint && mocha test/` | 
| [visionmedia/page.js](https://github.com/visionmedia/page.js) | 5713 | `jshint index.js test/tests.js && mocha test/tests.js` | 
| [josdejong/mathjs](https://github.com/josdejong/mathjs) | 5640 | `mocha test --recursive` | 
| [sockjs/sockjs-client](https://github.com/sockjs/sockjs-client) | 5596 | `mocha tests/node.js` | 
| [kelektiv/node-uuid](https://github.com/kelektiv/node-uuid) | 5536 | `mocha test/test.js` | 
| [rauchg/slackin](https://github.com/rauchg/slackin) | 5502 | `mocha && eslint lib/**` | 
| [matthew-andrews/isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) | 5466 | `jshint `npm run -s files` && lintspaces -i js-comments -e .editorconfig `npm run -s files` && mocha` | 
| [webpack-contrib/webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | 5428 | `mocha --exit --require babel-core/register` | 
| [trufflesuite/truffle](https://github.com/trufflesuite/truffle) | 5426 | `npm run build-cli && mocha` | 
| [ExactTarget/fuelux](https://github.com/ExactTarget/fuelux) | 5394 | `xvfb-maybe mocha test/mocha.js && grunt travisci --verbose` | 
| [automerge/automerge](https://github.com/automerge/automerge) | 5311 | `mocha` | 
| [alvarcarto/url-to-pdf-api](https://github.com/alvarcarto/url-to-pdf-api) | 5202 | `mocha --timeout 10000 && npm run lint` | 
| [jscs-dev/node-jscs](https://github.com/jscs-dev/node-jscs) | 5164 | `mocha --color` | 
| [PrismJS/prism](https://github.com/PrismJS/prism) | 5151 | `mocha tests/testrunner-tests.js && mocha tests/run.js` | 
| [daniel-lundin/snabbt.js](https://github.com/daniel-lundin/snabbt.js) | 5147 | `mocha src/**/*Tests.js --harmony` | 
| [redux-observable/redux-observable](https://github.com/redux-observable/redux-observable) | 4949 | `npm run lint && npm run build && npm run build:tests && mocha temp && npm run test:typings` | 
| [ethereum/web3.js](https://github.com/ethereum/web3.js) | 4858 | `mocha; jshint *.js lib` | 
| [assaf/zombie](https://github.com/assaf/zombie) | 4817 | `gulp lint && mocha` | 
| [bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) | 4815 | `npm run build && npm run lint &&  mocha --check-leaks -t 10000 -b test/index.js` | 
| [deployd/deployd](https://github.com/deployd/deployd) | 4764 | `mocha --timeout 5000 --exit && cd test-app && node runtests.js` | 
| [redux-utilities/redux-actions](https://github.com/redux-utilities/redux-actions) | 4763 | `mocha --compilers js:babel-register src/**/*-test.js` | 
| [Tencent/vConsole](https://github.com/Tencent/vConsole) | 4743 | `mocha` | 
| [expressjs/multer](https://github.com/expressjs/multer) | 4679 | `standard && mocha` | 
...
| [GoogleChrome/workbox](https://github.com/GoogleChrome/workbox) | 4632 | `nyc --clean false --require @std/esm --require ./infra/testing/sw-env --silent mocha ./infra/testing/auto-stub-logger.mjs` | 
| [dthree/vorpal](https://github.com/dthree/vorpal) | 4562 | `gulp build; mocha;` | 
| [KELiON/cerebro](https://github.com/KELiON/cerebro) | 4558 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
| [keithwhor/nodal](https://github.com/keithwhor/nodal) | 4544 | `mocha ./test/runner.js` | 
| [gajus/react-css-modules](https://github.com/gajus/react-css-modules) | 4484 | `NODE_ENV=development mocha --compilers js:babel-register ./tests/**/*.js && npm run lint && npm run build` | 
| [helmetjs/helmet](https://github.com/helmetjs/helmet) | 4469 | `mocha` | 
| [prerender/prerender](https://github.com/prerender/prerender) | 4411 | `./node_modules/.bin/mocha` | 
| [josephg/ShareJS](https://github.com/josephg/ShareJS) | 4400 | `node_modules/mocha/bin/mocha test/server test/browser` | 
| [yargs/yargs](https://github.com/yargs/yargs) | 4348 | `nyc --cache mocha --require ./test/before.js --timeout=8000 --check-leaks` | 
...
| [josdejong/jsoneditor](https://github.com/josdejong/jsoneditor) | 4299 | `mocha test` | 
| [matthewmueller/x-ray](https://github.com/matthewmueller/x-ray) | 4265 | `mocha` | 
| [lebab/lebab](https://github.com/lebab/lebab) | 4261 | `mocha --compilers js:babel-register "test/**/*Test.js"` | 
| [rendrjs/rendr](https://github.com/rendrjs/rendr) | 4224 | `mocha -R spec ./test --recursive` | 
| [mattgodbolt/compiler-explorer](https://github.com/mattgodbolt/compiler-explorer) | 4060 | `mocha --recursive && make test` | 
| [peterramsing/lost](https://github.com/peterramsing/lost) | 4045 | `nyc mocha` | 
| [luin/ioredis](https://github.com/luin/ioredis) | 3977 | `NODE_ENV=test mocha` | 
| [Khan/tota11y](https://github.com/Khan/tota11y) | 3932 | `mocha --require test/babel-hook test/*.js` | 
| [agenda/agenda](https://github.com/agenda/agenda) | 3915 | `npm run lint && npm run mocha` | 
...
| [AliasIO/Wappalyzer](https://github.com/AliasIO/Wappalyzer) | 3774 | `mocha -R spec ./test` | 
| [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) | 3768 | `mocha -r intelli-espower-loader -t 20000 test` | 
| [artf/grapesjs](https://github.com/artf/grapesjs) | 3766 | `cross-env NODE_PATH=./src mocha --compilers js:babel-core/register --require test/helper.js --timeout 10000 --recursive test/main.js` | 
| [ApoorvSaxena/lozad.js](https://github.com/ApoorvSaxena/lozad.js) | 3752 | `nyc mocha` | 
| [tjunnone/npm-check-updates](https://github.com/tjunnone/npm-check-updates) | 3724 | `npm run lint ; mocha && mocha test/individual` | 
| [bfirsh/jsnes](https://github.com/bfirsh/jsnes) | 3665 | `mocha ./test/*.spec.js` | 
...
| [blakeembrey/code-problems](https://github.com/blakeembrey/code-problems) | 3550 | `mocha tests/javascript` | 
| [webpack/webpack-dev-server](https://github.com/webpack/webpack-dev-server) | 3546 | `npm run lint && npm run mocha` | 
| [saenzramiro/rambox](https://github.com/saenzramiro/rambox) | 3528 | `./node_modules/.bin/mocha test/tests/**/*.spec.js` | 
...
| [react-tools/react-move](https://github.com/react-tools/react-move) | 3419 | `cross-env NODE_ENV=test BABEL_ENV=cjs mocha "src/**/*.spec.js"` | 
...
| [socketio/engine.io](https://github.com/socketio/engine.io) | 3398 | `npm run lint && mocha && EIO_WS_ENGINE=uws mocha` | 
| [node-serialport/node-serialport](https://github.com/node-serialport/node-serialport) | 3290 | `istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [moroshko/react-autosuggest](https://github.com/moroshko/react-autosuggest) | 3272 | `nyc mocha "test/**/*.test.js"` | 
| [shoutem/ui](https://github.com/shoutem/ui) | 3270 | `mocha -R spec --require test-utils/setup.js --require react-native-mock/mock.js --compilers js:babel-core/register $(find . -name '*.spec.js' ! -ipath '*node_modules*')` | 
...
| [GoogleChromeLabs/sw-toolbox](https://github.com/GoogleChromeLabs/sw-toolbox) | 3234 | `gulp lint default && node ./test/helpers/download-browsers.js && mocha` | 
| [ianstormtaylor/superstruct](https://github.com/ianstormtaylor/superstruct) | 3202 | `yarn build:cjs && yarn lint && mocha --require babel-core/register ./test/index.js` | 
| [mozilla-services/react-jsonschema-form](https://github.com/mozilla-services/react-jsonschema-form) | 3131 | `cross-env NODE_ENV=test mocha --compilers js:babel-register --require ./test/setup-jsdom.js test/**/*_test.js` | 
| [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js) | 3107 | `node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly --` | 
...
| [chimurai/http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware) | 3084 | `npm run lint && mocha --recursive --colors --reporter spec` | 
...
| [alexmingoia/koa-router](https://github.com/alexmingoia/koa-router) | 2971 | `NODE_ENV=test mocha test/**/*.js` | 
...
| [commitizen/cz-cli](https://github.com/commitizen/cz-cli) | 2942 | `nyc --require babel-core/register _mocha -- test/tests/index.js` | 
| [shakiba/planck.js](https://github.com/shakiba/planck.js) | 2926 | `mocha test/*.js` | 
| [ctavan/express-validator](https://github.com/ctavan/express-validator) | 2918 | `nyc mocha && tsc` | 
...
| [vuejs/vue-loader](https://github.com/vuejs/vue-loader) | 2896 | `eslint lib && mocha --slow 5000 --timeout 10000` | 
...
| [bitinn/node-fetch](https://github.com/bitinn/node-fetch) | 2844 | `cross-env BABEL_ENV=test mocha --compilers js:babel-register test/test.js` | 
...
| [aui/font-spider](https://github.com/aui/font-spider) | 2808 | `mocha test/index.js && npm run demo` | 
...
| [felipernb/algorithms.js](https://github.com/felipernb/algorithms.js) | 2799 | `mocha -R spec --recursive src/test` | 
| [StephenGrider/ReduxSimpleStarter](https://github.com/StephenGrider/ReduxSimpleStarter) | 2789 | `mocha --compilers js:babel-core/register --require ./test/test_helper.js --recursive ./test` | 
| [jsonresume/resume-cli](https://github.com/jsonresume/resume-cli) | 2769 | `node node_modules/mocha/bin/mocha test test/*.js` | 
| [reworkcss/rework](https://github.com/reworkcss/rework) | 2766 | `mocha --require should --reporter spec` | 
| [yujiosaka/headless-chrome-crawler](https://github.com/yujiosaka/headless-chrome-crawler) | 2762 | `yarn tsc && yarn lint && yarn mocha-exclude-redis-cache` | 
...
| [swagger-api/swagger-node](https://github.com/swagger-api/swagger-node) | 2742 | `mocha -u exports -R spec test/config.js test/util test/commands test/commands/project test/project-skeletons` | 
| [tj/consolidate.js](https://github.com/tj/consolidate.js) | 2724 | `mocha` | 
| [github-tools/github](https://github.com/github-tools/github) | 2720 | `mocha --opts ./mocha.opts test/*.spec.js` | 
| [jayphelps/core-decorators](https://github.com/jayphelps/core-decorators) | 2716 | `mocha --compilers js:babel-core/register --require babel-polyfill "test/**/*.spec.js"` | 
...
| [OptimalBits/bull](https://github.com/OptimalBits/bull) | 2710 | `NODE_ENV=test mocha` | 
...
| [plouc/mozaik](https://github.com/plouc/mozaik) | 2688 | `mocha --opts mocha.opts` | 
...
| [google-map-react/google-map-react](https://github.com/google-map-react/google-map-react) | 2613 | `NODE_ENV=eee mocha --compilers js:babel-register --recursive --require babel-polyfill` | 
| [css/csso](https://github.com/css/csso) | 2612 | `mocha --reporter dot` | 
...
| [yagop/node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) | 2584 | `npm run eslint && istanbul cover ./node_modules/mocha/bin/_mocha` | 
| [webpack-contrib/css-loader](https://github.com/webpack-contrib/css-loader) | 2580 | `mocha` | 
| [ecomfe/fontmin](https://github.com/ecomfe/fontmin) | 2578 | `mocha` | 
| [toji/gl-matrix](https://github.com/toji/gl-matrix) | 2567 | `mocha --compilers js:babel-register --recursive spec` | 
| [Vincit/objection.js](https://github.com/Vincit/objection.js) | 2561 | `npm run eslint && mocha --slow 10 --timeout 15000 --reporter spec --recursive tests` | 
| [developit/unfetch](https://github.com/developit/unfetch) | 2557 | `eslint src test && mocha --compilers js:babel-register test/**/*.js` | 
| [contra/react-responsive](https://github.com/contra/react-responsive) | 2557 | `cross-env NODE_PATH=$NODE_PATH:$PWD/src mocha -R spec --compilers js:babel-register --require ./test/setup.js test/*_test.js` | 
...
| [node-ffi/node-ffi](https://github.com/node-ffi/node-ffi) | 2432 | `node-gyp rebuild --directory test && mocha -gc --reporter spec` | 
...
| [octokit/rest.js](https://github.com/octokit/rest.js) | 2416 | `nyc mocha test/mocha-node-setup.js "test/**/*-test.js"` | 
...
| [kubernetes/dashboard](https://github.com/kubernetes/dashboard) | 2386 | `export TESTING=true; mocha --reporter list` | 
| [agershun/alasql](https://github.com/agershun/alasql) | 2384 | `npm run build && cd test && mocha . --reporter dot` | 
...
| [json5/json5](https://github.com/json5/json5) | 2330 | `nyc --reporter=html --reporter=text mocha` | 
| [mde/ejs](https://github.com/mde/ejs) | 2299 | `mocha --require should --reporter spec` | 
...
| [reactjs/react-chartjs](https://github.com/reactjs/react-chartjs) | 2272 | `mocha` | 
...
| [mcollina/mosca](https://github.com/mcollina/mosca) | 2248 | `mocha --recursive --bail --reporter spec test 2>&1` | 
...
| [oauthjs/node-oauth2-server](https://github.com/oauthjs/node-oauth2-server) | 2212 | `NODE_ENV=test ./node_modules/.bin/mocha 'test/**/*_test.js'` | 
...
| [kolodny/immutability-helper](https://github.com/kolodny/immutability-helper) | 2174 | `mocha test.js` | 
| [gajus/swing](https://github.com/gajus/swing) | 2155 | `mocha --compilers js:babel-register` | 
| [wuchangming/spy-debugger](https://github.com/wuchangming/spy-debugger) | 2130 | `mocha -R landing test/index` | 
| [dmfay/massive-js](https://github.com/dmfay/massive-js) | 2124 | `nyc --reporter=html --reporter=text mocha` | 
...
| [weui/react-weui](https://github.com/weui/react-weui) | 2054 | `mocha --compilers js:babel-core/register --recursive -r ignore-styles -r jsdom-global/register` | 
| [apostrophecms/apostrophe](https://github.com/apostrophecms/apostrophe) | 2054 | `mocha && eslint .` | 
| [tapio/live-server](https://github.com/tapio/live-server) | 2040 | `mocha test && npm run lint` | 
| [apsdehal/awesome-ctf](https://github.com/apsdehal/awesome-ctf) | 2011 | `./node_modules/mocha/bin/mocha -u bdd tests/test.js` | 
...
| [nodebox/opentype.js](https://github.com/nodebox/opentype.js) | 1981 | `mocha --require reify --compilers js:buble/register --recursive && jshint . && jscs .` | 
| [thlorenz/proxyquire](https://github.com/thlorenz/proxyquire) | 1958 | `standard && mocha` | 
| [babel/example-node-server](https://github.com/babel/example-node-server) | 1943 | `mocha --compilers js:babel-register` | 
| [reactopt/reactopt](https://github.com/reactopt/reactopt) | 1937 | `mocha -c test/index.js` | 
...
| [OptimalBits/node_acl](https://github.com/OptimalBits/node_acl) | 1891 | `mocha test/runner.js --reporter spec` | 
| [yeoman/generator-chrome-extension](https://github.com/yeoman/generator-chrome-extension) | 1867 | `mocha --reporter spec --timeout 5000` | 
| [Automattic/expect.js](https://github.com/Automattic/expect.js) | 1865 | `mocha --require ./test/common --growl test/expect.js` | 
| [davidkpiano/react-redux-form](https://github.com/davidkpiano/react-redux-form) | 1857 | `NODE_ENV=test mocha --require babel-register --require ./test/spec-setup.js` | 
| [letsgetrandy/brototype](https://github.com/letsgetrandy/brototype) | 1856 | `mocha tests.js` | 
| [rgrove/rawgit](https://github.com/rgrove/rawgit) | 1852 | `NODE_ENV=test mocha -R dot test/**/test.*.js` | 
| [kunalkapadia/express-mongoose-es6-rest-api](https://github.com/kunalkapadia/express-mongoose-es6-rest-api) | 1848 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --ui bdd --reporter spec --colors server --recursive` | 
...
| [omnidan/redux-undo](https://github.com/omnidan/redux-undo) | 1803 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha --compilers js:babel-core/register` | 
...
| [embark-framework/embark](https://github.com/embark-framework/embark) | 1787 | `grunt jshint && mocha test/ --no-timeouts && cd test_app/ && npm install && ../bin/embark test` | 
...
| [share/sharedb](https://github.com/share/sharedb) | 1771 | `./node_modules/.bin/mocha && npm run jshint` | 
| [posthtml/posthtml](https://github.com/posthtml/posthtml) | 1770 | `npm run lint && mocha -R dot && npm run cover` | 
...
| [mysticatea/npm-run-all](https://github.com/mysticatea/npm-run-all) | 1741 | `nyc npm run _mocha` | 
...
| [danielstjules/jsinspect](https://github.com/danielstjules/jsinspect) | 1727 | `mocha -R spec spec spec/reporters` | 
| [trailsjs/trails](https://github.com/trailsjs/trails) | 1725 | `eslint --ignore-path .gitignore index.js lib/ test/ && nyc mocha` | 
| [jaredhanson/passport-local](https://github.com/jaredhanson/passport-local) | 1723 | `node_modules/.bin/mocha --reporter spec --require test/bootstrap/node test/*.test.js` | 
...
| [rickbergfalk/sqlpad](https://github.com/rickbergfalk/sqlpad) | 1710 | `rm -rf ./dbtest && npm run lint && SQLPAD_DB_PATH='./dbtest' mocha server/test --timeout 10000 --recursive --exit` | 
...
| [kimmobrunfeldt/concurrently](https://github.com/kimmobrunfeldt/concurrently) | 1668 | `mocha` | 
...
| [fb55/htmlparser2](https://github.com/fb55/htmlparser2) | 1653 | `mocha && npm run lint` | 
| [guo-yu/douban.fm](https://github.com/guo-yu/douban.fm) | 1642 | `node_modules/mocha/bin/mocha tests/*.js --require tests/babelhook` | 
| [pahen/madge](https://github.com/pahen/madge) | 1642 | `npm run lint && npm run mocha` | 
...
| [ivanakimov/hashids.js](https://github.com/ivanakimov/hashids.js) | 1627 | `mocha tests --compilers js:babel-core/register` | 
...
| [flitbit/diff](https://github.com/flitbit/diff) | 1597 | `mocha test/**/*.js` | 
| [gcanti/tcomb](https://github.com/gcanti/tcomb) | 1597 | `npm run lint && mocha` | 
| [bcoin-org/bcoin](https://github.com/bcoin-org/bcoin) | 1595 | `mocha --reporter spec test/*.js` | 
| [tinytacoteam/zazu](https://github.com/tinytacoteam/zazu) | 1589 | `cross-env NODE_ENV=test electron-mocha --recursive test/app` | 
| [felixrieseberg/windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) | 1587 | `standard "src/*.js" && npm run build && mocha` | 
...
| [danmactough/node-feedparser](https://github.com/danmactough/node-feedparser) | 1570 | `mocha` | 
| [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) | 1565 | `eslint . && mocha -t 5000` | 
...
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 1511 | `mocha --compilers js:babel-register` | 
...
| [lmenezes/cerebro](https://github.com/lmenezes/cerebro) | 1471 | `cross-env NODE_ENV=test ./node_modules/.bin/mocha-webpack` | 
...
| [benjycui/bisheng](https://github.com/benjycui/bisheng) | 1458 | `lerna bootstrap && lerna exec -- _mocha --recursive --opts test/mocha.opts` | 
...
| [Zarel/Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) | 1434 | `eslint --cache . && tsc && mocha` | 
| [mbloch/mapshaper](https://github.com/mbloch/mapshaper) | 1426 | `mocha --check-leaks -R dot` | 
| [jdesboeufs/connect-mongo](https://github.com/jdesboeufs/connect-mongo) | 1424 | `nyc mocha` | 
| [gajus/redux-immutable](https://github.com/gajus/redux-immutable) | 1424 | `mocha --compilers js:babel-register './tests/**/*.js'` | 
...
| [teambit/bit](https://github.com/teambit/bit) | 1413 | `mocha --compilers js:babel-core/register ./specs/**/*.spec.js` | 
| [observing/pre-commit](https://github.com/observing/pre-commit) | 1408 | `mocha test.js` | 
| [mrvautin/adminMongo](https://github.com/mrvautin/adminMongo) | 1406 | `find ./tests -name '*.js' | xargs mocha -R spec -t 5000` | 
...
| [zeit/ms](https://github.com/zeit/ms) | 1391 | `mocha tests.js` | 
| [socketio/socket.io-redis](https://github.com/socketio/socket.io-redis) | 1387 | `mocha` | 
| [webpack-contrib/copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) | 1386 | `mocha compiled_tests/` | 
| [seejohnrun/haste-server](https://github.com/seejohnrun/haste-server) | 1380 | `mocha --recursive` | 
| [squaremo/rabbit.js](https://github.com/squaremo/rabbit.js) | 1378 | `./node_modules/mocha/bin/mocha --ui exports test` | 
...
| [captivationsoftware/react-sticky](https://github.com/captivationsoftware/react-sticky) | 1354 | `mocha test/setup.js test/spec/*.js` | 
...
| [electron/devtron](https://github.com/electron/devtron) | 1275 | `mocha test/unit/*-test.js test/integration/*-test.js && standard` | 
| [zendesk/cross-storage](https://github.com/zendesk/cross-storage) | 1275 | `./node_modules/.bin/zuul --local 8080 --ui mocha-bdd -- test/test.js` | 
...
| [kantord/just-dashboard](https://github.com/kantord/just-dashboard) | 1268 | `mocha-webpack "src/**/*.test.js" --webpack-config webpack.test.config.js --require babel-polyfill --reporter mochawesome` | 
...
| [gemini-testing/gemini](https://github.com/gemini-testing/gemini) | 1244 | `istanbul test _mocha -- --recursive test/unit test/functional test/browser` | 
...
| [Kong/mockbin](https://github.com/Kong/mockbin) | 1227 | `mocha --recursive` | 
...
| [gaearon/react-document-title](https://github.com/gaearon/react-document-title) | 1193 | `mocha` | 
...
| [dherault/serverless-offline](https://github.com/dherault/serverless-offline) | 1174 | `mocha test` | 
| [djfarrelly/MailDev](https://github.com/djfarrelly/MailDev) | 1173 | `standard && istanbul cover _mocha` | 
| [Foliotek/Croppie](https://github.com/Foliotek/Croppie) | 1171 | `mocha test/unit` | 
...
| [taylorhakes/promise-polyfill](https://github.com/taylorhakes/promise-polyfill) | 1167 | `eslint src && mocha && karma start --single-run` | 
...
| [pillarjs/hbs](https://github.com/pillarjs/hbs) | 1162 | `mocha` | 
| [react-tools/react-form](https://github.com/react-tools/react-form) | 1161 | `mocha-webpack --opts tests/mocha-webpack.opts` | 
...
| [wonderunit/storyboarder](https://github.com/wonderunit/storyboarder) | 1136 | `mocha $(find test -name '*[!renderer].test.js') && electron-mocha --renderer test/*.renderer.test.js test/**/*.renderer.test.js && electron-mocha test/**/*.main.test.js` | 
| [broofa/node-mime](https://github.com/broofa/node-mime) | 1133 | `mocha src/test.js` | 
| [Raathigesh/dazzle](https://github.com/Raathigesh/dazzle) | 1131 | `babel-node ./node_modules/istanbul/lib/cli.js --include-all-sources cover node_modules/mocha/bin/_mocha -- --require ./test/entry.js ./test/**/*.spec.js` | 
| [conventional-changelog/standard-version](https://github.com/conventional-changelog/standard-version) | 1131 | `nyc mocha --timeout=20000 test.js` | 
| [Yomguithereal/mnemonist](https://github.com/Yomguithereal/mnemonist) | 1130 | `mocha` | 
| [variety/variety](https://github.com/variety/variety) | 1128 | `node_modules/.bin/mocha --compilers js:babel-core/register --require babel-polyfill  --recursive --reporter spec --timeout 15000 spec` | 
...
| [yanyiwu/nodejieba](https://github.com/yanyiwu/nodejieba) | 1105 | `node test/demo.js && node test/load_dict_demo.js && mocha --timeout 10s -R spec test/test.js && mocha --timeout 10s -R spec test/load_dict_test.js` | 
...
| [survivejs/webpack-merge](https://github.com/survivejs/webpack-merge) | 1091 | `mocha tests/test-*` | 
...
| [expressjs/csurf](https://github.com/expressjs/csurf) | 1082 | `mocha --check-leaks --reporter spec --bail test/` | 
...
| [securingsincity/react-ace](https://github.com/securingsincity/react-ace) | 1077 | `mocha --require babel-register --require tests/setup.js tests/**/*.spec.js --exit` | 
...
| [ramda/ramda-fantasy](https://github.com/ramda/ramda-fantasy) | 1029 | `mocha` | 
...
| [prescottprue/react-redux-firebase](https://github.com/prescottprue/react-redux-firebase) | 1015 | `mocha -R spec ./test/unit/**` | 
...
| [jerairrest/react-chartjs-2](https://github.com/jerairrest/react-chartjs-2) | 1006 | `mocha test/config/setup.js test/__tests__/**/*` | 
| [oakmac/chessboardjs](https://github.com/oakmac/chessboardjs) | 1005 | `mocha` | 
| [tschaub/gh-pages](https://github.com/tschaub/gh-pages) | 1005 | `mocha --recursive test` | 
...
| [sequelize/sequelize-auto](https://github.com/sequelize/sequelize-auto) | 991 | `./node_modules/.bin/mocha --globals setImmediate,clearImmediate,__core-js_shared__ --ui tdd --check-leaks --colors -t 15000 --reporter spec "test/**/*.test.js"` | 
...
| [DemocracyEarth/sovereign](https://github.com/DemocracyEarth/sovereign) | 990 | `meteor test --settings=config/development/settings.json --once --driver-package dispatch:mocha-phantomjs` | 
| [webpro/reveal-md](https://github.com/webpro/reveal-md) | 987 | `mocha` | 
...
| [mzgoddard/hard-source-webpack-plugin](https://github.com/mzgoddard/hard-source-webpack-plugin) | 984 | `mocha tests/*.js` | 
...
| [Rob--W/cors-anywhere](https://github.com/Rob--W/cors-anywhere) | 975 | `mocha ./test/test*.js --reporter spec` | 
...
| [jaredhanson/passport-facebook](https://github.com/jaredhanson/passport-facebook) | 972 | `node_modules/.bin/mocha --require test/bootstrap/node test/*.test.js` | 
| [nolanlawson/marky](https://github.com/nolanlawson/marky) | 971 | `npm run rollup-cjs && mocha test/test.js` | 
| [jhen0409/react-chrome-extension-boilerplate](https://github.com/jhen0409/react-chrome-extension-boilerplate) | 967 | `cross-env NODE_ENV=test mocha -r ./test/setup-app test/app` | 
| [kirjs/react-highcharts](https://github.com/kirjs/react-highcharts) | 964 | `webpack && mocha test/unit` | 
| [cnpm/cnpm](https://github.com/cnpm/cnpm) | 963 | `mocha -t 120000 test/*.test.js` | 
...
| [greena13/react-hotkeys](https://github.com/greena13/react-hotkeys) | 953 | `mocha` | 
| [yeoman/generator-mobile](https://github.com/yeoman/generator-mobile) | 950 | `mocha --timeout 5000` | 
| [expressjs/generator](https://github.com/expressjs/generator) | 947 | `mocha --reporter spec --bail --check-leaks test/` | 
...
| [mozilla-iot/gateway](https://github.com/mozilla-iot/gateway) | 939 | `npm run lint && npm run mocha` | 
...
| [skygragon/leetcode-cli](https://github.com/skygragon/leetcode-cli) | 907 | `npm run lint && nyc mocha test/** && nyc report --reporter=lcov` | 
| [bkimminich/juice-shop](https://github.com/bkimminich/juice-shop) | 905 | `standard && karma start karma.conf.js && nyc --report-dir=./build/reports/coverage/server-tests mocha test/server` | 
...
| [hortinstein/node-dash-button](https://github.com/hortinstein/node-dash-button) | 902 | `istanbul cover ./node_modules/mocha/bin/_mocha test/test.js --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage` | 
| [domenic/sinon-chai](https://github.com/domenic/sinon-chai) | 902 | `mocha` | 
| [orbitdb/orbit-db](https://github.com/orbitdb/orbit-db) | 896 | `TEST=all mocha` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 882 | `mocha ./test -R spec` | 
...
| [FormidableLabs/victory-native](https://github.com/FormidableLabs/victory-native) | 845 | `mocha --compilers test/compiler.js --recursive test/spec/*.js` | 
...
| [gkajs/gka](https://github.com/gkajs/gka) | 844 | `mocha --timeout 20000` | 
| [andrewrk/node-s3-client](https://github.com/andrewrk/node-s3-client) | 844 | `mocha` | 
| [ant-design/babel-plugin-import](https://github.com/ant-design/babel-plugin-import) | 843 | `node_modules/.bin/babel-istanbul cover node_modules/.bin/_mocha  -- --require @babel/register --no-timeouts` | 
| [thelinmichael/spotify-web-api-node](https://github.com/thelinmichael/spotify-web-api-node) | 840 | `npm run lint && ./node_modules/.bin/mocha --bail` | 
| [mikemintz/react-rethinkdb](https://github.com/mikemintz/react-rethinkdb) | 840 | `eslint test && mocha --compilers js:babel/register` | 
...
| [strongloop/microgateway](https://github.com/strongloop/microgateway) | 819 | `mocha -t 600000` | 
| [ember-fastboot/ember-cli-fastboot](https://github.com/ember-fastboot/ember-cli-fastboot) | 819 | `mocha && ember test` | 
| [ExpressGateway/express-gateway](https://github.com/ExpressGateway/express-gateway) | 818 | `npm run mocha:istanbul` | 
...
| [digitalbazaar/jsonld.js](https://github.com/digitalbazaar/jsonld.js) | 802 | `cross-env NODE_ENV=test mocha --delay -t 30000 -A -R ${REPORTER:-spec} tests/test.js` | 
...
| [image-size/image-size](https://github.com/image-size/image-size) | 801 | `nyc mocha specs` | 
...
| [petecoop/generator-express](https://github.com/petecoop/generator-express) | 786 | `mocha` | 
...
| [GitbookIO/nuts](https://github.com/GitbookIO/nuts) | 781 | `mocha --reporter list` | 
...
| [greggman/twgl.js](https://github.com/greggman/twgl.js) | 771 | `node node_modules/mocha/bin/mocha --recursive 'test/**/*-harness.js'` | 
...
| [indutny/node-ip](https://github.com/indutny/node-ip) | 748 | `jscs lib/*.js test/*.js && jshint lib/*.js && mocha --reporter spec test/*-test.js` | 
...
| [datastax/nodejs-driver](https://github.com/datastax/nodejs-driver) | 741 | `./node_modules/.bin/mocha test/unit -R spec -t 5000` | 
...
| [radi-js/radi](https://github.com/radi-js/radi) | 730 | `nyc mocha` | 
...
| [patriksimek/vm2](https://github.com/patriksimek/vm2) | 723 | `mocha test` | 
...
| [webpack-contrib/html-loader](https://github.com/webpack-contrib/html-loader) | 712 | `mocha --harmony --full-trace --check-leaks` | 
...
| [yanhaijing/template.js](https://github.com/yanhaijing/template.js) | 706 | `mocha test` | 
| [tshelburne/redux-batched-actions](https://github.com/tshelburne/redux-batched-actions) | 706 | `node_modules/.bin/mocha --compilers js:babel-core/register` | 